...
public class InitUsingDefaultConfigurator {
    ...
    //   Private Variables:
    //--------------------------------------------------------------------------
    private static Logger logger = Logger.getLogger(InitUsingDefaultConfigurator.class);
    ...
    public static class InnerInitUsingDefaultConfigurator {
        ...
        static Logger logger = Logger.getLogger(InnerInitUsingDefaultConfigurator.class.getName());
