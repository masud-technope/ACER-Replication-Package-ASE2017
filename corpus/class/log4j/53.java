...
public class DatagramStringAppender extends AppenderSkeleton {
  ...
  */
    ...
    public String[] getOptionStrings() {
        return OptionConverter.concatanateArrays(super.getOptionStrings(), new String[] { DATAGRAM_HOST_OPTION, DATAGRAM_PORT_OPTION, DATAGRAM_ENCODING_OPTION });
    }
    ...
    */
    ...
    public void setDestination(String host, int port, String encoding) {
        ...
        this.qw = new QuietWriter(new DatagramStringWriter(host, port, encoding), errorHandler);
