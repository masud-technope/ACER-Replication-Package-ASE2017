...
public class JListView extends JList {
    ...
    static LoggingEvent proto = new LoggingEvent("x", cat, Priority.ERROR, "Message ", new Throwable());
  ...
  */
    ...
    class MyCellRenderer extends JTextArea implements ListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object value, // cell index
        ...
        public void run() {
            while (true) {
                ...
                for (int i = 0; i < burst; i++) {
                    LoggingEvent event = new LoggingEvent("x", cat, Priority.DEBUG, "Message " + counter, null);
                    event.getThreadName();
                    if (counter % 50 == 0) {
