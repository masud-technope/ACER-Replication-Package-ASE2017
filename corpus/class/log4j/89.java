...
public class DailyFileAppender extends FileAppender {
   ...
   */
    public static final String FILE_NAME_PATTERN_OPTION = "FilePattern";
  ...
  */
    public String[] getOptionStrings() {
        return OptionConverter.concatanateArrays(super.getOptionStrings(), new String[] { FILE_NAME_PATTERN_OPTION });
    }
  ...
  */
    ...
    public void activateOptions() {
        try {
            ...
            errorHandler.error("setFile(null," + fileAppend + ") call failed.", e, ErrorCode.FILE_OPEN_FAILURE);
        }
    }
}
