...
public class SocketAppenderTest extends TestCase {
    ...
    protected void setUp() {
        ...
        secondary = (LastOnlyAppender) Logger.getLogger("org.apache.log4j.net.SocketAppenderTestDummy").getAppender("lastOnly");
    }
     ...
     */
    public static class LastOnlyAppender extends AppenderSkeleton {
