...
public class DRFATestCase extends TestCase {
    ...
    public void testRolloverNoPattern() throws IOException {
        Layout layout = new SimpleLayout();
        DailyRollingFileAppender appender = new DailyRollingFileAppender(layout, "output/drfa_nopattern.log", null);
     ...
     */
    private static void append(final FileOutputStream combined, final FileInputStream source, final byte[] buf) throws IOException {
