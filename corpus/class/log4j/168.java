...
public class MinimumTestCase extends TestCase {
    ...
    static String TTCC_PAT = Filter.ABSOLUTE_DATE_AND_TIME_PAT + " \\[main]\\ (TRACE|DEBUG|INFO|WARN|ERROR|FATAL) .* - Message \\d{1,2}";

    static String TTCC2_PAT = Filter.ABSOLUTE_DATE_AND_TIME_PAT + " \\[main]\\ (TRACE|DEBUG|INFO|WARN|ERROR|FATAL) .* - Messages should bear numbers 0 through 29\\.";
    ...
    public void simple() throws Exception {
        ...
        common();
        Transformer.transform("output/simple", FILTERED, new Filter[] { new LineNumberFilter(), new SunReflectFilter(), new JunitTestRunnerFilter() });
    ...
    public void ttcc() throws Exception {
        ...
        ControlFilter cf1 = new ControlFilter(new String[] { TTCC_PAT, TTCC2_PAT, EXCEPTION1, EXCEPTION2, EXCEPTION3, EXCEPTION4, EXCEPTION5 });
        Transformer.transform("output/ttcc", FILTERED, new Filter[] { cf1, new LineNumberFilter(), new AbsoluteDateAndTimeFilter(), new SunReflectFilter(), new JunitTestRunnerFilter() });
