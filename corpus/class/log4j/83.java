...
public class TestLogMF extends TestCase {
    ...
    public void testDebugDate() {
        ...
        String expected2 = "Iteration " + DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(epoch);
    ...
    public void testDebugFullPrecisionAndPercent() {
        ...
        String expected = java.text.MessageFormat.format("{0}{0, number, percent}", new Object[] { new Double(Math.PI) });
        assertEquals(expected, capture.getMessage());
    }
    ...
    public void testInfo10ParamBrace9() {
        LogCapture capture = new LogCapture(Level.INFO);
        LogMF.info(logger, "{1}, {9}{0}", new Object[] { "World", "Hello", null, null, null, null, null, null, null, "New " });
