...
public class TempFileAppender extends AppenderSkeleton {
  ...
  */
    public String[] getOptionStrings() {
        return OptionConverter.concatanateArrays(super.getOptionStrings(), new String[] { PATH_OPTION, PREFIX_OPTION, SUFFIX_OPTION });
    }
    ...
    public void setOption(String key, String value) {
        ...
        if (key.equalsIgnoreCase(PATH_OPTION)) {
            ...
            if (value != null && value.length() >= 3) {
                ...
                errorHandler.error("Prefix cannot be shorter than 3 characters!", null, 0);
            }
