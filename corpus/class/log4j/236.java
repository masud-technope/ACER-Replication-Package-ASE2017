...
public class JTableAppender extends JTable {
    ...
    public static void main(String[] args) {
        ...
        JTableAppenderModel model = new JTableAppenderModel(Integer.parseInt(args[0]));
        ...
        int i = 0;
        while (i++ < RUN) {
            LoggingEvent event = new LoggingEvent("x", cat, Priority.ERROR, "Message " + i, null);
            event.getThreadName();
            if (i % 10 == 0) {
...
class JTableAddAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        LoggingEvent event = new LoggingEvent("x", cat, Priority.DEBUG, "Message " + j, null);
        if (j % 5 == 0) {
