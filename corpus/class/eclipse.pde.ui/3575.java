    ...
    protected IStatus run(IProgressMonitor monitor) {
        ...
        try {
            ...
            try {
                ...
                String description = NLS.bind(ActionMessages.CompareWithAction_compared_with_against, new Object[] { new Integer(size), baselineName, new Integer(delta.getChildren().length) });
                if (size == 0) {
                    ...
                    description = NLS.bind(ActionMessages.CompareWithAction_compared_project_with, new Object[] { elementName, baselineName, new Integer(delta.getChildren().length) });
                }
