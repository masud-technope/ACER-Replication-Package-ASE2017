...
public class PreferencesSection extends PDESection {
    ...
    private String getWizardConfigText() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        bindings[0] = info.getSourceFilePath() == null ? PDEUIMessages.PreferencesSection_epf : "<br></br><b>" + TextProcessor.process(info.getSourceFilePath()) + "</b><br></br><br></br>";
        //$NON-NLS-1$ //$NON-NLS-2$
        bindings[1] = info.getPreferenceCustomizationPath() == null ? PDEUIMessages.PreferencesSection_customize : "<br></br><b>" + TextProcessor.process(info.getPreferenceCustomizationPath()) + "</b><br></br>";
