...
public class IntroTemplate extends PDETemplateSection {
    ...
    private void createProductExtension() throws CoreException {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        property.setAttribute("value", "icons/alt_window_16.gif,icons/alt_window_32.gif");
    ...
    public IPluginReference[] getDependencies(String schemaVersion) {
        ...
        //$NON-NLS-1$
        result.add(new PluginReference("org.eclipse.ui.intro", null, 0));
        //$NON-NLS-1$
        ...
        if (getValue(KEY_GENERATE_DYNAMIC_CONTENT).toString().equals(DYNAMIC_SELECTED)) {
            //$NON-NLS-1$
            result.add(new PluginReference("org.eclipse.ui.forms", null, 0));
            //$NON-NLS-1$
