...
public class SplashHandlersTemplate extends PDETemplateSection {
    ...
    public IPluginReference[] getDependencies(String schemaVersion) {
        ...
        //$NON-NLS-1$
        dependencies[0] = new PluginReference("org.eclipse.core.runtime", null, 0);
        //$NON-NLS-1$
        dependencies[1] = new PluginReference("org.eclipse.swt", null, 0);
        //$NON-NLS-1$
        dependencies[2] = new PluginReference("org.eclipse.jface", null, 0);
        //$NON-NLS-1$
        dependencies[3] = new PluginReference("org.eclipse.ui.workbench", null, 0);
        return dependencies;
    }
