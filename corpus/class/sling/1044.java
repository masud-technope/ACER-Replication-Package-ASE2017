...
public class TraxSerializer implements Serializer, LexicalHandler {
    ...
    public  TraxSerializer(final TransformerHandler transformerHandler, final ContentHandler handler, final String outputFormat, final String doctypePublic, final String doctypeSystem) {
