...
public class TopicMatchingTest extends AbstractJobHandlingTest {
    ...
    public void testSimpleMatching() throws Exception {
        ...
        final ServiceRegistration reg = this.registerJobExecutor("sling/test/*", new JobExecutor() {
        ...
        final ServiceRegistration eventHandler = this.registerEventHandler(NotificationConstants.TOPIC_JOB_FINISHED, new EventHandler() {
    ...
    public void testDeepMatching() throws Exception {
        final AtomicInteger finishedCount = new AtomicInteger();
        final ServiceRegistration reg = this.registerJobExecutor("sling/**", new JobExecutor() {
    ...
    public void testOrdering() throws Exception {
        ...
        final ServiceRegistration reg1 = this.registerJobExecutor("sling/**", new JobExecutor() {
        ...
        final ServiceRegistration reg2 = this.registerJobExecutor("sling/test/*", new JobExecutor() {
        ...
        final ServiceRegistration reg3 = this.registerJobExecutor(TOPIC, new JobExecutor() {
