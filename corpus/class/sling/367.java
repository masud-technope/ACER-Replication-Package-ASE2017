...
public class DummyDiscoveryService extends BaseDiscoveryService {
    ...
    public  DummyDiscoveryService(String slingId, ClusterViewService clusterViewService, AnnouncementRegistry topologyRegistry, ResourceResolverFactory resourceResolverFactory, BaseConfig config, ConnectorRegistry connectorRegistry, Scheduler scheduler) {
