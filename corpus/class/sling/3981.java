...
public class SlingJSPTaglibTest extends RenderingTestBase {
    ...
    protected void setUp() throws Exception {
        ...
        testClient.upload(HTTP_BASE_URL + "/apps/integration-test/taglib-test/taglib-test.jsp", SlingJSPTaglibTest.class.getClassLoader().getResourceAsStream("integration-test/taglib-test.jsp"));
