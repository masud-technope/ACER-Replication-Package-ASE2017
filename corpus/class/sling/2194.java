...
public class HealthCheckExecutionOptions {
    ...
    public String toString() {
        return "[HealthCheckExecutionOptions forceInstantExecution=" + forceInstantExecution + ", combineTagsWithOr=" + combineTagsWithOr + ", overrideGlobalTimeout=" + overrideGlobalTimeout + "]";
    }
