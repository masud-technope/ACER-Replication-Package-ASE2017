...
public class HealthCheckFilterTest {
    ...
    class TestHealthCheck implements HealthCheck {
        ...
        final String[] tags;
         ...
         TestHealthCheck(String... tags) {
            ...
            log.info("Registered {} with {}={}", new Object[] { this, HealthCheck.TAGS, props.get(HealthCheck.TAGS) });
        }
    ...
    public void testSelectorService() {
        assertNotNull("Expecting HealthCheckSelector service to be provided", filter);
    }
    ...
    public void testMinusOtherFoo() {
        final List<HealthCheck> s = filter.getTaggedHealthChecks("-other", "-foo");
