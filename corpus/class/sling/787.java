...
public class CRUDMergingResourceProvider extends MergingResourceProvider {
    ...
    public  CRUDMergingResourceProvider(final String mergeRootPath, final MergedResourcePicker picker, final boolean traverseHierarchie) {
    ...
    private ExtendedResourceHolder getAllResources(final ResourceResolver resolver, final String path, final String relativePath) {
