...
public class UniqueRoot {
    ...
    protected final Resource getOrCreateResource(String path, String primaryType) {
        try {
            return ResourceUtil.getOrCreateResource(context.resourceResolver(), path, ImmutableMap.<String, Object>of(JcrConstants.JCR_PRIMARYTYPE, primaryType), null, true);
