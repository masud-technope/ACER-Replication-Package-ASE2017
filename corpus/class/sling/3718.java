...
public class UnitLoader {
    ...
    public RenderUnit createUnit(Resource scriptResource, Bindings bindings, RenderContext renderContext) throws Exception {
        ...
        SourceIdentifier sourceIdentifier = new SourceIdentifier(sightlyEngineConfiguration, unitChangeMonitor, classLoaderWriter, scriptResource, CLASS_NAME_PREFIX);
        Object obj;
        String encoding;
