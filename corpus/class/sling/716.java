...
public class JSONObject {
    ...
    public  JSONObject(Map<String, ?> map) {
        this.myHashMap = (map == null) ? new LinkedHashMap<String, Object>() : new LinkedHashMap<String, Object>(map);
    }
    ...
    String toString(int indentFactor, int initialIndent) throws JSONException {
        return renderer.prettyPrint(this, renderer.options().withIndent(indentFactor).withInitialIndent(initialIndent));
    }
     ...
     */
    static String valueToString(Object value, int indentFactor, int initialIndent) throws JSONException {
        return renderer.valueToString(value, renderer.options().withIndent(indentFactor).withInitialIndent(initialIndent));
    }
