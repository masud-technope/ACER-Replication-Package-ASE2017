...
public class ExpressionReducer implements NodeVisitor<EvalResult> {
    ...
    public EvalResult evaluate(PropertyAccess propertyAccess) {
        ...
        return EvalResult.constant(RenderUtils.resolveProperty(target.getValue(), property.getValue()));
    }
    ...
    public EvalResult evaluate(TernaryOperator ternaryOperator) {
        ...
        return (RenderUtils.toBoolean(condition.getValue())) ? eval(ternaryOperator.getThenBranch()) : eval(ternaryOperator.getElseBranch());
    }
