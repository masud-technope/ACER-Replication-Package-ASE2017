...
public class TestsManagerImpl implements TestsManager {
    ...
    public void listTests(Collection<String> testNames, Renderer renderer) throws Exception {
        ...
        final String note = "The test set can be restricted using partial test names" + " as a suffix to this URL" + ", followed by the appropriate extension, like 'com.example.foo.tests.html'";
