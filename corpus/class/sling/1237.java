...
public class CommonResourceResolverFactoryImpl implements ResourceResolverFactory, MapConfigurationProvider {
     ...
     */
    public void register(final ResourceResolver resolver, final ResourceResolverContext ctx) {
     ...
     * @param ctx The resource resolver context
     */
    public void unregister(final ResourceResolver resourceResolverImpl, final ResourceResolverContext ctx) {
        // close the context
        ctx.close();
     ...
     */
    public ResourceResolver getResourceResolverInternal(final Map<String, Object> authenticationInfo, final boolean isAdmin) throws LoginException {
        if (!isActive.get()) {
            throw new LoginException("ResourceResolverFactory is deactivated.");
        }
    ...
    private static final class ResolverWeakReference extends WeakReference<ResourceResolver> {
        ...
        public  ResolverWeakReference(final ResourceResolver referent, final ReferenceQueue<? super ResourceResolver> q, final ResourceResolverContext ctx) {
            super(referent, q);
            this.context = ctx;
        }
