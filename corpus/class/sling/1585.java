...
public class BundleInfo {
    ...
    public static BundleInfo getBundleInfo(final BundleContext bundleContext, final String symbolicName, final String version) {
     ...
     */
    public static Bundle getMatchingBundle(final BundleContext bundleContext, final String bundleSymbolicName, final String version) {
        Bundle match = null;
