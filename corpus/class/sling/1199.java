...
public class RepositoryDistributionPackageImporterFactory implements DistributionPackageImporter {
    ...
    protected void activate(Map<String, Object> config) {
        importer = new RepositoryDistributionPackageImporter(repository, PropertiesUtil.toString(config.get(SERVICE_NAME), "admin"), PropertiesUtil.toString(config.get(PATH), "/var/distribution/import"), PropertiesUtil.toString(config.get(PRIVILEGE_NAME), "jcr:read"));
    }
