 ...
 */
public final class JcrModifiableValueMap implements ModifiableValueMap {
    ...
    private Map<String, Object> transformEntries(final Map<String, JcrPropertyMapCacheEntry> map) {
        ...
        for (final Map.Entry<String, JcrPropertyMapCacheEntry> entry : map.entrySet()) transformedEntries.put(entry.getKey(), entry.getValue().getPropertyValueOrNull());
