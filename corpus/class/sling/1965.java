...
public interface JobManager {
     ...
     */
    enum QueryType implements  {

        // all means all active and all queued
        ALL() {
        }
        , ACTIVE() {
        }
        ...
        , // returns the complete history of cancelled and succeeded jobs (if available)
        HISTORY() {
        }
        , // history of cancelled jobs (STOPPED, GIVEN_UP, ERROR, DROPPED)
        CANCELLED() {
        }
        , // history of succeeded jobs
        SUCCEEDED() {
        }
        , // history of stopped jobs
        STOPPED() {
        }
        , // history of given up jobs
        GIVEN_UP() {
        }
        , // history of jobs signaled CANCELLED or throw an exception
        ERROR() {
        }
        , // history of dropped jobs
        DROPPED() {
        }
        ;
    }
