...
@Service
@Properties({ @Property(name = EngineConstants.FILTER_NAME, value = "RequestAnalysisLogger"), @Property(name = EngineConstants.SLING_FILTER_SCOPE, value = EngineConstants.FILTER_SCOPE_REQUEST), @Property(name = Constants.SERVICE_RANKING, intValue = Integer.MAX_VALUE) })
public class RequestAnalysisLogger implements Filter {
    ...
    private void activate(final BundleContext ctx) throws IOException {
        ...
        this.webConsolePlugin = ctx.registerService("javax.servlet.Servlet", this.requestAnalyzerWebConsole, new Hashtable<String, Object>() {
