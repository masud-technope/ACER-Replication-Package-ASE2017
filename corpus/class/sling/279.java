 ...
 */
@Component(metatype = true, label = "Apache Sling Distribution Agent - Reverse Agents Factory", description = "OSGi configuration factory for reverse agents", configurationFactory = true, specVersion = "1.1", policy = ConfigurationPolicy.REQUIRE)
