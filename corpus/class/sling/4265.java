...
public class Activator implements BundleActivator, ServiceListener {
    ...
    protected void initDefaultConfig(Hashtable<String, String> props) {
        ...
        props.put(Context.INITIAL_CONTEXT_FACTORY, "org.apache.jackrabbit.core.jndi.provider.DummyInitialContextFactory");
    }
    ...
    public void start(BundleContext context) {
        ...
        if (sr != null) {
            ...
            try {
                ...
                log.error("start: Failed to register for Configuration Admin Service, will not verify configuration", ise);
            }
        }
    }
    ...
    private void verifyConfiguration(ServiceReference ref) {
        ...
        try {
            ...
            Configuration[] cfgs = ca.listConfigurations("(" + ConfigurationAdmin.SERVICE_FACTORYPID + "=" + this.getClientRepositoryFactoryPID() + ")");
            if (cfgs != null && cfgs.length > 0) {
                log.info("verifyConfiguration: {} Configurations available for {}, nothing to do", new Object[] { new Integer(cfgs.length), this.getClientRepositoryFactoryPID() });
                return;
            }
            ...
            if (overrideUrl != null && overrideUrl.length() > 0) {
                ...
                log.debug(RepositoryAccessor.REPOSITORY_URL_OVERRIDE_PROPERTY + "=" + overrideUrl + ", using it to create the default configuration");
            } else {
            ...
            log.debug("verifyConfiguration: Created configuration {} for {}", config.getPid(), config.getFactoryPid());
        } catch (Throwable t) {
