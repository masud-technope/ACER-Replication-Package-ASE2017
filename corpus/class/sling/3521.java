...
public class PlanetsResourceProviderTest extends HttpTestBase {
    ...
    public void testRootResource() throws Exception {
        assertStrings(HTTP_BASE_URL + "/planets.tidy.-1.json", new String[] { "earth", "moon", "Moon", "Resources can have different sets of properties", "\"name\": \"Uranus\"" });
    }

    public void testEarthResource() throws Exception {
        assertStrings(HTTP_BASE_URL + "/planets.tidy.-1.json", new String[] { "earth", "moon", "Moon", "Resources can have different sets of properties", "\"name\": \"Uranus\"", "384" });
    }

    public void testMoonResource() throws Exception {
        assertStrings(HTTP_BASE_URL + "/planets/earth/moon.tidy.json", new String[] { "!earth", "!moon", "Moon", "!Resources can have different sets of properties", "!\"name\": \"Uranus\"", "384" });
    }
