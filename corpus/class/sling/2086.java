...
public class AbstractNodeDescriptor extends AbstractItemDescriptor {
    ...
    public  AbstractNodeDescriptor(Log log, DocletTag tag, String fieldName) {
        ...
        isJcrSameNameSibblings = Boolean.valueOf(tag.getNamedParameter(JCR_SAME_NAME_SIBBLINGS)).booleanValue();
        ...
        if (tag.getNamedParameter(AUTO_RETRIEVE) != null) {
            isAutoRetrieve = Boolean.valueOf(tag.getNamedParameter(AUTO_RETRIEVE)).booleanValue();
        }
    ...
    void generate(XMLWriter xmlWriter) {
        ...
        xmlWriter.printAttribute(JCR_SAME_NAME_SIBBLINGS, isJcrSameNameSibblings);
        if (!isProxy) {
