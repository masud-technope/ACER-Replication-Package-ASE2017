...
public class Config implements BaseConfig, DiscoveryLiteConfig {
    ...
    protected void configure(final Map<String, Object> properties) {
        this.connectorPingTimeout = PropertiesUtil.toLong(properties.get(TOPOLOGY_CONNECTOR_TIMEOUT_KEY), DEFAULT_TOPOLOGY_CONNECTOR_TIMEOUT);
        logger.debug("configure: connectorPingTimeout='{}'", this.connectorPingTimeout);
        this.connectorPingInterval = PropertiesUtil.toLong(properties.get(TOPOLOGY_CONNECTOR_INTERVAL_KEY), DEFAULT_TOPOLOGY_CONNECTOR_INTERVAL);
        logger.debug("configure: connectorPingInterval='{}'", this.connectorPingInterval);
        this.discoveryLiteCheckInterval = PropertiesUtil.toLong(properties.get(DISCOVERY_LITE_CHECK_INTERVAL_KEY), DEFAULT_DISCOVERY_LITE_CHECK_INTERVAL);
        logger.debug("configure: discoveryLiteCheckInterval='{}'", this.discoveryLiteCheckInterval);
        this.clusterSyncServiceTimeout = PropertiesUtil.toLong(properties.get(CLUSTER_SYNC_SERVICE_TIMEOUT_KEY), DEFAULT_CLUSTER_SYNC_SERVICE_TIMEOUT);
        logger.debug("configure: clusterSyncServiceTimeout='{}'", this.clusterSyncServiceTimeout);
        this.clusterSyncServiceInterval = PropertiesUtil.toLong(properties.get(CLUSTER_SYNC_SERVICE_INTERVAL_KEY), DEFAULT_CLUSTER_SYNC_SERVICE_TIMEOUT);
        ...
        this.socketConnectTimeout = PropertiesUtil.toInteger(properties.get(SOCKET_CONNECT_TIMEOUT_KEY), DEFAULT_SOCKET_CONNECT_TIMEOUT);
