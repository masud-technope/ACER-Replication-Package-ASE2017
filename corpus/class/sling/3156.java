...
public interface UpdateHandler {
     ...
     */
    UpdateResult handleRemoval(final String resourceType, final String id, final String url);
     ...
     *         otherwise the handler should return <code>null</code>
     */
    UpdateResult handleUpdate(final String resourceType, final String id, final String url, final Dictionary<String, Object> dict, final Map<String, Object> attributes);
     ...
     *         otherwise the handler should return <code>null</code>
     */
    UpdateResult handleUpdate(final String resourceType, final String id, final String url, final InputStream is, final Map<String, Object> attributes);
}
