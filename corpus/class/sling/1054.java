...
public class JcrJavaCompilerImpl implements JcrJavaCompiler {
     ...
     */
    public CompilationResult compile(final String[] srcFiles, final String outputDir, final Options compilerOptions) throws Exception {
     ...
     */
    public CompilationResult compile(final String[] srcFiles, final Options compilerOptions) throws Exception {
     ...
     */
    private CompilationResult mapResult(final CompilationResult result, final String[] srcFiles, final CompilationUnit[] units) {
    ...
    //--------------------------------------------------------< misc. helpers >
    private CompilationUnit createCompileUnit(final String sourceFile, final Session session) throws RepositoryException, IOException {
    ...
    private Source readTextResource(final String resourcePath, final Session session) throws RepositoryException, IOException {
