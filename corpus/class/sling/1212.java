...
public class MergedResource extends AbstractResource {
     ...
     */
     MergedResource(final ResourceResolver resolver, final String mergeRootPath, final String relativePath, final List<Resource> mappedResources, final List<ValueMap> valueMaps) {
    ...
    public String toString() {
        return "MergedResource [path=" + this.path + ", resources=" + this.metadata.get(MergedResourceConstants.METADATA_RESOURCES) + "]";
    }
}
