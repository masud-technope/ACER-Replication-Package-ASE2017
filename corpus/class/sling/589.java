...
public class SlingAptParserImplTest extends TestCase implements MacroResolver {
    ...
    public void testLinkA() throws Exception {
        parse(" Para {{http://www.perdu.com}}", "<p>Para <a href=\"http://www.perdu.com\">http://www.perdu.com</a></p>");
    }

    public void testLinkB() throws Exception {
        parse(" Para {{{http://www.perdu.com}text here}}", "<p>Para <a href=\"http://www.perdu.com\">text here</a></p>");
    }
    ...
    public void testSections() throws Exception {
        parse("Top\n\n* s1\n\n** s2\n\n** s2b\n\n*** s3\n\n para", "<h1>Top</h1><h2>s1</h2><h3>s2</h3>" + EOL + "<h3>s2b</h3><h4>s3</h4><p>para</p>");
    }

    public void testList() throws Exception {
        parse(" * 1\n para 1\n\n  * 2\n\n  * 3\n\n  para 2", "<ul><li><p>1 para 1</p><ul><li><p>2</p></li><li><p>3</p><p>para 2</p></li></ul></li></ul>");
    }
    ...
    public void testTitle() throws Exception {
        final String input = " ---- \n test title \n ---- \n\nH1 title now";
        final String expected = "<html>" + EOL + "<head>" + EOL + "<title>test title</title>" + EOL + "</head>" + EOL + "<body><h1>H1 title now</h1>" + EOL + "</body>" + EOL + "</html>";
