...
public interface StatefulResourceProvider {
     ...
     */
    @CheckForNull
    Resource getParent(@Nonnull final Resource child);

    /**
     * @see ResourceProvider#getResource(org.apache.sling.spi.resource.provider.ResolveContext, String, Resource)
     */
    @CheckForNull
    Resource getResource(@Nonnull final String path, @CheckForNull final Resource parent, @CheckForNull final Map<String, String> parameters, final boolean isResolve);

    /**
     * @see ResourceProvider#listChildren(org.apache.sling.spi.resource.provider.ResolveContext, Resource)
     */
    @CheckForNull
    Iterator<Resource> listChildren(@Nonnull final Resource parent);
     ...
     */
    void delete(@Nonnull final Resource resource) throws PersistenceException;
     ...
     */
    @CheckForNull
    <AdapterType> AdapterType adaptTo(@Nonnull final Class<AdapterType> type);
