...
public interface Query {
     ...
     * single query.
     */
    public enum QueryType implements  {
     ...
     */
    public enum PropertyOperator implements  {
        ...
        , // property is greater or equal to the value
        GT_OR_EQ() {
        }
        , // property is less than the value
        LT() {
        }
        , // property is less or equal to the value
        LT_OR_EQ() {
        }
