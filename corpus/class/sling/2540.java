...
@Component
@Service
public class MailStatsProcessorImpl implements /** Computes stats of how often a given organization writes to
 ...
 */
MailStatsProcessor, MessageProcessor {
    ...
    class DataRecord {
        ...
        public String toString() {
            return new StringBuilder().append(getClass().getSimpleName()).append(' ').append(timestampPath).append(' ').append(destination).append(' ').append(sourceCounts).toString();
        }

        String getKey() {
            return new StringBuilder().append(timestampPath).append('#').append(destination).toString();
        }
    }
