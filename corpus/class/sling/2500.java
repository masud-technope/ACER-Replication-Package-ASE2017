...
@Component(label = "Apache Sling Scripting Thymeleaf â€œNon-Caching Template Resolverâ€?", description = "non-caching template resolver for Sling Scripting Thymeleaf", immediate = true, metatype = true)
@Service
@Properties({ @Property(name = Constants.SERVICE_VENDOR, value = "The Apache Software Foundation"), @Property(name = Constants.SERVICE_DESCRIPTION, value = "non-caching template resolver for Sling Scripting Thymeleaf") })
