...
public interface Repository {
    ...
    public enum CommandExecutionFlag implements  {
    ...
    Command<Void> newAddOrUpdateNodeCommand(CommandContext context, FileInfo fileInfo, ResourceProxy resourceProxy, CommandExecutionFlag... flags);
