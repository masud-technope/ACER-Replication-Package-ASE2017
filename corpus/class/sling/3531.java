...
@Service
public class PlainTextRenderer extends /** Plain text renderer */
RunListener implements Renderer, RendererFactory {
    ...
    public void testRunFinished(Result result) throws Exception {
        ...
        output.println("TEST RUN FINISHED: " + "tests:" + result.getRunCount() + ", failures:" + result.getFailureCount() + ", ignored:" + result.getIgnoreCount());
    }
