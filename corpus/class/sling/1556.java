        ...
        for (; ; ) {
            ...
            if (c < 0) {
                ...
                if (!lineStart && state == PARSE_STATE_ESP) {
                    ...
                    doVerbatim("\");");
                    // mark the line having ended
                    lineStart = true;
                    // let's start read the injection
                    continue;
                }
                // return the marker, we're done
                return c;
            }
            ...
            switch(state) {
                ...
                case PARSE_STATE_ECMA_EXPR_COMPACT:
                    if (c == '}') {
                        //might be the end of a compact expression
