...
public interface ResourceChangeListener {
     ...
     */
    void resourceAddedOrUpdated(final String resourceType, final String entityId, final InputStream is, final Dictionary<String, Object> dict, final Map<String, Object> attributes);
     ...
     * @param entityId     The entity id (symbolic name etc.)
     */
    void resourceRemoved(final String resourceType, final String entityId);
}
