...
@Properties({ @Property(name = "service.description", value = "Decorates resources that have been called with the ResEditorResourceProvider with the resource-editor resource type."), @Property(name = "service.vendor", value = "The Apache Software Foundation") })
public class ResourceProviderBasedResourceDecorator implements ResourceDecorator {
    ...
    public Resource decorate(Resource resource, HttpServletRequest request) {
        ...
        return getResourceEditorResourceWrapper(resource, pathInfo);
    }
