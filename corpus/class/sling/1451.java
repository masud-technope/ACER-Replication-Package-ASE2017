...
@Component
@Service
@Properties({ @Property(name = "service.description", value = "JSP Script Handler"), @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = "felix.webconsole.label", value = FSClassLoaderWebConsole.APP_ROOT), @Property(name = "felix.webconsole.title", value = "File System Class Loader"), @Property(name = "felix.webconsole.css", value = { FSClassLoaderWebConsole.RES_LOC + "/prettify.css" }), @Property(name = "felix.webconsole.category", value = "Sling") })
public class FSClassLoaderWebConsole extends AbstractWebConsolePlugin {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!StringUtils.isEmpty(file)) {
            ...
            IOUtils.copy(getClass().getClassLoader().getResourceAsStream("/res/ui/prettify.css"), response.getOutputStream());
        } else if (request.getRequestURI().endsWith(RES_LOC + "/prettify.js")) {
            response.setContentType("application/javascript");
            IOUtils.copy(getClass().getClassLoader().getResourceAsStream("/res/ui/prettify.js"), response.getOutputStream());
        } else {
    ...
    protected void renderContent(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!StringUtils.isEmpty(file)) {
            if (isValid(toView)) {
                ...
                w.write("<td>[<a href=\"?download=" + scriptFiles.getClassFile() + "\" target=\"_blank\">download</a>]</td>");
                w.write("<td>[<a href=\"?download=" + scriptFiles.getDepsFile() + "\" target=\"_blank\">download</a>]</td>");
                w.write("<td>[<a href=\"?download=" + scriptFiles.getJavaFile() + "\" target=\"_blank\">download</a>]</td>");
                w.write("</tr>");
                w.write("</table><br/><br/>");
                InputStream is = null;
                try {
            ...
            w.write("<p class=\"statline ui-state-highlight\">File System ClassLoader Root: " + root + "</p>");
            w.write("<table class=\"nicetable ui-widget\">");
            w.write("<tr class=\"header ui-widget-header\">");
            w.write("<th>View</th>");
            w.write("<th>Script</th>");
