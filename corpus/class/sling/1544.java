...
public class NamedScriptResourceCollector extends AbstractResourceCollector {
    ...
    public static NamedScriptResourceCollector create(final String name, final Resource resource, final String[] executionPaths) {
    ...
    public  NamedScriptResourceCollector(final String baseResourceType, final String resourceType, final String resourceSuperType, final String scriptName, final String extension, final String[] executionPaths) {
        super(baseResourceType, resourceType, resourceSuperType, extension, executionPaths);
        this.scriptName = scriptName;
        // create the hash code once
        final String key = baseResourceType + ':' + this.scriptName + ':' + this.resourceType + ':' + (this.resourceSuperType == null ? "" : this.resourceSuperType) + ':' + (this.extension == null ? "" : this.extension);
