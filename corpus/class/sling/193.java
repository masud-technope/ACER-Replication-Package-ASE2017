...
@Properties({ @Property(name = HealthCheck.NAME, value = "SlingDiscoveryOakClocksInSyncHC", description = "Health Check name", label = "Name"), @Property(name = HealthCheck.TAGS, unbounded = PropertyUnbounded.ARRAY, description = "Health Check tags", label = "Tags"), @Property(name = HealthCheck.MBEAN_NAME, value = "slingDiscoveryOakClocksInSync", description = "Health Check MBean name", label = "MBean name") })
