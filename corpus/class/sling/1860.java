...
public class RemoteEventDistributionTrigger implements DistributionTrigger {
    ...
    private class SSEResponseConsumer extends BasicAsyncResponseConsumer {
        ...
        protected void onContentReceived(ContentDecoder decoder, IOControl ioctrl) throws IOException {
            ...
            log.info("distribution request to agent {} sent ({} {})", new Object[] { handler, distributionRequest.getRequestType(), distributionRequest.getPaths() });
        ...
        public void run() {
            try {
                ...
                if (credentialsMap != null) {
                    ...
                    credentialsProvider.setCredentials(new AuthScope(new HttpHost(endpoint.getUri().getHost(), endpoint.getUri().getPort())), new UsernamePasswordCredentials(username, password));
                    final CloseableHttpAsyncClient httpClient = HttpAsyncClients.custom().setDefaultCredentialsProvider(credentialsProvider).build();
                    ...
                    try {
                        ...
                        Future<HttpResponse> futureResponse = httpClient.execute(basicAsyncRequestProducer, new SSEResponseConsumer(requestHandler), new FutureCallback<HttpResponse>() {
