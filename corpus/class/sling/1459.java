...
public class PostServletAtMoveTest extends HttpTestBase {
    ...
    public void testMovePropertyAbsolute() throws IOException {
        ...
        // assert no content at old location
        assertHttpStatus(HTTP_BASE_URL + testPath + "/src.json", HttpServletResponse.SC_OK, "Expected source parent existing");
        assertHttpStatus(HTTP_BASE_URL + testPath + "/src/text.json", HttpServletResponse.SC_NOT_FOUND, "Expected Not_Found for old content");
    }
