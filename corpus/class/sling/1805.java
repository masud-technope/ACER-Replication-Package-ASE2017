...
public class ProcessorConfigurationImpl implements PipelineConfiguration {
    ...
    public  ProcessorConfigurationImpl(final Resource resource) {
        ...
        if (this.isPipeline) {
            if (this.generatorConfiguration == null || this.generatorConfiguration.getType() == null || this.generatorConfiguration.getType().length() == 0) {
                this.isValid = false;
    ...
    protected ProcessingComponentConfiguration getComponentConfig(final Resource configResource, final String propertyName, final String prefix) {
