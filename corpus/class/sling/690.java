...
public class ServicesListener implements StartupListener {
    ...
    private void registerProvider2(final Object authSupport, final Object authenticator) {
        ...
        this.provider2Reg = this.bundleContext.registerService(new String[] { ManagedService.class.getName(), WebConsoleSecurityProvider.class.getName() }, new SlingWebConsoleSecurityProvider2(authSupport, authenticator), props);
    ...
    private void registerProvider(final Object repository) {
        ...
        props.put(Constants.SERVICE_VENDOR, "The Apache Software Foundation");
        this.providerReg = this.bundleContext.registerService(new String[] { ManagedService.class.getName(), WebConsoleSecurityProvider.class.getName() }, new SlingWebConsoleSecurityProvider(repository), props);
