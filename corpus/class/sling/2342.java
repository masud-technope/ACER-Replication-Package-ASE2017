...
public class ScriptableHealthCheck implements HealthCheck {
    ...
    @Property(value = DEFAULT_LANGUAGE_EXTENSION, label = "Language Extension", description = "File extension of the language to use to evaluate the " + "expression, for example \"ecma\" or \"groovy\", asssuming the corresponding script engine " + "is available. By default \"ecma\" is used.")
    ...
    protected void activate(ComponentContext ctx) {
        ...
        log.debug("Activated scriptable health check name={}, languageExtension={}, expression={}", new Object[] { ctx.getProperties().get(HealthCheck.NAME), languageExtension, expression });
    }
