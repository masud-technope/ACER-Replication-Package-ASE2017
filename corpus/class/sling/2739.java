...
@Component(label = "Apache Sling Scripting Thymeleaf â€œResource Bundle Message Resolverâ€?", description = "resource bundle message resolver for Sling Scripting Thymeleaf", immediate = true, metatype = true)
@Service
@Properties({ @Property(name = Constants.SERVICE_VENDOR, value = "The Apache Software Foundation"), @Property(name = Constants.SERVICE_DESCRIPTION, value = "resource bundle message resolver for Sling Scripting Thymeleaf") })
