...
public class OsgiUtils {
    ...
    public static String getFilter(String configFactory, String propertyName, String propertyValue) {
        if (propertyName != null && propertyValue != null) {
            return "(&(" + ConfigurationAdmin.SERVICE_FACTORYPID + "=" + OsgiUtils.escape(configFactory) + ")(" + OsgiUtils.escape(propertyName) + "=" + OsgiUtils.escape(propertyValue) + "))";
    ...
    public static Map<String, Object> sanitize(Map<String, Object> map) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            if (valueClass.isPrimitive() || valueClass.equals(String.class) || valueClass.equals(Boolean.class) || valueClass.equals(Integer.class)) {
