...
public class U {
    ...
    public static final String[] TEST_MODEL_FILENAMES = new String[] { "boot.txt", "example.txt", "main.txt", "oak.txt" };
    ...
    public static void assertArtifact(final Artifact artifact, final String groupId, final String artifactId, final String version, final String type, final String classifier) {
