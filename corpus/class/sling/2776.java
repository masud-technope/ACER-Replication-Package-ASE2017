    ...
    public static void initPlugin(final BundleContext bundleContext) {
        ...
        if (propUrl != null) {
            ...
            if (props != null) {
                ...
                serviceProps.put(Constants.SERVICE_DESCRIPTION, "Apache Sling Sling Properties Configuration Printer");
                ...
                propertiesPlugin = bundleContext.registerService(SlingPropertiesPrinter.class.getName(), propertiesPrinter, serviceProps);
            }
        }
    }
