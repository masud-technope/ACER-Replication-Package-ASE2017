...
class Validator {
    ...
    static class ValidateVisitor extends Node.Visitor {
        ...
        private static final JspUtil.ValidAttribute[] includeActionAttrs = { new JspUtil.ValidAttribute("page", true, true), new JspUtil.ValidAttribute("flush") };

        private static final JspUtil.ValidAttribute[] paramActionAttrs = { new JspUtil.ValidAttribute("name", true), new JspUtil.ValidAttribute("value", true, true) };

        private static final JspUtil.ValidAttribute[] forwardActionAttrs = { new JspUtil.ValidAttribute("page", true, true) };
        ...
        private static final JspUtil.ValidAttribute[] setPropertyAttrs = { new JspUtil.ValidAttribute("name", true), new JspUtil.ValidAttribute("property", true), new JspUtil.ValidAttribute("value", false, true), new JspUtil.ValidAttribute("param") };

        private static final JspUtil.ValidAttribute[] useBeanAttrs = { new JspUtil.ValidAttribute("id", true), new JspUtil.ValidAttribute("scope"), new JspUtil.ValidAttribute("class"), new JspUtil.ValidAttribute("type"), new JspUtil.ValidAttribute("beanName", false, true) };

        private static final JspUtil.ValidAttribute[] plugInAttrs = { new JspUtil.ValidAttribute("type", true), new JspUtil.ValidAttribute("code", true), new JspUtil.ValidAttribute("codebase"), new JspUtil.ValidAttribute("align"), new JspUtil.ValidAttribute("archive"), new JspUtil.ValidAttribute("height", false, true), new JspUtil.ValidAttribute("hspace"), new JspUtil.ValidAttribute("jreversion"), new JspUtil.ValidAttribute("name"), new JspUtil.ValidAttribute("vspace"), new JspUtil.ValidAttribute("width", false, true), new JspUtil.ValidAttribute("nspluginurl"), new JspUtil.ValidAttribute("iepluginurl") };
        ...
        public void visit(Node.ParamAction n) throws JasperException {
            ...
            n.setValue(getJspAttribute(null, "value", null, null, n.getAttributeValue("value"), java.lang.String.class, n, false));
            visitBody(n);
        }
        ...
        public void visit(Node.IncludeAction n) throws JasperException {
            ...
            n.setPage(getJspAttribute(null, "page", null, null, n.getAttributeValue("page"), java.lang.String.class, n, false));
            visitBody(n);
        }
        ...
        public void visit(Node.UseBean n) throws JasperException {
            ...
            Node.JspAttribute jattr = getJspAttribute(null, "beanName", null, null, n.getAttributeValue("beanName"), java.lang.String.class, n, false);
            n.setBeanName(jattr);
        ...
        public void visit(Node.PlugIn n) throws JasperException {
            ...
            Node.JspAttribute width = getJspAttribute(null, "width", null, null, n.getAttributeValue("width"), java.lang.String.class, n, false);
            n.setWidth(width);
            Node.JspAttribute height = getJspAttribute(null, "height", null, null, n.getAttributeValue("height"), java.lang.String.class, n, false);
            n.setHeight(height);
            visitBody(n);
        }
        ...
        public void visit(Node.ELExpression n) throws JasperException {
            ...
            if (n.getType() == '#') {
                if (!pageInfo.isDeferredSyntaxAllowedAsLiteral() && (tagInfo == null || ((tagInfo != null) && !(tagInfo.getTagLibrary().getRequiredVersion().equals("2.0") || tagInfo.getTagLibrary().getRequiredVersion().equals("1.2"))))) {
        ...
        public void visit(Node.UninterpretedTag n) throws JasperException {
            ...
            if (attrs != null) {
                ...
                for (int i = 0; i < attrSize; i++) {
                    jspAttrs[i] = getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), attrs.getValue(i), java.lang.Object.class, n, false);
                }
        ...
        public void visit(Node.JspElement n) throws JasperException {
            ...
            for (int i = 0; i < xmlAttrLen; i++) {
                if ("name".equals(attrs.getLocalName(i))) {
                    n.setNameAttribute(getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), attrs.getValue(i), java.lang.String.class, n, false));
                } else {
                    if (jspAttrIndex < jspAttrSize) {
                        jspAttrs[jspAttrIndex++] = getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), attrs.getValue(i), java.lang.Object.class, n, false);
                    }
                }
            }
        ...
        private void checkXmlAttributes(Node.CustomTag n, Node.JspAttribute[] jspAttrs, Hashtable<String, Object> tagDataAttrs) throws JasperException {
            ...
            TagAttributeInfo[] tldAttrs = tagInfo.getAttributes();
            Attributes attrs = n.getAttributes();
            boolean checkDeferred = !pageInfo.isDeferredSyntaxAllowedAsLiteral() && !(tagInfo.getTagLibrary().getRequiredVersion().equals("2.0") || tagInfo.getTagLibrary().getRequiredVersion().equals("1.2"));
            for (int i = 0; attrs != null && i < attrs.getLength(); i++) {
                boolean found = false;
                ...
                boolean expression = runtimeExpression || (elExpression && (!pageInfo.isELIgnored() || (!"true".equalsIgnoreCase(pageInfo.getIsELIgnored()) && checkDeferred && deferred)));
                            ...
                            if (!expression) {
                                ...
                                if (expectedType != null) {
                                    ...
                                    try {
                                        ...
                                        err.jspError(n, "jsp.error.unknown_attribute_type", tldAttrs[j].getName(), expectedType);
                                    }
                                    // Check casting
                                    try {
                                        ELSupport.checkType(attrs.getValue(i), expectedClass);
                                    } catch (Exception e) {
                                        err.jspError(n, "jsp.error.coerce_to_type", tldAttrs[j].getName(), expectedType, attrs.getValue(i));
                                    }
                                }
                                ...
                                try {
                                    ...
                                    if (elExpression) {
                                        ...
                                        // Runtime expression
                                        jspAttrs[i] = getJspAttribute(tldAttrs[j], attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), attrs.getValue(i), expectedType, n, false);
                                    }
                                } catch (ClassNotFoundException e) {
                                    err.jspError(n, "jsp.error.unknown_attribute_type", tldAttrs[j].getName(), tldAttrs[j].getTypeName());
                                }
                            }
                        } else {
                ...
                if (!found) {
                    if (tagInfo.hasDynamicAttributes()) {
                        jspAttrs[i] = getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), attrs.getValue(i), java.lang.Object.class, n, true);
                    } else {
        ...
        private Node.JspAttribute getJspAttribute(TagAttributeInfo tai, String qName, String uri, String localName, String value, Class expectedType, Node n, boolean dynamic) throws JasperException {
            ...
            if (value != null) {
                if (n.getRoot().isXmlSyntax() && value.startsWith("%=")) {
                    ...
                    if (el.containsEL() && !pageInfo.isELIgnored() && ((!pageInfo.isDeferredSyntaxAllowedAsLiteral() && deferred) || !deferred)) {
                        validateFunctions(el, n);
