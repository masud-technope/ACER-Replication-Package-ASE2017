...
public class U {
    ...
    // TODO 10
    public static final int LONG_TIMEOUT_SECONDS = 2;
    ...
    static void setAdminCredentials(DefaultHttpClient c) {
        c.getCredentialsProvider().setCredentials(AuthScope.ANY, new UsernamePasswordCredentials(ADMIN, ADMIN));
    ...
    static JSONObject getBundleData(CrankstartSetup C, DefaultHttpClient client, String symbolicName) throws ClientProtocolException, IOException, JSONException {
        ...
        return new JSONObject(e.execute(b.buildGetRequest("/system/console/bundles/" + symbolicName + ".json").withCredentials(U.ADMIN, U.ADMIN)).assertStatus(200).getContent());
    }
