...
@Properties({ @Property(name = Constants.SERVICE_DESCRIPTION, value = "Authenticator Login Servlet"), @Property(name = Constants.SERVICE_VENDOR, value = "The Apache Software Foundation"), @Property(name = "sling.servlet.methods", value = { "GET", "POST" }) })
    ...
    protected void service(SlingHttpServletRequest request, SlingHttpServletResponse response) throws IOException {
        ...
        if (request.getAuthType() != null) {
            ...
            if (isSelf(resourcePath)) {
                ...
                log.warn("doGet: Redirecting to {} to prevent login loop for resource {}", redirectTarget, resourcePath);
