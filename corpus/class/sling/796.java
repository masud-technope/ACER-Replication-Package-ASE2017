...
public class NestedModelsMerger extends ArtifactsVisitor {
    ...
    boolean isNestedModel(Artifact a) {
        ...
        final boolean result = MavenResolver.SLINGFEATURE_ARTIFACT_TYPE.equals(aType) || MavenResolver.SLINGFEATURE_ARTIFACT_TYPE.equals(classifier) || MavenResolver.SLINGSTART_ARTIFACT_TYPE.equals(aType) || MavenResolver.SLINGSTART_ARTIFACT_TYPE.equals(classifier);
        return result;
    }
