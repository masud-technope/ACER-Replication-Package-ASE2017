...
public class CreateDeleteResourceResolverTest {
    ...
    private static final Map<String, Object> PROPS1 = ImmutableMap.<String, Object>builder().put("prop1", "value1").build();

    private static final Map<String, Object> PROPS2 = ImmutableMap.<String, Object>builder().put("prop2", "value2").build();
