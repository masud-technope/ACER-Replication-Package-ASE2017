...
public class RetryRule implements TestRule {
    ...
    public String toString() {
        return new StringBuilder().append(getClass().getSimpleName()).append(", default interval=").append(defaultInterval).append(" msec, default timeout=").append(defaultTimeout).append(" msec").toString();
    }
