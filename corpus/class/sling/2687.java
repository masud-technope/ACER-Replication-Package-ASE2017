...
// we want to spin up the container once only.
...
public class CacheIT extends AbstractOSGiRunner {
    ...
    public Option[] getOptions() {
        // check();
        return options(provision(// Infinispan needs a transaction API.
        mavenBundle("org.apache.geronimo.specs", "geronimo-jta_1.1_spec"), mavenBundle("org.apache.sling", "org.apache.sling.commons.cache.api")));
    }
