...
public final class EvalResult {
    ...
    public Object getValue() {
        if (!isConstant()) {
            throw new CompilerException(CompilerException.CompilerExceptionCause.COMPILER_ERRORS, new UnsupportedOperationException("Cannot get constant value from non-constant result."));
        }
        return value;
    }
    ...
    private static ExpressionNode asLiteral(Object value) {
        ...
        throw new CompilerException(CompilerException.CompilerExceptionCause.COMPILER_ERRORS, new UnsupportedOperationException("Cannot " + "transform to literal: " + value));
    }
