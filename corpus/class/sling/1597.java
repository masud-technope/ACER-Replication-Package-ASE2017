...
public abstract class PathBasedHolder implements Comparable<PathBasedHolder> {
    ...
    final String getProvider() {
        ...
        final String descr = OsgiUtil.toString(serviceReference.getProperty(Constants.SERVICE_DESCRIPTION), null);
        if (descr != null) {
            return descr;
        }
        return "Service " + OsgiUtil.toString(serviceReference.getProperty(Constants.SERVICE_ID), "unknown");
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj.getClass() == getClass()) {
            ...
            return fullPath.equals(other.fullPath) && ((serviceReference == null && other.serviceReference == null) || (serviceReference != null && serviceReference.equals(other.serviceReference)));
        }
        return false;
    }
}
