...
public class GenerateAdapterMetadataMojo extends AbstractMojo {
    ...
    private void addResource() {
        ...
        boolean found = false;
        @SuppressWarnings("unchecked") final Iterator<Resource> rsrcIterator = this.project.getResources().iterator();
    ...
    private void parseAdaptablesAnnotation(final AnnotationNode annotation, final ClassNode classNode, final JSONObject descriptor) throws JSONException {
    ...
    private void parseAdaptableAnnotation(final AnnotationNode annotation, final ClassNode annotatedClass, final JSONObject descriptor) throws JSONException {
    ...
    @SuppressWarnings("unchecked")
    private void parseAdapterAnnotation(final AnnotationNode annotation, final ClassNode annotatedClass, final JSONObject adaptableDescription) throws JSONException {
