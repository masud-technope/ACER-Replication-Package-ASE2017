...
public abstract class AbstractAccessPostServlet extends SlingAllMethodsServlet {
	 ...
	 * @param changes
	 */
    protected abstract void handleOperation(SlingHttpServletRequest request, AbstractPostResponse response, List<Modification> changes) throws RepositoryException;
     ...
     */
    protected AccessControlList getAccessControlList(final AccessControlManager accessControlManager, final String resourcePath, final boolean mayCreate) throws RepositoryException {
