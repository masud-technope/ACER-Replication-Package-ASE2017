...
public class ServicesListener {
    ...
    public  ServicesListener(final BundleContext bundleContext, final List<ScanConfiguration> configs) {
    ...
    private void startScanner(final OsgiInstaller installer, final SlingSettingsService settings) {
        if (!running) {
            ...
            this.registration = this.bundleContext.registerService(UpdateHandler.class.getName(), this.installer, props);
            running = true;
        }
    }
