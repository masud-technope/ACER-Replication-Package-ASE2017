...
public class ResourceUtilTest {
    ...
    public void test_adaptTo() {
        ...
        this.context.checking(new Expectations() {
            ...
            {
                allowing(a).adaptTo(List.class);
                will(returnValue(new ArrayList<Object>()));
                allowing(b).adaptTo(List.class);
                will(returnValue(new ArrayList<Object>()));
                allowing(c).adaptTo(List.class);
                will(returnValue(null));
                allowing(a).adaptTo(Map.class);
                will(returnValue(new HashMap<Object, Object>()));
                allowing(b).adaptTo(Map.class);
                will(returnValue(new HashMap<Object, Object>()));
                allowing(c).adaptTo(Map.class);
                will(returnValue(new HashMap<Object, Object>()));
                allowing(a).adaptTo(Long.class);
                will(returnValue(null));
                allowing(b).adaptTo(Long.class);
                will(returnValue(new Long(1)));
                allowing(c).adaptTo(Long.class);
                will(returnValue(new Long(2)));
                allowing(a).adaptTo(Boolean.class);
                will(returnValue(new Boolean(true)));
                allowing(b).adaptTo(Boolean.class);
                will(returnValue(null));
                allowing(c).adaptTo(Boolean.class);
                will(returnValue(new Boolean(false)));
                allowing(a).adaptTo(String.class);
                will(returnValue(null));
                allowing(b).adaptTo(String.class);
                will(returnValue(null));
                allowing(c).adaptTo(String.class);
                will(returnValue(null));
            }
        });
