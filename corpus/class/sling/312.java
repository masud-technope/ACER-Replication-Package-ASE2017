...
public class WebConsoleFtpLet extends HttpServlet implements Ftplet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        pw.printf("FTP Server active. Started: %s. Uptime %d:%02d:%02d.", start, uptime / 3600, uptime / 60 % 60, uptime % 60);
        pw.println("</p>");
        ...
        pw.printf("<td>%d created, %d removed</td>%n", this.stats.getTotalDirectoryCreated(), this.stats.getTotalDirectoryRemoved());
        pw.println("</tr>");
        pw.println("<tr>");
        ...
        pw.printf("<td>%d (%d MB)</td>%n", this.stats.getTotalUploadNumber(), this.stats.getTotalUploadSize() / 1024 / 1024);
        pw.println("</tr>");
        pw.println("</tr>");
        pw.println("<tr>");
        pw.println("<th>File Downloads</th>");
        pw.printf("<td>%d (%d MB)</td>%n", this.stats.getTotalDownloadNumber(), this.stats.getTotalDownloadSize() / 1024 / 1024);
        pw.println("</tr>");
        pw.println("</table>");
        pw.println("<p>&nbsp;</p>");
        pw.println("<table class=\"nicetable\">");
        ...
        for (SessionEntry entry : this.sessions.values()) {
            ...
            pw.printf("<td>%s:%s</td>%n", session.getClientAddress().getAddress().getHostAddress(), session.getClientAddress().getPort());
