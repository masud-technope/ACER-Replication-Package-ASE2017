...
public interface QueryBuilder {
     ...
     */
    @Nonnull
    QueryBuilder at(@Nonnull String... path);
     ...
     */
    @Nonnull
    QueryBuilder isA(@Nonnull String resourceType);
     ...
     */
    @Nonnull
    QueryBuilder name(@Nonnull String resourceName);
     ...
     */
    @Nonnull
    PropertyBuilder property(@Nonnull String name);
}
