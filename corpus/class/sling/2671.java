...
class ControlListener implements Runnable {
     ...
     */
     ControlListener(final Main slingMain, final String listenSpec) {
        ...
        // socketAddress = this.getSocketAddress(listenSpec, selectNewPort);
    ...
    public void run() {
        ...
        try {
            ...
            writePortToConfigFile(getConfigFile(), new InetSocketAddress(server.getInetAddress(), server.getLocalPort()), this.secretKey);
    ...
    private int sendCommand(final String command) {
        if (configure(true)) {
            ...
            try {
                ...
                // LSB code for everything's fine
                return 0;
    ...
    private static void writePortToConfigFile(final File configFile, final InetSocketAddress socketAddress, final String secretKey) {
