...
public interface ValidationModelProvider {
     ...
     */
    @Nonnull
    public Collection<ValidationModel> getModel(@Nonnull String relativeResourceType, @Nonnull Map<String, Validator<?>> validatorsMap, @Nonnull ResourceResolver resourceResolver) throws IllegalStateException;
}
