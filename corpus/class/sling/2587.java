...
public class ValidationModelImpl implements ValidationModel {
    ...
    @Nonnull
    private final String[] applicablePaths;

    @Nonnull
    private final List<ChildResource> children;

    public  ValidationModelImpl(@Nonnull List<ResourceProperty> resourceProperties, @Nonnull String validatedResourceType, String[] applicablePaths, @Nonnull List<ChildResource> children) {
    ...
    public String toString() {
        return "ResourceValidationModel [resourceProperties=" + resourceProperties + ", validatedResourceType=" + validatedResourceType + ", applicablePaths=" + Arrays.toString(applicablePaths) + ", children=" + children + "]";
    }
