...
public class ErbScriptEngineFactory extends AbstractScriptEngineFactory {
    ...
    public static final String ERB_SCRIPT_EXTENSION = "erb";

    public static final String RUBY_MIME_TYPE = "application/x-ruby";

    public static final String SHORT_NAME = "erb";
