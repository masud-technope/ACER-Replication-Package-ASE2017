...
public class ModelProcessorTest {
    ...
    static final class TestModelProcessor extends ModelProcessor {
        ...
        protected Artifact processArtifact(Artifact artifact, Feature feature, RunMode runMode) {
            Artifact newArtifact = new Artifact(artifact.getGroupId() != null ? "#" + artifact.getGroupId() : null, artifact.getArtifactId() != null ? "#" + artifact.getArtifactId() : null, artifact.getVersion() != null ? "#" + artifact.getVersion() : "#LATEST", artifact.getClassifier() != null ? "#" + artifact.getClassifier() : null, artifact.getType() != null ? "#" + artifact.getType() : null);
            return newArtifact;
        }
