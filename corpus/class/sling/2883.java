...
@Properties({ @Property(name = "service.description", value = "Sling Info Servlet"), @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = "sling.servlet.paths", value = "/system/sling/info") })
...
*/
    ...
    protected void activate(ComponentContext context) {
        infoProviders.put(SessionInfoProvider.PROVIDER_LABEL, new SessionInfoProvider());
    }
}
