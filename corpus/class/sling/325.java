...
public class ContentXmlHandlerTest {
    ...
    private ResourceProxy parseContentXmlFile(String fileName, String rootResourcePath) throws ParserConfigurationException, SAXException, IOException {
    ...
    @Test
    @SuppressWarnings("unchecked")
    public void parseSingleExplicitMultiValuedProperties() throws ParserConfigurationException, SAXException, IOException {
