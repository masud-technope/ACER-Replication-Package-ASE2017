...
public class SelectorSegment {
    ...
    public boolean equals(Object obj) {
        ...
        return new EqualsBuilder().append(type, rhs.type).append(attributes, rhs.attributes).append(modifiers, rhs.modifiers).append(hierarchyOperator, rhs.hierarchyOperator).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(type).append(attributes).append(modifiers).append(hierarchyOperator).toHashCode();
    }
