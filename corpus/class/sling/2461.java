...
public interface QueryInstructionsBuilder {
     ...
     */
    @Nonnull
    QueryInstructionsBuilder limit(int limit);

    /**
     * Specify the continuation key.
     */
    @Nonnull
    QueryInstructionsBuilder continueAt(@Nonnull String continuationKey);
     ...
     */
    @Nonnull
    QueryInstructionsBuilder sortAscendingBy(@Nonnull String propName);
     ...
     */
    @Nonnull
    QueryInstructionsBuilder sortDescendingBy(@Nonnull String propName);
