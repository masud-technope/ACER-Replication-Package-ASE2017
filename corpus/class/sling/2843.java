...
public class DataSourceFactory {
    ...
    @Property(intValue = PoolProperties.DEFAULT_MAX_ACTIVE)
    static final String //defaults to maxActive
    PROP_MAXIDLE = "maxIdle";

    @Property(intValue = 10)
    static final String //defaults to initialSize
    PROP_MINIDLE = "minIdle";
     ...
     */
    private static final Set<String> PROPS_WITH_DFEAULT = Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(PROP_DEFAULTAUTOCOMMIT, PROP_DEFAULTREADONLY, PROP_DEFAULTTRANSACTIONISOLATION)));
    ...
    private void registerJmx(ConnectionPool pool) throws SQLException {
        ...
        try {
            ...
            log.warn("Error occurred while registering the JMX Bean for " + "connection pool with name {}", jmxName, e);
        }
    }
