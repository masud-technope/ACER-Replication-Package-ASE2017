...
@Reference(name = "repository", referenceInterface = Repository.class, policy = ReferencePolicy.DYNAMIC, cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE)
public class RepositoryPrinterProvider {
    ...
    private void registerPrinter(final BundleContext processContext, final Repository repo, final Map<String, Object> props) {
        ...
        final ServiceRegistration reg = processContext.registerService(RepositoryPrinter.class.getName(), printer, printer.getProperties());
