...
@Properties({ @Property(name = InventoryPrinter.FORMAT, value = "JSON", propertyPrivate = true), @Property(name = InventoryPrinter.NAME), @Property(name = InventoryPrinter.TITLE), @Property(name = InventoryPrinter.WEBCONSOLE, boolValue = false, propertyPrivate = true) })
