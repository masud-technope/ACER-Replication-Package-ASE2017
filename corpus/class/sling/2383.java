...
public class DynamicClassLoaderManagerImpl implements DynamicClassLoaderManager {
    ...
    public  DynamicClassLoaderManagerImpl(final BundleContext ctx, final PackageAdmin pckAdmin, final ClassLoader parent, final DynamicClassLoaderManagerFactory factory) {
        this.deprecatedProviderTracker = new ServiceTracker(ctx, DynamicClassLoaderProvider.class.getName(), new ServiceTrackerCustomizer() {
            ...
            public void removedService(final ServiceReference serviceRef, final Object paramObject) {
                ctx.ungetService(serviceRef);
            }

            public void modifiedService(final ServiceReference serviceRef, final Object paramObject) {
            // nothing to do
            }
            ...
            public Object addingService(final ServiceReference serviceRef) {
                ...
                if (obj != null) {
                    logger.warn("Dynamic class loader does not support deprecated dynamic class loader providers: {} : {}", serviceRef, obj);
                }
                return obj;
            }
        });
