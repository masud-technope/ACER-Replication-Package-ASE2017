...
abstract class AbstractInjectableElement implements InjectableElement {
    ...
    public  AbstractInjectableElement(AnnotatedElement element, Type type, String defaultName, StaticInjectAnnotationProcessorFactory[] processorFactories, DefaultInjectionStrategy defaultInjectionStrategy) {
