...
public class VltUtils {
    ...
    static final Logger log = LoggerFactory.getLogger(VltUtils.class);
    ...
    public static ExportOptions getExportOptions(WorkspaceFilter filter, String[] packageRoots, String packageGroup, String packageName, String packageVersion) {
