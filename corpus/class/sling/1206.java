...
public class ParentsTest {
    ...
    public void testFilteredParents() {
        SlingQuery query = $(tree.getChild("application/configuration/labels/jcr:content/configParsys/tab/items")).parents("cq:Page");
        assertResourceSetEquals(query.iterator(), "labels", "configuration", "application", "/");
    }

    @Test
    public void testNoParents() {
        SlingQuery query = $(tree.getChild("application/configuration/labels/jcr:content/configParsys/tab/items")).parents("cq:Undefined");
