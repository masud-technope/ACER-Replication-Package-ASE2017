...
public class ScriptSelectionTest extends HelperTestBase {
    ...
    protected final String[] SET_A = { "/apps/foo/bar/html.esp", "/apps/foo/bar/POST.esp", "/apps/foo/bar/print.esp", "/apps/foo/bar/print", "/apps/foo/bar/print/POST.esp", "/apps/foo/bar/mail.POST.esp", "/apps/foo/bar/xml.esp", "/apps/foo/bar/print.xml.esp", "/apps/foo/bar/print/DELETE.esp", "/apps/foo/bar/DELETE.esp", "/apps/foo/bar/SPURIOUS.esp", "/apps/foo/bar/UNKNOWN.esp" };
    ...
    public void testMultipleSelectorsA() {
        final String[] scripts = { "/apps/foo/bar/print", "/apps/foo/bar/print/a4.esp", "/apps/foo/bar/print.a4.esp", "/apps/foo/bar/html.print.a4.esp", "/apps/foo/bar/html.print.esp", "/apps/foo/bar/print.esp", "/apps/foo/bar/print.html.esp", "/apps/foo/bar/a4.esp", "/apps/foo/bar/a4.html.esp", "/apps/foo/bar/html.esp" };
        assertScript("GET", "print.a4", "html", scripts, "/apps/foo/bar/print/a4.esp");
    }

    public void testMultipleSelectorsB() {
        final String[] scripts = { "/apps/foo/bar/print.a4.esp", "/apps/foo/bar/print.esp", "/apps/foo/bar/a4.esp", "/apps/foo/bar/html.esp" };
    ...
    public void testMultipleSelectorsE() {
        final String[] scripts = { "/apps/foo/bar/bar.print.a4.esp", "/apps/foo/bar/bar.print.esp", "/apps/foo/bar/print.esp", "/apps/foo/bar/a4.esp", "/apps/foo/bar/bar.a4.esp", "/apps/foo/bar/print", "/apps/foo/bar/print/a4.esp", "/apps/foo/bar/html.esp" };
        assertScript("GET", "print.a4", "html", scripts, "/apps/foo/bar/print/a4.esp");
        assertScript("GET", "a4.print", "html", scripts, "/apps/foo/bar/a4.esp");
        assertScript("GET", null, "html", scripts, "/apps/foo/bar/html.esp");
    }
