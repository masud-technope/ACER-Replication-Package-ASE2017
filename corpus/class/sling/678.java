...
public enum HierarchyOperator implements  {
    ...
    public abstract <T> Function<?, ?> getFunction(SelectorSegment segment, SearchStrategy strategy, TreeProvider<T> provider);
