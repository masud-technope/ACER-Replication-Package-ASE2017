...
public class LegacyResourceProviderFactoryAdapter extends ResourceProvider<LegacyResourceProviderAdapter> {
    ...
    @Override
    @Nonnull
    public LegacyResourceProviderAdapter authenticate(@Nonnull final Map<String, Object> authenticationInfo) throws LoginException {
        return new LegacyResourceProviderAdapter(rpFactory.getResourceProvider(authenticationInfo), languages, ownsRoot);
    }

    @Override
    public void logout(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx) {
    ...
    @Override
    public void refresh(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx) {
        ctx.getProviderState().refresh((ResolverContext) ctx);
    }

    @Override
    @CheckForNull
    public JCRQueryProvider<LegacyResourceProviderAdapter> getJCRQueryProvider() {
    ...
    @Override
    public Collection<String> getAttributeNames(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx) {
        return ctx.getProviderState().getAttributeNames((ResolverContext) ctx);
    }

    @Override
    public Object getAttribute(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx, @Nonnull final String name) {
        return ctx.getProviderState().getAttribute((ResolverContext) ctx, name);
    }

    @Override
    public boolean isLive(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx) {
        return ctx.getProviderState().isLive((ResolverContext) ctx);
    }

    @Override
    public Resource create(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx, final String path, final Map<String, Object> properties) throws PersistenceException {
        return ctx.getProviderState().create((ResolverContext) ctx, path, properties);
    }

    @Override
    public void delete(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx, @Nonnull final Resource resource) throws PersistenceException {
        ctx.getProviderState().delete((ResolverContext) ctx, resource);
    }

    @Override
    public void revert(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx) {
        ctx.getProviderState().revert((ResolverContext) ctx);
    }

    @Override
    public void commit(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx) throws PersistenceException {
        ctx.getProviderState().commit((ResolverContext) ctx);
    }

    @Override
    public boolean hasChanges(@Nonnull final ResolverContext<LegacyResourceProviderAdapter> ctx) {
    ...
    private static class JCRQueryProviderAdapter implements JCRQueryProvider<LegacyResourceProviderAdapter> {
        ...
        @Override
        public Iterator<Resource> findResources(ResolverContext<LegacyResourceProviderAdapter> ctx, String query, String language) {
            return ctx.getProviderState().getJCRQueryProvider().findResources((ResolverContext) ctx, query, language);
        }

        @Override
        public Iterator<ValueMap> queryResources(ResolverContext<LegacyResourceProviderAdapter> ctx, String query, String language) {
