...
public class SimpleXmlSerializationManager implements SerializationManager, SerializationDataBuilder {
    ...
    public String getBaseResourcePath(String serializationFilePath) {
        if (!serializationFilePath.endsWith(CONTENT_XML)) {
            throw new IllegalArgumentException("File path " + serializationFilePath + "does not end with '" + File.separatorChar + CONTENT_XML + "'");
        }
    ...
    @Override
    public SerializationDataBuilder newBuilder(Repository repository, File contentSyncRoot) throws SerializationException {
        return this;
    }
