...
public class MainFrame extends JFrame {
    ...
    public  MainFrame(final File file, final int limit, final Dimension screenSize) throws FileNotFoundException, IOException {
        ...
        Util.setupComponentLocationSize(this, MAIN_X, MAIN_Y, MAIN_WIDTH, MAIN_HEIGHT, (int) screenSize.getWidth() / 4, 0, (int) screenSize.getWidth() / 2, (int) screenSize.getHeight() / 4);
