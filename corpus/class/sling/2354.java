...
@Component
@Service
@Properties({ @Property(name = ContentReader.PROPERTY_EXTENSIONS, value = { "zip", "jar" }), @Property(name = ContentReader.PROPERTY_TYPES, value = { "application/zip", "application/java-archive" }) })
