...
@Component(label = "Apache Sling JCR Content Loader Sample GsonReader", description = "parses JSON content with Gson", immediate = true, metatype = true)
@Service
@Properties({ @Property(name = Constants.SERVICE_VENDOR, value = "The Apache Software Foundation"), @Property(name = Constants.SERVICE_DESCRIPTION, value = "Apache Sling JCR Content Loader Sample GsonReader"), @Property(name = ContentReader.PROPERTY_EXTENSIONS, value = { "json" }, unbounded = PropertyUnbounded.ARRAY), @Property(name = ContentReader.PROPERTY_CONTENTTYPES, value = { "application/json" }, unbounded = PropertyUnbounded.ARRAY), @Property(name = Constants.SERVICE_RANKING, intValue = 1, propertyPrivate = false) })
