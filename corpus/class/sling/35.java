...
T extends Item> extends AbstractResource implements Resource {
    ...
    protected  JcrItemResource(final ResourceResolver resourceResolver, final String path, final String version, final T item, final ResourceMetadata metadata) {
     ...
     * property is not set
     */
    protected String getResourceTypeForNode(final Node node) throws RepositoryException {
        String result = null;
    ...
    public static long getContentLength(final Property property) throws RepositoryException {
        ...
        try {
            ...
            LOGGER.warn("getPropertyContentLength: Cannot determine length of non-binary property {}: {}", property, uee);
        }
        return -1;
    }
