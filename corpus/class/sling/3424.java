...
public class WebConsoleTestActivator implements BundleActivator {
    ...
    public static Class[] BUNDLE_CLASS_NAMES = { WebConsoleTestActivator.class, WebConsoleTestTurboFilter.class, WebConsoleTestConfigProvider.class, WebConsoleTestAppender.class, WebConsoleTestFilter.class };
