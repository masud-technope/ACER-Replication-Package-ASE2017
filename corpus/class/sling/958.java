...
public class DefaultBatcherTest {
    ...
    public void unrelatedDeletesAreNotCompacted() {
        assertCommandsAreNotCompacted(new DeleteNodeCommand(mockRepo, credentials, "/content/branch", null), new DeleteNodeCommand(mockRepo, credentials, "/content/sub", null));
    }
    ...
    public void unrelatedAddOrUpdatesAreNotCompacted() {
        assertCommandsAreNotCompacted(new AddOrUpdateNodeCommand(mockRepo, credentials, null, null, new ResourceProxy("/content/a"), null), new AddOrUpdateNodeCommand(mockRepo, credentials, null, null, new ResourceProxy("/content/b"), null));
    }
    ...
    public void unrelatedReorderingsAreNotCompacted() {
        assertCommandsAreNotCompacted(new ReorderChildNodesCommand(mockRepo, credentials, new ResourceProxy("/content/a"), null), new ReorderChildNodesCommand(mockRepo, credentials, new ResourceProxy("/content/b"), null));
    }

    @Test
    public void unhandledCommandIsReturnedAsIs() {
        assertCommandsAreNotCompacted(new GetNodeContentCommand(mockRepo, credentials, "/content", null), new GetNodeContentCommand(mockRepo, credentials, "/content", null));
    }
}
