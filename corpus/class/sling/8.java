...
public class PreparePackageMojo extends AbstractSlingStartMojo {
     ...
     */
    private void unpackBaseArtifact(final Model model, final File outputDirectory, final String packageRunMode) throws MojoExecutionException {
