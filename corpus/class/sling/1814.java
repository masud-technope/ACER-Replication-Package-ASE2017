...
public abstract class AbstractDispatcherTagHandler extends TagSupport {
    ...
    protected abstract void dispatch(RequestDispatcher dispatcher, ServletRequest request, ServletResponse response) throws IOException, ServletException, JspTagException;
