...
public class ResourceChange {
     ...
     */
    public  ResourceChange(@Nonnull final ChangeType changeType, @Nonnull final String path, final boolean isExternal, final Set<String> addedPropertyNames, final Set<String> changedPropertyNames, final Set<String> removedPropertyNames) {
        this.path = path;
