...
public class MapEntriesTest {
    ...
    @Test
    public //SLING-4847
    void test_doNodeAdded1() throws Exception {
    ...
    @Test
    public //SLING-4891
    void test_getVanityPaths_2() throws Exception {
    ...
    @Test
    public //SLING-4891
    void test_getVanityPaths_3() throws Exception {
        final Resource justVanityPath = mock(Resource.class, "justVanityPath");
        when(resourceResolver.getResource("/justVanityPath")).thenReturn(justVanityPath);
        when(justVanityPath.getPath()).thenReturn("/justVanityPath");
        when(justVanityPath.getName()).thenReturn("justVanityPath");
    ...
    @Test
    public //SLING-4891
    void test_loadVanityPaths() throws Exception {
        Field field1 = MapEntries.class.getDeclaredField("maxCachedVanityPathEntries");
        field1.setAccessible(true);
        field1.set(mapEntries, 2);
        final Resource justVanityPath = mock(Resource.class, "justVanityPath");
    ...
    @Test
    public //SLING-4891
    void test_loadVanityPaths_1() throws Exception {
        final Resource justVanityPath = mock(Resource.class, "justVanityPath");
        when(resourceResolver.getResource("/justVanityPath")).thenReturn(justVanityPath);
        when(justVanityPath.getPath()).thenReturn("/justVanityPath");
        when(justVanityPath.getName()).thenReturn("justVanityPath");
    ...
    @Test
    public //SLING-4883
    void test_concutrrent_getResolveMapsIterator() throws Exception {
