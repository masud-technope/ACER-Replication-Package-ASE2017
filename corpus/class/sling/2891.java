...
public class JarBuilder {
    ...
    public InputStream buildJar(final IFolder sourceDir) throws CoreException {
        ...
        if (manifestResource == null || manifestResource.getType() != IResource.FILE) {
            throw new CoreException(new Status(IStatus.ERROR, Activator.PLUGIN_ID, "No file named " + JarFile.MANIFEST_NAME + " found under " + sourceDir));
        }
    ...
    private void zipDir(final IFolder sourceDir, final ZipOutputStream zos, final String path) throws CoreException, IOException {
