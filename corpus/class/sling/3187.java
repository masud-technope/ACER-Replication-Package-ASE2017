...
public class ScriptResource extends AbstractResource {
    ...
    public  ScriptResource(final Resource resource, final ThreadLocal<ResourceResolver> perThreadScriptResolver, final ResourceResolver sharedResourceResolver) {
