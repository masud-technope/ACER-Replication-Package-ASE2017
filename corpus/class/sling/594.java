...
public class LauncherCallable implements Callable<ProcessDescription> {
    ...
    public  LauncherCallable(final Log logger, final ServerConfiguration configuration, final LaunchpadEnvironment environment) {
        this.logger = logger;
    ...
    public ProcessDescription call() throws Exception {
        ...
        try {
            ...
            this.logger.info("Started Launchpad " + configuration.getId() + " [" + configuration.getRunmode() + ", " + configuration.getPort() + "]");
        } finally {
            // stop control port
