...
public class JobHandlingTest extends AbstractJobHandlingTest {
    ...
    public void testSimpleJobExecutionUsingJobConsumer() throws Exception {
        ...
        final ServiceRegistration reg = this.registerJobConsumer(TOPIC, new JobConsumer() {
    ...
    public void testSimpleJobExecutionUsingJobExecutor() throws Exception {
        final Barrier cb = new Barrier(2);
        final ServiceRegistration reg = this.registerJobExecutor(TOPIC, new JobExecutor() {
    ...
    public void testManyJobs() throws Exception {
        final ServiceRegistration reg1 = this.registerJobConsumer(TOPIC, new JobConsumer() {
        ...
        final ServiceRegistration reg2 = this.registerEventHandler(NotificationConstants.TOPIC_JOB_FINISHED, new EventHandler() {
    ...
    public void testNotifications() throws Exception {
        ...
        final ServiceRegistration eh1Reg = this.registerEventHandler(NotificationConstants.TOPIC_JOB_CANCELLED, new EventHandler() {
        ...
        final ServiceRegistration eh2Reg = this.registerEventHandler(NotificationConstants.TOPIC_JOB_FAILED, new EventHandler() {
        ...
        final ServiceRegistration eh3Reg = this.registerEventHandler(NotificationConstants.TOPIC_JOB_FINISHED, new EventHandler() {
        ...
        final ServiceRegistration eh4Reg = this.registerEventHandler(NotificationConstants.TOPIC_JOB_STARTED, new EventHandler() {
    ...
    public void testNoJobProcessor() throws Exception {
        final AtomicInteger count = new AtomicInteger(0);
        final ServiceRegistration eh1 = this.registerJobConsumer(TOPIC, new JobConsumer() {
