...
public class HistoryCleanUpTask implements JobExecutor {
    ...
    // older than two days
    private static final int DEFAULT_AGE = 60 * 24 * 2;
    ...
    private void cleanup(final Calendar removeDate, final ResourceResolver resolver, final JobExecutionContext context, final String basePath, final String[] topics, final List<String> stateList) throws PersistenceException {
