...
public class XProcScriptEngineFactory extends AbstractScriptEngineFactory {
    ...
    public static final String XPROC_SCRIPT_EXTENSION = "xpl";

    public static final String XPROC_MIME_TYPE = "application/xml";

    public static final String SHORT_NAME = "XProc";
