...
class OpenIDLoginModulePlugin implements LoginModulePlugin {
     ...
     *         service on shutdown.
     */
    static ServiceRegistration register(final OpenIDAuthenticationHandler authHandler, final BundleContext bundleContext) {
    ...
    private  OpenIDLoginModulePlugin(final OpenIDAuthenticationHandler authHandler) {
