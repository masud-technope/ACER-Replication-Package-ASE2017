...
public class SlingContextImpl extends OsgiContextImpl {
     ...
     */
    public final <T1, T2> void registerAdapter(final Class<T1> adaptableClass, final Class<T2> adapterClass, final T2 adapter) {
    ...
    public final <T1, T2> void registerAdapter(final Class<T1> adaptableClass, final Class<T2> adapterClass, final Function<T1, T2> adaptHandler) {
        ...
        registerService(AdapterFactory.class, adapterFactory, ImmutableMap.<String, Object>builder().put(AdapterFactory.ADAPTABLE_CLASSES, new String[] { adaptableClass.getName() }).put(AdapterFactory.ADAPTER_CLASSES, new String[] { adapterClass.getName() }).build());
    }
}
