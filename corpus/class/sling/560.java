 ...
 */
@Component
@Service(value = { Servlet.class, GetEffectiveAcl.class })
...
public class GetEffectiveAclServlet extends AbstractGetAclServlet implements GetEffectiveAcl {
	 ...
	 */
    public JSONObject getEffectiveAcl(Session jcrSession, String resourcePath) throws RepositoryException, JSONException {
