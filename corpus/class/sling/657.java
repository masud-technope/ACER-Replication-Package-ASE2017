...
@Properties({ @Property(name = Plugin.SCR_PROP_NAME_BLOCK_NAME, value = "list"), @Property(name = Plugin.SCR_PROP_NAME_PRIORITY, intValue = 130) })
    ...
    public PluginInvoke invoke(final Expression expression, final PluginCallInfo callInfo, final CompilerContext compilerContext) {
        return new DefaultPluginInvoke() {
            ...
            public void beforeElement(PushStream stream, String tagName) {
                ...
                stream.emit(new VariableBinding.Start(collectionSizeVar, new UnaryOperation(UnaryOperator.LENGTH, new Identifier(listVariable))));
