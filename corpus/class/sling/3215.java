...
public class SynchronousJcrResourceListener extends JcrResourceListener implements SynchronousEventListener {
    ...
    public  SynchronousJcrResourceListener(final SlingRepository repo, final BundleContext bundleContext, final ResourceResolver resolver, final ServiceTracker tracker) throws LoginException, RepositoryException, NoSuchFieldException {
