...
public class EstablishedClusterView extends LocalClusterView {
    ...
    public  EstablishedClusterView(final Config config, final View view, final String localId) {
        ...
        final Iterator<Resource> it1 = members.getChildren().iterator();
        ...
        for (Iterator<Resource> it2 = instanceRess.iterator(); it2.hasNext(); ) {
            ...
            EstablishedInstanceDescription instance = new EstablishedInstanceDescription(this, instanceResource, slingId, slingId.equals(leaderId), slingId.equals(localId));
