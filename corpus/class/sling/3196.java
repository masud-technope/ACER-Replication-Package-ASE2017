...
public class SlingAllMethodsServlet extends SlingSafeMethodsServlet {
     ...
     */
    @SuppressWarnings("unused")
    protected void doPut(@Nonnull SlingHttpServletRequest request, @Nonnull SlingHttpServletResponse response) throws ServletException, IOException {
        handleMethodNotImplemented(request, response);
    }
     ...
     */
    @SuppressWarnings("unused")
    protected void doDelete(@Nonnull SlingHttpServletRequest request, @Nonnull SlingHttpServletResponse response) throws ServletException, IOException {
        handleMethodNotImplemented(request, response);
    }
     ...
     */
    @Nonnull
    protected StringBuffer getAllowedRequestMethods(@Nonnull Map<String, Method> declaredMethods) {
