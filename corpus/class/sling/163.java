...
@Properties({ @Property(name = Constants.SERVICE_DESCRIPTION, value = "Apache Sling JcrResourceResolverFactory Implementation"), @Property(name = Constants.SERVICE_VENDOR, value = "The Apache Software Foundation") })
public class JcrResourceResolverFactoryImpl implements JcrResourceResolverFactory {
     ...
     */
    public ResourceResolver getResourceResolver(final Map<String, Object> arg0) throws LoginException {
