...
public class ResourceChangeListenerWhiteboard implements ResourceProviderTracker.ObservationReporterGenerator {
    ...
    public void activate(final BundleContext bundleContext, final ResourceProviderTracker resourceProviderTracker, final String[] searchPaths) {
        this.resourceProviderTracker = resourceProviderTracker;
        this.resourceProviderTracker.setObservationReporterGenerator(this);
        this.tracker = new ServiceTracker(bundleContext, ResourceChangeListener.class.getName(), new ServiceTrackerCustomizer() {
