...
public class LocationIteratorTest extends HelperTestBase {
    ...
    private LocationIterator getLocationIterator(final String resourceType, final String resourceSuperType) {
        return this.getLocationIterator(resourceType, resourceSuperType, DEFAULT_SERVLET_NAME);
    }

    private LocationIterator getLocationIterator(final String resourceType, final String resourceSuperType, final String baseResourceType) {
        final LocationIterator li = new LocationIterator(resourceType, resourceSuperType, baseResourceType, this.resourceResolver);
        return li;
    }
    ...
    public void testSearchPathEmpty() {
        ...
        LocationIterator li = getLocationIterator(r.getResourceType(), r.getResourceSuperType());
        // 1. /foo/bar
    ...
    public void testScriptNameWithoutResourceType() {
        ...
        String root1 = "/libs";
        resourceResolver.setSearchPath(root0, root1);
        LocationIterator li = getLocationIterator("", null, "");
        assertTrue(li.hasNext());
    ...
    public void testScriptNameWithResourceType() {
        ...
        String root1 = "/libs";
        resourceResolver.setSearchPath(root0, root1);
        LocationIterator li = getLocationIterator("a/b", null);
        assertTrue(li.hasNext());
    ...
    public void testScriptNameWithResourceTypeAndSuperType() {
        ...
        String root1 = "/libs";
        resourceResolver.setSearchPath(root0, root1);
        LocationIterator li = getLocationIterator("a/b", "c/d");
        assertTrue(li.hasNext());
        assertEquals(root0 + "/a/b", li.next());
        assertTrue(li.hasNext());
        assertEquals(root1 + "/a/b", li.next());
