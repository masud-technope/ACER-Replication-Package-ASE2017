 ...
 */
@Component(metatype = true, label = "Apache Sling Distribution Packaging - Kryo Package Builder Factory", description = "OSGi configuration for Kryo package builders", configurationFactory = true, specVersion = "1.1", policy = ConfigurationPolicy.REQUIRE)
...
public class KryoDistributionPackageBuilderFactory implements DistributionPackageBuilder {
     ...
     */
    @Property(options = { @PropertyOption(name = JCRKRYO, value = "Kryo JCR packages"), @PropertyOption(name = RESOURCEKRYO, value = "Kryo Resource packages") }, value = RESOURCEKRYO, label = "type", description = "The type of this package builder")
