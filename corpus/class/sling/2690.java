...
public class ArtifactDefinition {
    ...
    public String toString() {
        if (this.bundles == null) {
            return "ArtifactDefinition [artifactId=" + artifactId + ", classifier=" + classifier + ", groupId=" + groupId + ", startLevel=" + startLevel + ", type=" + type + ", version=" + version + ", runModes=" + runModes + "]";
        } else {
    ...
    public void initDefaults(final String valueList, final char delimiter) {
        ...
        if (values.length == 6) {
            initDefaults(values[0], values[1], values[2], values[3], values[4], Integer.valueOf(values[5]));
        } else {
