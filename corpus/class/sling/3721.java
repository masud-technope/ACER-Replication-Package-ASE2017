...
public class JcrNodeResourceIterator implements Iterator<Resource> {
     ...
     */
    public  JcrNodeResourceIterator(final ResourceResolver resourceResolver, final String parentPath, final String parentVersion, final NodeIterator nodes, final HelperData helper, final PathSet excludedPaths) {
