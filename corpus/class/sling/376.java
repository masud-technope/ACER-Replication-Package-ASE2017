...
public class DistributedEventReceiver implements EventHandler, Runnable, TopologyEventListener {
    ...
    public  DistributedEventReceiver(final BundleContext bundleContext, final String rootPath, final String ownRootPath, final int cleanupPeriod, final ResourceResolverFactory rrFactory, final SlingSettingsService settings) {
        ...
        final Thread writerThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final ServiceRegistration reg = bundleContext.registerService(new String[] { EventHandler.class.getName(), Runnable.class.getName(), TopologyEventListener.class.getName() }, DistributedEventReceiver.this, props);
                ...
                try {
                    ...
                    ResourceUtil.getOrCreateResource(writerResolver, ownRootPath, DistributedEventAdminImpl.RESOURCE_TYPE_FOLDER, DistributedEventAdminImpl.RESOURCE_TYPE_FOLDER, true);
     ...
     */
    private void writeEvent(final Event event) throws PersistenceException {
        ...
        ResourceUtil.getOrCreateResource(this.writerResolver, sb.toString(), properties, DistributedEventAdminImpl.RESOURCE_TYPE_FOLDER, true);
    }
