...
public interface ResourceResolver extends Adaptable, Closeable {
     ...
     */
    @Nonnull
    Resource resolve(@Nonnull HttpServletRequest request, @Nonnull String absPath);
     ...
     */
    @Nonnull
    Resource resolve(@Nonnull String absPath);
    ...
    @Deprecated
    @Nonnull
    Resource resolve(@Nonnull HttpServletRequest request);
     ...
     */
    @CheckForNull
    Resource getResource(Resource base, @Nonnull String path);
     ...
     */
    @CheckForNull
    Resource getParent(@Nonnull Resource child);
     ...
     */
    @Nonnull
    Iterable<Resource> getChildren(@Nonnull Resource parent);
     ...
     */
    @Nonnull
    Resource create(@Nonnull Resource parent, @Nonnull String name, Map<String, Object> properties) throws PersistenceException;
