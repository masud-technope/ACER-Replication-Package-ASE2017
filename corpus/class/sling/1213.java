...
class DefaultSlingScript implements SlingScript, Servlet, ServletConfig {
     ...
     */
     DefaultSlingScript(final BundleContext bundleContext, final Resource scriptResource, final ScriptEngine scriptEngine, final Collection<BindingsValuesProvider> bindingsValuesProviders, final ServiceCache cache, final ScriptCache scriptCache) {
    ...
    private String getLoggerName() {
        ...
        // extension separator as part of name
        name = name.replace('.', '$');
        // hierarchy defined by dot
        name = name.replace('/', '.');
        return name;
    }
