...
@Properties({ @Property(name = "service.description", value = "Factory for configuration based request/access loggers"), @Property(name = "service.vendor", value = "The Apache Software Foundation") })
...
public class RequestLoggerService {
    ...
    void setup(BundleContext bundleContext, Map<String, Object> configuration) {
        ...
        if (output != null) {
            ...
            int outputType = (outputTypeObject instanceof Number) ? ((Number) outputTypeObject).intValue() : OUTPUT_TYPE_LOGGER;
