...
public class SlingServerSideTestsBase extends SlingTestBase {
    ...
    public  SlingServerSideTestsBase() {
        ...
        if (!servletOk) {
            final RetryingContentChecker servletChecker = new RetryingContentChecker(getRequestExecutor(), getRequestBuilder(), getServerUsername(), getServerPassword()) {
            ...
            log.info("Checking that {} returns status {}, timeout={} seconds", new Object[] { path, status, timeout });
