...
public class WarSelectorServletTest extends ResolutionTestBase {
    ...
    public void testSelectorOne() throws Exception {
        assertServlet(getContent(testNodeNORT.nodeUrl + ".WAR_TEST_SEL_1.txt", CONTENT_TYPE_PLAIN), WAR_SEL_SERVLET_SUFFIX);
    }

    public void testSelectorTwo() throws Exception {
        assertServlet(getContent(testNodeNORT.nodeUrl + ".WAR_TEST_SEL_2.txt", CONTENT_TYPE_PLAIN), WAR_SEL_SERVLET_SUFFIX);
    }

    public void testSelectorOther() throws Exception {
        assertNotTestServlet(getContent(testNodeNORT.nodeUrl + ".WAR_TEST_SEL_3.txt", CONTENT_TYPE_PLAIN));
    }
}
