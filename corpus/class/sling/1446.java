...
public class MockInstallableResource extends InstallableResource {
    ...
    public  MockInstallableResource(String uri, String data, String digest) {
        super(uri, new ByteArrayInputStream(data.getBytes()), null, getNextDigest(digest), InstallableResource.TYPE_BUNDLE, InstallableResource.DEFAULT_PRIORITY);
    }
    ...
    public  MockInstallableResource(String uri, InputStream is, Dictionary<String, Object> d, String digest, String type, Integer priority) {
        super(uri, is, d, digest, type != null ? type : (is != null ? InstallableResource.TYPE_BUNDLE : InstallableResource.TYPE_CONFIG), priority != null ? priority : InstallableResource.DEFAULT_PRIORITY);
    }
    ...
    public  MockInstallableResource(String uri, Dictionary<String, Object> d, String digest, String type, Integer priority) {
        super(uri, null, d, digest, type != null ? type : InstallableResource.TYPE_CONFIG, priority);
    }
