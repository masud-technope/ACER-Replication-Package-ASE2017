...
public class LeakDetector implements Runnable, BundleActivator {
    ...
    public void printConfiguration(PrintWriter pw) {
        ...
        while (itr.hasNext()) {
            ...
            if (bi.hasSingleInstance() && activeBundleIds.contains(bi.bundleId)) {
                itr.remove();
            }
        }
    ...
    private static void addHelp(PrintWriter pw) {
        ...
        boolean containsRequiredArgs = argList.contains("-XX:+UseConcMarkSweepGC") && argList.contains("-XX:+CMSClassUnloadingEnabled");
    ...
    private static class BundleInfo {
        ...
        private final Set<ClassloaderInfo> classloaderInfos = Collections.synchronizedSet(new HashSet<ClassloaderInfo>());
    ...
    private static class ClassloaderInfo implements Comparable<ClassloaderInfo> {
        ...
        public boolean equals(Object o) {
            ...
            if (systemHashCode != that.systemHashCode)
                return false;
            return true;
        }
