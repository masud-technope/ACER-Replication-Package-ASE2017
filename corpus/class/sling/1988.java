...
public final class JobScheduleBuilderImpl implements ScheduleBuilder {
    ...
    public  JobScheduleBuilderImpl(final String topic, final Map<String, Object> properties, final String name, final JobSchedulerImpl jobScheduler) {
        this.topic = topic;
    ...
    public ScheduledJobInfo add(final List<String> errors) {
        return this.jobScheduler.addScheduledJob(topic, properties, scheduleName, suspend, schedules, errors);
    }
