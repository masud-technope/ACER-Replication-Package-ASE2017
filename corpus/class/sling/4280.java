...
public abstract class ResourceProvider<T> {
     ...
     */
    @Nonnull
    public T authenticate(@Nonnull final Map<String, Object> authenticationInfo) throws LoginException {
        return null;
    }
     ...
     */
    public void logout(@Nonnull final ResolverContext<T> ctx) {
    // do nothing
    }
     ...
     * @param ctx The {@link ResolverContext}.
     */
    public void refresh(@Nonnull final ResolverContext<T> ctx) {
    // nothing to do here
    }
     ...
     */
    public boolean isLive(@Nonnull final ResolverContext<T> ctx) {
        return true;
    }
     ...
     */
    @CheckForNull
    public Resource getParent(@Nonnull final ResolverContext<T> ctx, @Nonnull final Resource child) {
     ...
     */
    @CheckForNull
    public abstract Resource getResource(@Nonnull final ResolverContext<T> ctx, @Nonnull final String path, @Nonnull final ResourceContext resourceContext, @CheckForNull final Resource parent);
     ...
     */
    @CheckForNull
    public abstract Iterator<Resource> listChildren(@Nonnull final ResolverContext<T> ctx, @Nonnull final Resource parent);
     ...
     *                               closed.
     */
    public Collection<String> getAttributeNames(@Nonnull final ResolverContext<T> ctx) {
        return null;
    }
     ...
     */
    public Object getAttribute(@Nonnull final ResolverContext<T> ctx, @Nonnull final String name) {
        return null;
    }
     ...
     */
    public Resource create(@Nonnull final ResolverContext<T> ctx, final String path, final Map<String, Object> properties) throws PersistenceException {
     ...
     * @throws PersistenceException If anything fails
     */
    public void delete(@Nonnull final ResolverContext<T> ctx, @Nonnull final Resource resource) throws PersistenceException {
     ...
     * @param ctx The {@link ResolverContext}.
     */
    public void revert(@Nonnull final ResolverContext<T> ctx) {
    // nothing to do here
    }
     ...
     * @throws PersistenceException If anything fails
     */
    public void commit(@Nonnull final ResolverContext<T> ctx) throws PersistenceException {
    // nothing to do here
    }
     ...
     * @param ctx The {@link ResolverContext}.
     */
    public boolean hasChanges(@Nonnull final ResolverContext<T> ctx) {
        return false;
    }
     ...
     */
    @CheckForNull
    public JCRQueryProvider<T> getJCRQueryProvider() {
        return null;
    }
     ...
     */
    @CheckForNull
    public <AdapterType> AdapterType adaptTo(@Nonnull final ResolverContext<T> ctx, @Nonnull final Class<AdapterType> type) {
        return null;
    }
     ...
     */
    public boolean copy(@Nonnull final ResolverContext<T> ctx, final String srcAbsPath, final String destAbsPath) throws PersistenceException {
        return false;
    }
     ...
     */
    public boolean move(@Nonnull final ResolverContext<T> ctx, final String srcAbsPath, final String destAbsPath) throws PersistenceException {
        return false;
    }
}
