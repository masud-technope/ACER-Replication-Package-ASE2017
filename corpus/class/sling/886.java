...
public class ResourceProviderEntryTest {
    ...
    private ResourceResolver getResolver() throws LoginException {
        if (providersBasedResolver == null) {
            providersBasedResolver = new ResourceResolverImpl(new CommonResourceResolverFactoryImpl(new ResourceResolverFactoryActivator()), false, null, new ResourceProviderStorage(providers));
        }
