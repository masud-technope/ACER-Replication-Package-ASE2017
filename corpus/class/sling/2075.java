...
public class ResourceCollectionManagerImpl implements ResourceCollectionManager {
    ...
    public ResourceCollection createCollection(Resource parentResource, String name, Map<String, Object> properties) throws PersistenceException {
        if (parentResource != null) {
            ...
            if (properties.get(JcrResourceConstants.SLING_RESOURCE_TYPE_PROPERTY) != null && !ResourceCollection.RESOURCE_TYPE.equals(properties.get(JcrResourceConstants.SLING_RESOURCE_TYPE_PROPERTY))) {
                properties.put(JcrResourceConstants.SLING_RESOURCE_SUPER_TYPE_PROPERTY, ResourceCollection.RESOURCE_TYPE);
            } else {
                properties.put(JcrResourceConstants.SLING_RESOURCE_TYPE_PROPERTY, ResourceCollection.RESOURCE_TYPE);
            }
