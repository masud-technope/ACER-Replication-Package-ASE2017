...
public class DriverRegistry {
    ...
    protected void activate(BundleContext bundleContext) {
        bundleTracker = new BundleTracker<Collection<DriverInfo>>(bundleContext, Bundle.ACTIVE, new DriverBundleTracker());
        bundleTracker.open();
    }
            ...
            while ((line = reader.readLine()) != null) {
                if (!line.startsWith("#") && line.trim().length() > 0) {
                    try {
                        ...
                        log.warn("Cannot register java.sql.Driver [{}] from bundle [{}]", new Object[] { line, bundle, t });
                    }
                }
            }
    ...
    private static class DriverInfo {
        ...
        public boolean equals(Object o) {
            ...
            if (!(bundle == that.bundle))
                return false;
            if (!(driver == that.driver))
                return false;
            return true;
        }
