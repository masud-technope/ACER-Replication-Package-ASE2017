 ...
 */
public class JobSchedulerImpl implements EventHandler, ConfigurationChangeListener, org.apache.sling.commons.scheduler.Job {
     ...
     */
    public  JobSchedulerImpl(final JobManagerConfiguration configuration, final Scheduler scheduler, final JobManagerImpl jobManager) {
    ...
    public JobBuilder.ScheduleBuilder createJobBuilder(final ScheduledJobInfoImpl info) {
        final JobBuilder.ScheduleBuilder sb = new JobScheduleBuilderImpl(info.getJobTopic(), info.getJobProperties(), info.getName(), this);
            ...
            for (final Map.Entry<String, Object> current : template.entrySet()) {
                ...
                if (op == Operation.EQUALS) {
                    ...
                    if (value instanceof Comparable) {
                        @SuppressWarnings({ "unchecked", "rawtypes" }) final int result = ((Comparable) value).compareTo(job.getJobProperties().get(propName));
