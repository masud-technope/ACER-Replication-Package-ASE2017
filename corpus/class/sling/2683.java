...
public class ServerSetupSingletonTest {
    ...
    public void testStartup() throws Exception {
        ...
        assertEquals("Expecting all startup phases to have run", "one,two,three", TestSetupPhase.executionLog.toString());
        serverSetup.setupTestServer();
        assertEquals("Expecting second setup call to have no effect", "one,two,three", TestSetupPhase.executionLog.toString());
    }

    @Test
    public void testShutdown() throws Exception {
        serverSetup.shutdown();
        assertEquals("Expecting all shutdown phases to have run", "four,five", TestSetupPhase.executionLog.toString());
        serverSetup.shutdown();
        assertEquals("Expecting second shutdown call to be ignored", "four,five", TestSetupPhase.executionLog.toString());
    }
    ...
    public void testStartupAndShutdown() throws Exception {
        ...
        assertEquals("Expecting all startup phases to have run", "one,two,three", TestSetupPhase.executionLog.toString());
        serverSetup.shutdown();
        assertEquals("Expecting all phases to have run", "one,two,three,four,five", TestSetupPhase.executionLog.toString());
    }
    ...
    public void testStartupSomeOnly() throws Exception {
        ...
        serverSetup.setConfig(props);
        serverSetup.setupTestServer();
        assertEquals("Expecting only two startup phases to have run", "one,three", TestSetupPhase.executionLog.toString());
        serverSetup.setupTestServer();
        assertEquals("Expecting second setup call to have no effect", "one,three", TestSetupPhase.executionLog.toString());
    }
    ...
    public void testShutdownSomeOnly() throws Exception {
        ...
        serverSetup.setConfig(props);
        serverSetup.shutdown();
        assertEquals("Expecting only one shutdown phase to have run", "four", TestSetupPhase.executionLog.toString());
        serverSetup.shutdown();
        assertEquals("Expecting second setup call to have no effect", "four", TestSetupPhase.executionLog.toString());
    }
    ...
    public void testAddPhasesLater() throws Exception {
        ...
        serverSetup.setupTestServer();
        assertEquals("Expecting all startup phases to have run", "one,A,two", TestSetupPhase.executionLog.toString());
        serverSetup.shutdown();
        assertEquals("Expecting all phases to have run", "one,A,two,B,five", TestSetupPhase.executionLog.toString());
    }
}
