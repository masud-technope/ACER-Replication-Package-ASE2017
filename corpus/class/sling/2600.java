...
public abstract class AbstractAuthenticationHandlerHolder extends PathBasedHolder implements AuthenticationHandler {
     ...
     */
    protected abstract AuthenticationInfo doExtractCredentials(HttpServletRequest request, HttpServletResponse response);
     ...
     */
    protected abstract boolean doRequestCredentials(HttpServletRequest request, HttpServletResponse response) throws IOException;
     ...
     */
    protected abstract void doDropCredentials(HttpServletRequest request, HttpServletResponse response) throws IOException;
    ...
    private Object setPath(final HttpServletRequest request) {
        return setRequestAttribute(request, AuthenticationHandler.PATH_PROPERTY, fullPath);
    }
    ...
    private void resetPath(final HttpServletRequest request, Object oldValue) {
        setRequestAttribute(request, AuthenticationHandler.PATH_PROPERTY, oldValue);
    }
