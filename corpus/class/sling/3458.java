...
public class SimpleHttpDistributionTransportTest {
    ...
    public void testDeliverPackage() throws Exception {
        ...
        SimpleHttpDistributionTransport simpleHttpDistributionTransport = new SimpleHttpDistributionTransport(mock(DefaultDistributionLog.class), endpoint, packageBuilder, secretProvider, maxNoOfPackages);
