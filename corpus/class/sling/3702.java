...
public class AuthenticatedResourceProvider implements StatefulResourceProvider {
    ...
    public  AuthenticatedResourceProvider(ResourceProvider<?> rp, ResourceProviderInfo info, ResourceResolver resolver, Map<String, Object> authInfo, CombinedResourceProvider combinedProvider) throws LoginException {
