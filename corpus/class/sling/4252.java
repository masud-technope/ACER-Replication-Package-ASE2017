...
public class RequestParserTest {
    ...
    public static Collection<Object[]> configs() {
        final String EMPTY = "";
        final Object[][] data = new Object[][] { { EMPTY, EMPTY, EMPTY, EMPTY }, { "/", EMPTY, EMPTY, EMPTY }, { "/.html", EMPTY, "html", EMPTY }, { "/someTests.here.html", "someTests.here", "html", EMPTY }, { "someTests.here.html", "someTests.here", "html", EMPTY }, { "someTests.here.html.json", "someTests.here.html", "json", EMPTY }, { "someTests.here.html.json/TEST_METHOD_NAME.txt", "someTests.here.html.json", "txt", "TEST_METHOD_NAME" }, { ".json/TEST_METHOD_NAME", "", "json/TEST_METHOD_NAME", "" }, { ".json/TEST_METHOD_NAME.txt", ".json", "txt", "TEST_METHOD_NAME" }, { "/.json/TEST_METHOD_NAME.txt", ".json", "txt", "TEST_METHOD_NAME" }, { "/.json/TEST_METHOD_NAME.txt", ".json", "txt", "TEST_METHOD_NAME" }, { "/.html.json/TEST_METHOD_NAME.txt", ".html.json", "txt", "TEST_METHOD_NAME" } };
