...
public class JsonRenderingTest extends HttpTestBase {
    ...
    protected void setUp() throws Exception {
        ...
        // allow collisions
        postUrl = HTTP_BASE_URL + testPath + "_" + System.currentTimeMillis() + SlingPostConstants.DEFAULT_CREATE_SUFFIX;
    ...
    public void testAccentedStrings() throws IOException {
        ...
        props.put("c", "The ? cyrillic capital letter shcha");
        props.put("d", "The ? cherokee letter qui");
