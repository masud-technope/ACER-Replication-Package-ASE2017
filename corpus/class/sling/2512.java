...
@Properties({ @Property(name = "service.description", value = "HTML Default Test Servlet", propertyPrivate = true), @Property(name = "service.vendor", value = "The Apache Software Foundation", propertyPrivate = true), @Property(name = "sling.servlet.resourceTypes", value = "sling/servlet/default", propertyPrivate = true), @Property(name = "sling.servlet.extensions", value = "html", propertyPrivate = true), @Property(name = "sling.servlet.methods", value = "GET") })
