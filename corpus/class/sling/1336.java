...
@Service(value = { Servlet.class, ChangeUserPassword.class })
...
public class ChangeUserPasswordServlet extends AbstractUserPostServlet implements ChangeUserPassword {
    ...
    protected void activate(ComponentContext componentContext) {
        ...
        this.userAdminGroupName = OsgiUtil.toString(props.get(PAR_USER_ADMIN_GROUP_NAME), DEFAULT_USER_ADMIN_GROUP_NAME);
    ...
    protected void handleOperation(SlingHttpServletRequest request, AbstractPostResponse response, List<Modification> changes) throws RepositoryException {
        ...
        changePassword(session, resource.getName(), request.getParameter("oldPwd"), request.getParameter("newPwd"), request.getParameter("newPwdConfirm"), changes);
    }
