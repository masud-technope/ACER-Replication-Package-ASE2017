...
public class SettingsServiceConfigurator implements ManagedService {
    ...
    public  SettingsServiceConfigurator(final BundleContext btx, final SlingSettingsServiceImpl s) {
        this.settings = s;
        ...
        msProps.put(Constants.SERVICE_DESCRIPTION, "Apache Sling Managed Service for the Settings Service");
