...
public class ProcessorManagerImpl implements ProcessorManager, EventHandler {
     ...
     * @param ctx
     */
    protected void activate(final ComponentContext ctx) throws LoginException, InvalidSyntaxException {
        ...
        props.put("event.topics", new String[] { "org/apache/sling/api/resource/Resource/*", "org/apache/sling/api/resource/ResourceProvider/*" });
        props.put("service.description", "Processor Configuration/Modification Handler");
        props.put("service.vendor", "The Apache Software Foundation");
        this.eventHandlerRegistration = ctx.getBundleContext().registerService(EventHandler.class.getName(), this, props);
