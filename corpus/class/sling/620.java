...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        slingSettingsTracker = new ServiceTracker<SlingSettingsService, SlingSettingsService>(context, SlingSettingsService.class, null) {
    ...
    private void registerInstaller(BundleContext context, SlingSettingsService slingSettings) {
        ...
        this.serviceReg = context.registerService(ResourceTransformer.class, new SubsystemBaseTransformer(slingSettings), props);
    }
