...
@Property(name = "webconsole.configurationFactory.nameHint", value = "Root paths: {" + MongoDBNoSqlResourceProviderFactory.PROVIDER_ROOTS_PROPERTY + "}")
public final class MongoDBNoSqlResourceProviderFactory extends AbstractNoSqlResourceProviderFactory {
    ...
    @Property(label = "Connection String", description = "MongoDB connection String. Example: 'localhost:27017,localhost:27018,localhost:27019'", value = MongoDBNoSqlResourceProviderFactory.CONNECTION_STRING_DEFAULT)
    ...
    @Property(label = "Database", description = "MongoDB database to store resource data in.", value = MongoDBNoSqlResourceProviderFactory.DATABASE_DEFAULT)
    static final String DATABASE_PROPERTY = "database";

    private static final String DATABASE_DEFAULT = "sling";

    @Property(label = "Collection", description = "MongoDB collection to store resource data in.", value = MongoDBNoSqlResourceProviderFactory.COLLECTION_DEFAULT)
