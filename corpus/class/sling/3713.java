...
public class QueueJobCache {
     ...
     */
    public  QueueJobCache(final JobManagerConfiguration configuration, final String queueName, final StatisticsManager statisticsManager, final QueueConfiguration.Type queueType, final Set<String> topics) {
