...
public abstract class RenderUnit implements Record<RenderUnit> {
    ...
    protected abstract void render(PrintWriter writer, Bindings bindings, Bindings arguments, RenderContextImpl renderContext);
    ...
    protected void callUnit(RenderContext renderContext, Object templateObj, Object argsObj) {
        if (!(templateObj instanceof RenderUnit)) {
            ...
            if (RenderUtils.isPrimitive(templateObj)) {
                throw new SightlyException("data-sly-call: primitive \"" + templateObj.toString() + "\" does not represent a Sightly " + "template.");
