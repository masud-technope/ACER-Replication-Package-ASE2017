...
public class ConnectorRegistryImpl implements ConnectorRegistry {
    ...
    public TopologyConnectorClientInformation registerOutgoingConnector(final ClusterViewService clusterViewService, final URL connectorUrl) {
        ...
        synchronized (outgoingClientsMap) {
            for (Iterator<Entry<String, TopologyConnectorClient>> it = outgoingClientsMap.entrySet().iterator(); it.hasNext(); ) {
            ...
            client = new TopologyConnectorClient(clusterViewService, announcementRegistry, config, connectorUrl, serverInfo);
    ...
    public void pingOutgoingConnectors(boolean force) {
        ...
        synchronized (outgoingClientsMap) {
            outgoingTemplatesClone = new ArrayList<TopologyConnectorClient>(outgoingClientsMap.values());
        }
