...
public interface ServletResolver {
     ...
     */
    @Nonnull
    Servlet resolveServlet(@Nonnull SlingHttpServletRequest request);
     ...
     */
    @Nonnull
    Servlet resolveServlet(@Nonnull Resource resource, @Nonnull String scriptName);
     ...
     */
    @Nonnull
    Servlet resolveServlet(@Nonnull ResourceResolver resolver, @Nonnull String scriptName);
}
