...
public class Coordinator {
    ...
    public static final class Operation {
        ...
        public String toString() {
            return "Operation [pid=" + pid + ", factoryPid=" + factoryPid + ", isDelete=" + isDelete + ", created=" + created + "]";
        }
    }
        ...
        while (i.hasNext()) {
            ...
            if (op.isDelete == isDelete) {
                if (op.pid.equals(pid)) {
                    if ((op.factoryPid == null && factoryPid == null) || (op.factoryPid != null && op.factoryPid.equals(factoryPid))) {
                        result = op;
                        i.remove();
                        break;
                    }
