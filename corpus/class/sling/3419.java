...
@Properties({ @Property(name = SlyBindingsValuesProvider.SCR_PROP_JS_BINDING_IMPLEMENTATIONS, value = { "sightly:" + SlyBindingsValuesProvider.SLING_NS_PATH }, unbounded = PropertyUnbounded.ARRAY, label = "Script Factories", description = "Script factories to load in the bindings map. The entries should be in the form " + "'namespace:/path/from/repository'.") })
