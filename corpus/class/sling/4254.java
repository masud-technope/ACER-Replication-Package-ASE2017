...
public class SlingPropertyValueHandler {
     ...
     */
    public void setProperty(final Resource parent, final RequestProperty prop) throws RepositoryException, PersistenceException {
     ...
     * @throws RepositoryException if a repository error occurs.
     */
    private String removePropertyIfExists(final Modifiable parent, final String name) throws RepositoryException, PersistenceException {
     ...
     * @throws RepositoryException if a repository error occurs.
     */
    private void setPropertyAsIs(final Modifiable parent, final RequestProperty prop) throws RepositoryException, PersistenceException {
     ...
     */
    private String[] patch(final Modifiable parent, String name, String[] values) throws RepositoryException, PersistenceException {
     ...
     */
    private void clearProperty(final Modifiable parent, RequestProperty prop) throws RepositoryException, PersistenceException {
        if (parent.valueMap.containsKey(prop.getName())) {
            if (parent.node != null) {
                if (parent.node.getProperty(prop.getName()).getDefinition().isMultiple()) {
                    ...
                    changes.add(Modification.onModified(parent.node.setProperty(prop.getName(), "").getPath()));
                }
            } else {
     ...
     */
    private void removeProperty(final Modifiable parent, RequestProperty prop) throws RepositoryException, PersistenceException {
        final String removePath = removePropertyIfExists(parent, prop.getName());
        if (removePath != null) {
            changes.add(Modification.onDeleted(removePath));
        }
     ...
     */
    private void removeIfSingleValueProperty(final Modifiable parent, final RequestProperty prop) throws RepositoryException, PersistenceException {
        if (parent.valueMap.containsKey(prop.getName())) {
            if (parent.node != null) {
                if (!parent.node.getProperty(prop.getName()).getDefinition().isMultiple()) {
     ...
     */
    private boolean storeAsDate(final Modifiable parent, String name, String[] values, boolean multiValued, ValueFactory valFac) throws RepositoryException, PersistenceException {
        if (multiValued) {
     ...
     * @return true only if parsing was successfull and the property was actually changed
     */
    private boolean storeAsReference(final Modifiable parent, String name, String[] values, int type, boolean multiValued, ValueFactory valFac) throws RepositoryException, PersistenceException {
        if (parent.node == null) {
            // TODO
        ...
        if (multiValued) {
            ...
            if (array != null) {
                changes.add(Modification.onModified(parent.node.setProperty(name, array).getPath()));
                return true;
            }
        } else {
            if (values.length >= 1) {
                ...
                if (v != null) {
                    changes.add(Modification.onModified(parent.node.setProperty(name, v).getPath()));
                    return true;
                }
            }
        }
     ...
     */
    private void store(final Modifiable parent, final String name, final String[] values, final int type, final boolean multiValued) throws RepositoryException, PersistenceException {
        if (parent.node != null) {
            Property p = null;
            if (multiValued) {
     ...
     */
    private enum AutoType implements  {
