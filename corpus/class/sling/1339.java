...
class WebloaderJob extends Thread implements WebloaderJobStatus {
    ...
    static class DocTooBigException extends IOException {
     ...
     WebloaderJob(SlingRepository repository, MimeTypeService mimeTypeService, String webQuery, String storagePath, String fileExtensions, int maxDocsToRetrieve, int maxDocSize) {
    ...
    public String toString() {
        ...
        return getClass().getSimpleName() + ", webQuery=" + webQuery + ", storagePath=" + storagePath + ", fileTypes=" + sb.toString() + ", maxDocsToRetrieve=" + maxDocsToRetrieve + ", maxDocSize=" + maxDocSize;
    }
    ...
    private void getAndStoreContent(URL currentURL, Node resource, String filename) throws RepositoryException, IOException {
