...
public class JspcMojo extends AbstractMojo implements Options {
    ...
    private void processFile(final String file) throws JasperException {
        ...
        try {
            ...
            final JspServletWrapper wrapper = new JspServletWrapper(new JspCServletConfig(context), this, jspUri, false, rctxt);
            final JspCompilationContext clctxt = new JspCompilationContext(jspUri, false, this, context, wrapper, rctxt);
            ...
            if ((e instanceof FileNotFoundException) && getLog().isWarnEnabled()) {
