...
public class DecomposedURLTest {
    ...
    public static List<Object[]> data() {
        ...
        result.add(new Object[] { "http://localhost:8080/libs/foo/content/something/formitems.truc.who.json/image/vnd/xnd/knd.xml", "/libs/foo/content/something/formitems", "json", "truc.who", "/image/vnd/xnd/knd.xml" });
        ...
        result.add(new Object[] { "/home/users/geometrixx-outdoors/emily.andrews@mailinator.com/profile.form.html/content/geometrixx-outdoors/en/user/profile", "/home/users/geometrixx-outdoors/emily", "com", "andrews@mailinator", "/profile.form.html/content/geometrixx-outdoors/en/user/profile" });
        // the trick is to replace dots with _, which gives the same results as
        // if a resource exists at ...@mailinator.com/profile
        result.add(new Object[] { "/home/users/geometrixx-outdoors/emily_andrews@mailinator_com/profile.form.html/content/geometrixx-outdoors/en/user/profile", "/home/users/geometrixx-outdoors/emily_andrews@mailinator_com/profile", "html", "form", "/content/geometrixx-outdoors/en/user/profile" });
        return result;
    }
