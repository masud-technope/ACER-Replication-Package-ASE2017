...
public class AccessControlUtil {
    ...
    public static void replaceAccessControlEntry(Session session, String resourcePath, Principal principal, String[] grantedPrivilegeNames, String[] deniedPrivilegeNames, String[] removedPrivilegeNames) throws RepositoryException {
        replaceAccessControlEntry(session, resourcePath, principal, grantedPrivilegeNames, deniedPrivilegeNames, removedPrivilegeNames, null);
    }
        ...
        if (privilege.isAggregate()) {
            ...
            for (Privilege disaggregate : privileges) {
                if (disaggregate.isAggregate()) {
                    //nested aggregate, so skip it since the privileges are already included.
                    continue;
                }
