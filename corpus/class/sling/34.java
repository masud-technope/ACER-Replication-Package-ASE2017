...
public class WebConsoleConfigPrinter {
    ...
    public static void register(final BundleContext bundleContext, final ProcessorManagerImpl manager) {
        ...
        serviceProps.put(Constants.SERVICE_DESCRIPTION, "Apache Sling Rewriter Configuration Printer");
        ...
        REG = bundleContext.registerService(WebConsoleConfigPrinter.class.getName(), printer, serviceProps);
    }
