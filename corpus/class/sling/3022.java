...
public class MongoDBNoSqlResourceProviderRootIT extends AbstractNoSqlResourceProviderRootTest {
    ...
    protected void registerResourceProviderFactoryAsRoot() {
        context.registerInjectActivateService(new MongoDBNoSqlResourceProviderFactory(), ImmutableMap.<String, Object>builder().put(ResourceProvider.ROOTS, "/").put("connectionString", System.getProperty("connectionString", "localhost:27017")).put("database", System.getProperty("database", "sling")).put("collection", System.getProperty("collection", "resources")).build());
    }
}
