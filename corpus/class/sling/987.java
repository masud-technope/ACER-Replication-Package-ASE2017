...
public class PostRedirectTest extends HttpTestBase {
    ...
    public void testEncodedRedirect() throws IOException {
        ...
        assertTrue("With UTF-8 in path, redirect must be encoded :" + location, location.contains(postPath + "/%D0%94%D1%80%D1%83%D0%B3%D0%B0"));
    }
    ...
    public void testDefaultRedirect() throws IOException {
        ...
        assertTrue("With no headers or parameters, redirect (" + location + ") must point to created node (path=" + postPath + ")", location.contains(postPath));
    }
    ...
    public void testMagicStarRedirect() throws IOException {
        ...
        headers.put("Referer", "http://referer/");
        final String location = testClient.createNode(postUrl, params, headers, false);
        assertTrue("With magic star, redirect (" + location + ") must point to created node (path=" + postPath + ")", location.contains(postPath));
    }
    ...
    public void testMagicStarRedirectPrefix() throws IOException {
        ...
        headers.put("Referer", "http://referer/");
        final String location = testClient.createNode(postUrl, params, headers, false);
        assertTrue("With magic star, redirect (" + location + ") must start with prefix " + prefix, location.contains(prefix));
    }
    ...
    public void testMagicStarRedirectSuffix() throws IOException {
        ...
        headers.put("Referer", "http://referer/");
        final String location = testClient.createNode(postUrl, params, headers, false);
        assertTrue("With magic star, redirect (" + location + ") must end with suffix " + suffix, location.endsWith(suffix));
    }
    ...
    public void testMagicStarRedirectPrefixSuffix() throws IOException {
        ...
        headers.put("Referer", "http://referer/");
        final String location = testClient.createNode(postUrl, params, headers, false);
        assertTrue("With magic star, redirect (" + location + ") must start with prefix " + prefix + " and end with suffix " + suffix, location.contains(prefix) && location.endsWith(suffix));
    }
}
