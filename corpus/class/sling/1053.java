...
public class ResourcePropertyImpl implements ResourceProperty {
    ...
    public  ResourcePropertyImpl(@Nonnull String name, String nameRegex, boolean isMultiple, boolean isRequired, @Nonnull List<ParameterizedValidator> validators) throws IllegalArgumentException {
        if (nameRegex != null) {
            try {
    ...
    public String toString() {
        return "ResourcePropertyImpl [name=" + name + ", isMultiple=" + isMultiple + ", isRequired=" + isRequired + ", validators=" + validators + ", namePattern=" + namePattern + "]";
    }
