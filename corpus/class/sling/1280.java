...
public class JarArchiverHelper {
    ...
    public  JarArchiverHelper(final JarArchiver archiver, final MavenProject project, final File destFile) throws MojoExecutionException {
        this(archiver, project, destFile, null);
    }

    public  JarArchiverHelper(final JarArchiver archiver, final MavenProject project, final File destFile, final java.util.jar.Manifest manifest) throws MojoExecutionException {
    ...
    public void addArtifacts(final Map<String, File> globalContentsMap, final String prefix) throws MojoExecutionException {
