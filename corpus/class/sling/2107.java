 ...
 */
@Component(metatype = true, label = "Apache Sling Distribution Packaging - Avro Package Builder Factory", description = "OSGi configuration for Avro package builders", configurationFactory = true, specVersion = "1.1", policy = ConfigurationPolicy.REQUIRE)
...
public class AvroDistributionPackageBuilderFactory implements DistributionPackageBuilder {
     ...
     */
    @Property(options = { @PropertyOption(name = JCRAVRO, value = "Avro JCR packages"), @PropertyOption(name = RESOURCEAVRO, value = "Avro Resource packages") }, value = RESOURCEAVRO, label = "type", description = "The type of this package builder")
