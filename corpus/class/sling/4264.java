 ...
 * in the repository
 */
public class EstablishedInstanceDescription extends DefaultInstanceDescription {

    public  EstablishedInstanceDescription(final DefaultClusterView clusterView, final Resource res, final String slingId, final boolean isLeader, final boolean isOwn) {
