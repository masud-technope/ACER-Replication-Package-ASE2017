...
public class RequestUriOptingServletTest extends ResolutionTestBase {
    ...
    public void testGetMethodExistingResource() throws Exception {
        assertServlet(getContent(testNodeNORT.nodeUrl + TEST_URL_SUFFIX, CONTENT_TYPE_PLAIN), REQUEST_URI_OPTING_SERVLET_SUFFIX);
    }

    public void testGetMethodNonExistingResource() throws Exception {
        assertServlet(getContent(NONEXISTING_RESOURCE_URL + TEST_URL_SUFFIX, CONTENT_TYPE_PLAIN), REQUEST_URI_OPTING_SERVLET_SUFFIX);
    }
}
