...
public class PortalCache implements Cache {
    ...
    private <V> V get(String key, Map<String, Object> properties, V defaultValue) {
        @SuppressWarnings("unchecked") V v = (V) properties.get(key);
        if (v == null) {
            return defaultValue;
        }
        return v;
    ...
    public String createCacheKey(PortletWindow portletWindow, HttpServletRequest request) {
        // ignoring the user.
