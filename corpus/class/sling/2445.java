...
@Properties({ @Property(name = "service.description", value = "Apache Sling Selector Form Handler"), @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = org.apache.sling.auth.core.spi.AuthenticationHandler.PATH_PROPERTY, value = "/"), @Property(name = "service.ranking", intValue = 5000) })
@Service
public class SelectorAuthenticationHandler extends AbstractAuthenticationHandler {
    ...
    private void configure(Map<String, ?> properties) {
        this.loginForm = OsgiUtil.toString(properties.get(PAR_LOGIN_FORM), SelectorFormServlet.SERVLET_PATH);
