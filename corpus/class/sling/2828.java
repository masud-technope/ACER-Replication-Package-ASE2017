...
public class ScriptEngineConsolePlugin {
    ...
    static void initPlugin(BundleContext context, ScriptEngineManagerFactory scriptEngineManagerFactory) {
        if (INSTANCE == null) {
            ScriptEngineConsolePlugin tmp = new ScriptEngineConsolePlugin(scriptEngineManagerFactory);
    ...
    public void activate(BundleContext context) {
        ...
        props.put(Constants.SERVICE_DESCRIPTION, "Web Console Plugin for ScriptEngine implementations");
        ...
        serviceRegistration = context.registerService(this.getClass().getName(), this, props);
    }
