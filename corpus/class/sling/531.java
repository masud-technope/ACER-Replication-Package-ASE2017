...
public class EventingThreadPool implements ThreadPool {
    ...
    @Property(intValue = DEFAULT_POOL_SIZE, label = "Pool Size", description = "The size of the thread pool. This pool is used to execute jobs and therefore " + "limits the maximum number of jobs executed in parallel.")
