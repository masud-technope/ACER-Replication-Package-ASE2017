...
@Component(label = "Apache Sling Authentication XING OAuth â€œLogin Module Pluginâ€?", description = "Login Module Plugin for Sling Authentication XING OAuth", immediate = true, metatype = true)
@Service
@Properties({ @Property(name = Constants.SERVICE_VENDOR, value = XingOauth.SERVICE_VENDOR), @Property(name = Constants.SERVICE_DESCRIPTION, value = "Login Module Plugin for Sling Authentication XING OAuth"), @Property(name = Constants.SERVICE_RANKING, intValue = 0, propertyPrivate = false) })
public class XingOauthLoginModulePlugin implements /**
