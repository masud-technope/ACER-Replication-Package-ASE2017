...
public class Activator implements BundleActivator, BundleListener {
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        try {
            ...
            log.error("activate: Problem while registering bundle resources for existing bundles", t);
        }
    ...
    private void addBundleResourceProvider(Bundle bundle) {
        ...
        if (prefixes != null) {
            log.debug("addBundleResourceProvider: Registering resources '{}' for bundle {}/{} as service ", new Object[] { prefixes, bundle.getSymbolicName(), bundle.getBundleId() });
    ...
    private void removeBundleResourceProvider(Bundle bundle) {
        ...
        if (brp != null) {
            log.debug("removeBundleResourceProvider: Unregistering resources for bundle {}/{}", new Object[] { bundle.getSymbolicName(), bundle.getBundleId() });
