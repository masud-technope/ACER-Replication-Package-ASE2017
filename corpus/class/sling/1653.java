...
public class InstallableResourceTest {
    ...
    public void testPriority() {
        final InstallableResource defaultPrio = new InstallableResource("1", null, new Hashtable<String, Object>(), null, null, null);
        assertEquals(InstallableResource.DEFAULT_PRIORITY, defaultPrio.getPriority());
        final InstallableResource ownPrio = new InstallableResource("1", null, new Hashtable<String, Object>(), null, null, 47);
