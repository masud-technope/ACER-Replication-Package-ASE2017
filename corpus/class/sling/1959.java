...
public class PathBasedHolderCache<Type extends PathBasedHolder> {
    ...
    public Collection<Type>[] findApplicableHolder(final HttpServletRequest request) {
        ...
        try {
            final String hostname = request.getServerName() + (request.getServerPort() != 80 && request.getServerPort() != 443 ? ":" + request.getServerPort() : "");
            @SuppressWarnings("unchecked") final SortedSet<Type>[] result = new SortedSet[4];
