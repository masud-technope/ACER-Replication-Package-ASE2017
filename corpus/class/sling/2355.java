...
class WatchedFolder {
    ...
    private final Map<String, String> digests = new HashMap<String, String>();
     ...
     WatchedFolder(final Session session, final String path, final int priority, final Collection<JcrInstaller.NodeConverter> converters) throws RepositoryException {
        if (priority < 1) {
