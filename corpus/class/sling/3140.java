...
public class SlingRequestPathInfo implements RequestPathInfo {
    ...
    private  SlingRequestPathInfo(Resource resource, String resourcePath, String selectorString, String extension, String suffix) {
    ...
    public SlingRequestPathInfo merge(RequestPathInfo baseInfo) {
        if (getExtension() == null) {
            return new SlingRequestPathInfo(getResource(), getResourcePath(), baseInfo.getSelectorString(), baseInfo.getExtension(), baseInfo.getSuffix());
        }
        return this;
    }
    ...
    public String toString() {
        return "SlingRequestPathInfo: path='" + resourcePath + "'" + ", selectorString='" + selectorString + "'" + ", extension='" + extension + "'" + ", suffix='" + suffix + "'";
    }
