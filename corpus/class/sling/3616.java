...
public class DistributedEventSender implements EventHandler {
    ...
    public  DistributedEventSender(final BundleContext bundleContext, final String rootPath, final String ownRootPath, final ResourceResolverFactory rrFactory, final EventAdmin eventAdmin) {
        ...
        final Thread backgroundThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final ServiceRegistration reg = bundleContext.registerService(new String[] { EventHandler.class.getName() }, DistributedEventSender.this, props);
                DistributedEventSender.this.serviceRegistration = reg;
                try {
                    runInBackground();
                } catch (Throwable //NOSONAR
                t) {
