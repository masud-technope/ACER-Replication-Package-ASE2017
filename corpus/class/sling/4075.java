...
public class HealthCheckTestsProvider implements TestsProvider {
    ...
    @Property(cardinality = 2147483647, label = "Health Check Tags", description = "Groups of health check tags to execute as JUnit tests. Use the standard Health Checks 'includeThisTag,-omitThatTag' syntax")
