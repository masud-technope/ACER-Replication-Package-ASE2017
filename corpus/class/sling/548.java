...
public class EclipseJavaCompiler implements JavaCompiler {
    ...
    private class CompileContext implements ICompilerRequestor, INameEnvironment {
        ...
        public  CompileContext(final CompilationUnit[] units, final CompilationResultImpl errorHandler, final ClassLoaderWriter classWriter, final ClassLoader classLoader) {
