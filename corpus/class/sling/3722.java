 ...
 */
@Component(name = "org.apache.sling.launchpad.karaf.KarafStartupHandler", label = "%org.apache.sling.launchpad.karaf.label", description = "%org.apache.sling.launchpad.karaf.description", metatype = true, immediate = true)
@Service
...
public class KarafStartupHandler implements StartupHandler {
    ...
    @Property(value = DEFAULT_STARTUP_MODE, options = { @PropertyOption(name = STARTUP_MODE_INSTALL, value = "install"), @PropertyOption(name = STARTUP_MODE_RESTART, value = "restart"), @PropertyOption(name = STARTUP_MODE_UPDATE, value = "update") })
