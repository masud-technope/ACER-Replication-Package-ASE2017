...
public interface SlingHttpServletRequest extends HttpServletRequest, Adaptable {
     ...
     */
    @CheckForNull
    RequestParameter getRequestParameter(@Nonnull String name);
     ...
     */
    @CheckForNull
    RequestParameter[] getRequestParameters(@Nonnull String name);
     ...
     */
    @CheckForNull
    RequestDispatcher getRequestDispatcher(@Nonnull String path, RequestDispatcherOptions options);
     ...
     */
    @CheckForNull
    RequestDispatcher getRequestDispatcher(@Nonnull Resource resource, RequestDispatcherOptions options);
