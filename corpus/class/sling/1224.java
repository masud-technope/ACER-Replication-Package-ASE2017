...
public class SlingRemoteServiceServlet extends RemoteServiceServlet {
    ...
    static SerializationPolicy loadSerializationPolicy(HttpServlet servlet, HttpServletRequest request, String moduleBaseURL, String strongName, Bundle bundle) {
