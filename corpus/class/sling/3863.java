...
public class OakBacklogClusterSyncService extends AbstractServiceWithBackgroundCheck implements ClusterSyncService {
    ...
    static enum BacklogStatus implements  {

        UNDEFINED() {
        }
        , /* when there was an error retrieving the backlog status with oak */
        HAS_BACKLOG() {
        }
        , /* when oak's discovery lite descriptor indicated that there is still some backlog */
        NO_BACKLOG() {
        }
        ;
    }
    ...
    public static OakBacklogClusterSyncService testConstructorAndActivate(final DiscoveryLiteConfig commonsConfig, final IdMapService idMapService, final SlingSettingsService settingsService, ResourceResolverFactory resourceResolverFactory) {
     ...
     */
    public static OakBacklogClusterSyncService testConstructor(final DiscoveryLiteConfig commonsConfig, final IdMapService idMapService, final SlingSettingsService settingsService, ResourceResolverFactory resourceResolverFactory) {
