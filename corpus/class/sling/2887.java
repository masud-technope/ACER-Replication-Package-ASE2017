...
public class PathInfoTest {
    ...
    private static final PathInfo pathWithSchemePathExtensionSelectors = new PathInfo(SCHEME + ":" + "//" + HOST + ABSOLUTE_PATH + "." + SELECTOR_STRING + "." + EXTENSION);

    private static final PathInfo pathWithSchemePathExtensionSelectorsSuffix = new PathInfo(SCHEME + ":" + "//" + HOST + ABSOLUTE_PATH + "." + SELECTOR_STRING + "." + EXTENSION + SUFFIX);

    private static final PathInfo pathWithSchemePathExtensionSelectorsSuffixFragment = new PathInfo(SCHEME + ":" + "//" + HOST + ABSOLUTE_PATH + "." + SELECTOR_STRING + "." + EXTENSION + SUFFIX + "#" + FRAGMENT);

    private static final PathInfo pathWithSchemePortPathExtensionSelectorsSuffixFragment = new PathInfo(SCHEME + ":" + "//" + HOST + ":" + PORT + ABSOLUTE_PATH + "." + SELECTOR_STRING + "." + EXTENSION + SUFFIX + "#" + FRAGMENT);
