...
@Properties({ @Property(name = Plugin.SCR_PROP_NAME_BLOCK_NAME, value = "text"), @Property(name = Plugin.SCR_PROP_NAME_PRIORITY, intValue = 9) })
    ...
    public PluginInvoke invoke(final Expression expression, PluginCallInfo callInfo, final CompilerContext compilerContext) {
        return new DefaultPluginInvoke() {
            ...
            public void beforeChildren(PushStream stream) {
                ...
                stream.emit(new VariableBinding.Start(variable, compilerContext.adjustToContext(expression, MarkupContext.TEXT, ExpressionContext.TEXT).getRoot()));
