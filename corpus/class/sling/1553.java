...
class RootFolderListener implements EventListener {
    ...
    private final String pathWithSlash;
     ...
     RootFolderListener(final Session session, final String path, final RescanTimer timer, final InstallerConfig cfg) throws RepositoryException {
        this.timer = timer;
        ...
        session.getWorkspace().getObservationManager().addEventListener(this, eventTypes, watchedPath, isDeep, null, null, noLocal);
