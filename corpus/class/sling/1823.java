...
public class ScheduledJobHandler implements Runnable {
     ...
     */
    public ScheduledJobInfoImpl addOrUpdateJob(final String jobTopic, final Map<String, Object> jobProperties, final String scheduleName, final boolean suspend, final List<ScheduleInfoImpl> scheduleInfos) throws PersistenceException {
    ...
    private ScheduledJobInfoImpl addOrUpdateScheduledJob(final Map<String, Object> properties, final ScheduledJobInfoImpl oldInfo) {
