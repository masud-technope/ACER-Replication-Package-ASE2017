...
public class PostServletPrivilegesUpdateTest {
    ...
    public void testUpdatePropertyPrivilegesAndEvents() throws IOException, JSONException, RepositoryException, InterruptedException {
        ...
        try {
            ...
            observationManager.addEventListener(listener, Event.PROPERTY_ADDED | Event.PROPERTY_CHANGED | //event types
            Event.PROPERTY_REMOVED, //absPath
            testNodePath, //isDeep 
            true, //uuid
            null, //nodeTypeName
            null, //noLocal
    ...
    protected class TestEventListener implements EventListener {
        ...
        public String toString() {
            return "TestEventListener [addedProperties=" + Arrays.toString(addedProperties.toArray()) + ", changedProperties=" + Arrays.toString(changedProperties.toArray()) + ", removedProperties=" + Arrays.toString(removedProperties.toArray()) + "]";
        }
    }
}
