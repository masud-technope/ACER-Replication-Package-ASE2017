...
public class LegacyResourceProviderAdapter extends ResourceProvider<Object> {
    ...
    private boolean isContinueResolving(Resource resource) {
        return resource.getResourceMetadata() != null && resource.getResourceMetadata().containsKey(ResourceMetadata.INTERNAL_CONTINUE_RESOLVING);
    }
    ...
    public Iterator<Resource> listChildren(ResolverContext<Object> ctx, Resource parent) {
        ...
        if (children == null && !ownsRoot && ctx.getParentResourceProvider() != null) {
            children = ctx.getParentResourceProvider().listChildren((ResolverContext) ctx.getParentResolveContext(), parent);
        }
        return children;
    }

    @Override
    public void refresh(@Nonnull final ResolverContext<Object> ctx) {
    ...
    @Override
    public Collection<String> getAttributeNames(@Nonnull final ResolverContext<Object> ctx) {
    ...
    @Override
    public Object getAttribute(@Nonnull final ResolverContext<Object> ctx, @Nonnull final String name) {
        if (rp instanceof AttributableResourceProvider) {
    ...
    @Override
    public boolean isLive(@Nonnull final ResolverContext<Object> ctx) {
    ...
    @Override
    public void logout(@Nonnull final ResolverContext<Object> ctx) {
        if (rp instanceof DynamicResourceProvider) {
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @Override
    public Resource create(@Nonnull final ResolverContext<Object> ctx, final String path, final Map<String, Object> properties) throws PersistenceException {
        ...
        if (createdResource == null && !ownsRoot && ctx.getParentResourceProvider() != null) {
            createdResource = ctx.getParentResourceProvider().create((ResolverContext) ctx.getParentResolveContext(), path, properties);
        }
        return createdResource;
    }

    @Override
    public void delete(@Nonnull final ResolverContext<Object> ctx, @Nonnull final Resource resource) throws PersistenceException {
        if (rp instanceof ModifyingResourceProvider) {
    ...
    @Override
    public void revert(@Nonnull final ResolverContext<Object> ctx) {
        if (rp instanceof ModifyingResourceProvider) {
    ...
    @Override
    public void commit(@Nonnull final ResolverContext<Object> ctx) throws PersistenceException {
        if (rp instanceof ModifyingResourceProvider) {
    ...
    @Override
    public boolean hasChanges(@Nonnull final ResolverContext<Object> ctx) {
        if (rp instanceof ModifyingResourceProvider) {
