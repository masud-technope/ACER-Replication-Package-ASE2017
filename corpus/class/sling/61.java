...
public class MockAdapterManagerImpl implements AdapterManager {
    ...
    private static class AdapterFactoryDescriptor {
        ...
        public  AdapterFactoryDescriptor(final ComponentContext context, final ServiceReference reference, final String[] adapters) {
        ...
        public AdapterFactory getFactory() {
            if (factory == null) {
                factory = (AdapterFactory) context.locateService("AdapterFactory", reference);
            }
            return factory;
        }
     ...
     */
    private static class AdapterFactoryDescriptorMap extends TreeMap<ServiceReference, AdapterFactoryDescriptor> {
