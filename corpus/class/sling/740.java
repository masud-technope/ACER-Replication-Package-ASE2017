...
public enum FunctionType implements  {
    ...
    , PARENT() {
        ...
        @Override
        public <T> Function<?, ?> getFunction(String selector, SearchStrategy strategy, final TreeProvider<T> provider) {
    ...
    , EMPTY() {
        ...
        @Override
        public <T> Function<?, ?> getFunction(String argument, SearchStrategy strategy, final TreeProvider<T> provider) {
