...
public class InternalResource extends InstallableResource {
    ...
    public static InternalResource create(final String scheme, final InstallableResource resource) throws IOException {
        ...
        final String resourceUri = (dict != null && (type == null || InstallableResource.TYPE_FILE.equals(type)) && resource.getDigest() != null && resource.getDigest().length() > 0) ? (String) dict.get(InstallableResource.RESOURCE_URI_HINT) : null;
        ...
        if (is != null && (InstallableResource.TYPE_PROPERTIES.equals(type) || ((type == null || InstallableResource.TYPE_FILE.equals(type)) && isConfigExtension(resource.getId())))) {
            try {
    ...
    public  InternalResource(final String scheme, final String id, final InputStream is, final Dictionary<String, Object> dict, final String type, final String digest, final Integer priority, final File dataFile, final String resourceUri) {
     ...
     * @throws IOException
     */
    private static Dictionary<String, Object> readDictionary(final InputStream is, final String extension) throws IOException {
