...
public class FullJR2VirtualInstanceBuilder extends VirtualInstanceBuilder {
    ...
    private Object[] createAdditionalServices(VirtualInstance instance) throws Exception {
        ...
        observationManager.addEventListener(observationListener, Event.NODE_ADDED | Event.NODE_REMOVED | Event.NODE_MOVED | Event.PROPERTY_CHANGED | Event.PROPERTY_ADDED | Event.PROPERTY_REMOVED | Event.PERSIST, "/", true, null, null, false);
        return additionals;
    }
    ...
    public VirtualInstance build() throws Exception {
        ...
        return new FullJR2VirtualInstance(this) {
            ...
            public void assertEstablishedView() {
                ...
                try {
                    assertEquals(EstablishedInstanceDescription.class, this.getClusterViewService().getLocalClusterView().getInstances().get(0).getClass());
