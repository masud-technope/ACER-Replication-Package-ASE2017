...
public class PreparePackageMojoTest {
    ...
    public void testInitArtifactDefinitionsAllDefaults() throws Exception {
        ...
        makeArtifactAssertions(mojo, "base", "org.apache.sling", "org.apache.sling.launchpad.base", null, "jar", null, 0);
        //makeArtifactAssertions(mojo, "defaultBundles", "org.apache.sling",
        //		"org.apache.sling.launchpad", "RELEASE", "jar", "bundles", 0);
        makeArtifactAssertions(mojo, "defaultBundleList", "org.apache.sling", "org.apache.sling.launchpad", "7", "xml", "bundlelist", 0);
        makeArtifactAssertions(mojo, "jarWebSupport", "org.apache.felix", "org.apache.felix.http.jetty", "RELEASE", "jar", null, -1);
    }

    private void makeArtifactAssertions(PreparePackageMojo mojo, String name, String groupId, String artifactId, String version, String type, String classifier, int startLevel) throws Exception {
    ...
    private void invokeInitArtifactDefinitions(PreparePackageMojo mojo) throws Exception {
    ...
    private Method findMethod(Class<?> clazz, String name, Class<?>... args) throws NoSuchMethodException {
    ...
    private ArtifactDefinition getArtifactDefinition(PreparePackageMojo mojo, String name) throws Exception {
