...
class BundleResourceWebConsolePlugin extends HttpServlet {
    ...
    public void activate(BundleContext context) {
        providerTracker = new ServiceTracker(context, ResourceProvider.SERVICE_NAME, null) {
        ...
        serviceRegistration = context.registerService(Servlet.class.getName(), this, props);
    }
