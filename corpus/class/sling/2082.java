...
public class StartupFilterImplTest {
    ...
    private static class TestProvider implements StartupInfoProvider, ServiceReference {
    ...
    private static class TestFilterImpl extends StartupFilterImpl {
    ...
    private static class ChangeInteger implements Action {
    ...
    private void assertRequest(final int expectedStatus, final String expectedMessage) throws Exception {
        ...
        assertEquals("Expecting status to match", expectedStatus, lastReturnedStatus);
        assertEquals("Expecting message to match", expectedMessage, responseText);
    }
