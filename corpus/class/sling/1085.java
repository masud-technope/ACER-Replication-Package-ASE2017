...
public class MongoDBResource extends AbstractResource {
    ...
    public  MongoDBResource(final ResourceResolver resolver, final String resourcePath, final String collection, final DBObject dbObject, final MongoDBResourceProvider provider) {
    ...
    public String toString() {
        return "MongoDBResource [resourcePath=" + resourcePath + ", dbPath=" + this.dbObject.get(provider.getPROP_PATH()) + ", collection=" + collection + ", resourceResolver=" + resourceResolver + "]";
    }
