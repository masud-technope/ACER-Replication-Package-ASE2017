...
public class CompilerOptions extends Options {
    ...
    public static CompilerOptions createOptions(final Dictionary<String, Object> props) {
        ...
        final Boolean classDebugInfo = PropertiesUtil.toBoolean(props.get(JavaScriptEngineFactory.PROPERTY_CLASSDEBUGINFO), true);
        opts.put(Options.KEY_GENERATE_DEBUG_INFO, classDebugInfo);
        final String sourceVM = PropertiesUtil.toString(props.get(JavaScriptEngineFactory.PROPERTY_COMPILER_SOURCE_V_M), null);
        ...
        final String targetVM = PropertiesUtil.toString(props.get(JavaScriptEngineFactory.PROPERTY_COMPILER_TARGET_V_M), null);
        ...
        final String encoding = PropertiesUtil.toString(props.get(JavaScriptEngineFactory.PROPERTY_ENCODING), null);
