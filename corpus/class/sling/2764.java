...
public class DistributionAgentResourcesIntegrationTest extends DistributionIntegrationTestBase {
    ...
    public void testDefaultAgentConfigurationResourcesOnAuthor() throws Exception {
        String[] defaultAgentNames = new String[] { "publish", "publish-reverse" };
    ...
    public void testDefaultAgentConfigurationResourcesOnPublish() throws Exception {
        String[] defaultAgentNames = new String[] { "reverse" };
        for (String agentName : defaultAgentNames) {
    ...
    public void testDefaultPublishAgentResources() throws Exception {
        ...
        String[] defaultPublishAgentNames = new String[] { "reverse" };
    ...
    public void testDefaultAuthorAgentResources() throws Exception {
        ...
        String[] defaultAuthorAgentNames = new String[] { "publish", "publish-reverse" };
    ...
    public void testDefaultAgentsRootResource() throws Exception {
        ...
        assertResponseContains(author, agentRootUrl(), "sling:resourceType", "sling/distribution/service/agent/list", "items", "publish-reverse", "publish");
    }
    ...
    public void testAgentConfigurationResourceCreate() throws Exception {
        ...
        assertResponseContains(author, newConfigResource, "sling:resourceType", "sling/distribution/setting/agent", "name", agentName);
    }
    ...
    public void testAgentConfigurationResourceUpdate() throws Exception {
        ...
        assertResponseContains(author, newConfigResource, "sling:resourceType", "sling/distribution/setting/agent", "name", agentName, "packageExporter", "updated");
    }
}
