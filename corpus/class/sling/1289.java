...
public interface QueueConfiguration {
    ...
    /** The queue type. */
    static enum Type implements  {

        // unordered, parallel processing (push)
        UNORDERED() {
        }
        , // ordered, FIFO (push)
        ORDERED() {
        }
        , // unordered, parallel processing, executed based on topic (push)
        TOPIC_ROUND_ROBIN() {
        }
        ;
    }
     ...
     * @since 1.3
     */
    static enum ThreadPriority implements  {
