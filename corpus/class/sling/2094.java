...
public class SlowHealthCheckSample implements HealthCheck {
    ...
    @Property(label = "Minimum execution time", description = "Shortest execution time in milliseconds", intValue = SlowHealthCheckSample.DEFAULT_MIN_EXEC_TIME)
    ...
    @Property(label = "Maximum execution time", description = "Longest execution time in milliseconds", intValue = SlowHealthCheckSample.DEFAULT_MAX_EXEC_TIME)
