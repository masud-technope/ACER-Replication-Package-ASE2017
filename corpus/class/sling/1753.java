...
public class PythonScriptEngineFactory extends AbstractScriptEngineFactory {
    ...
    public static final String PYTON_SCRIPT_EXTENSION = "py";

    public static final String PYTHON_MIME_TYPE = "application/x-python";

    public static final String SHORT_NAME = "python";
