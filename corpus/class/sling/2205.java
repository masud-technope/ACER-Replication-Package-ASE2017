...
abstract class AbstractCopyMoveOperation extends AbstractPostOperation {
     ...
     *             the operation.
     */
    protected abstract Item execute(List<Modification> changes, Item source, String destParent, String destName, VersioningConfiguration versioningConfiguration) throws RepositoryException;
}
