...
public class ModelFactorySimpleTest {
    ...
    public void testIsModelClass() {
        ...
        // being provided by two adapters
    ...
    public void testCanCreateFromAdaptable() {
        ...
        // invalid adaptable
        assertFalse("Model is not detected as such", modelFactory.canCreateFromAdaptable(new String(), ConstructorInjectionTestModel.class));
    }

    @Test(expected = ModelClassException.class)
    public void testCanCreateFromAdaptableWithModelExceptin() {
        // no model class
        modelFactory.canCreateFromAdaptable(resource, DummyClass.class);
    }
}
