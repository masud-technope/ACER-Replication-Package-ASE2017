...
public class ResourceCollectionImpl implements ResourceCollection {
    ...
    private Resource findRes(Resource res) {
        if (res != null) {
            ...
            if (membersResource.getChild(resName) != null && (res.getPath()).equals(ResourceUtil.getValueMap(membersResource.getChild(resName)).get(ResourceCollectionConstants.REF_PROPERTY, "")))
            ...
            while (children.hasNext()) {
                ...
                if (ResourceUtil.getValueMap(r).get(ResourceCollectionConstants.REF_PROPERTY, "").equals(res.getPath()))
                    return r;
            }
        }
        return null;
