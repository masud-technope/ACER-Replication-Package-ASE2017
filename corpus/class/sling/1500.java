...
public class CommentsServiceImpl implements CommentsService {
    ...
    public String getCommentsResourcePath(final Resource resource) {
        ...
        if (contentPath != null) {
            final String fullPath = SlingshotConstants.APP_ROOT_PATH + "/users/" + SlingshotUtil.getUserId(resource) + "/ugc/comments" + contentPath;
            return fullPath;
        }
        return null;
    }
    ...
    public void addComment(final Resource resource, final Comment c) throws PersistenceException {
        ...
        final Resource ratingsResource = ResourceUtil.getOrCreateResource(resource.getResourceResolver(), commentsPath, props, null, true);
