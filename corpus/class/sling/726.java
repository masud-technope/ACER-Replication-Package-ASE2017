...
public class SlingPropertyValueHandlerAutotypeTest {
    ...
    private void assertAlias(String propertyNameA) {
        ...
        assertEquals("Expecting same AutotType for " + propertyNameA + " and " + propertyNameB, SlingPropertyValueHandler.getAutoType(propertyNameA), SlingPropertyValueHandler.getAutoType(propertyNameB));
    }
