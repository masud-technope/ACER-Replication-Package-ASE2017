...
public class VelocityTemplatesScriptEngineFactory extends AbstractScriptEngineFactory {
    ...
    public static final String VELOCITY_SCRIPT_EXTENSION = "vlt";

    public static final String VELOCITY_MIME_TYPE = "text/x-velocity";

    public static final String VELOCITY_SHORT_NAME = "velocity";
