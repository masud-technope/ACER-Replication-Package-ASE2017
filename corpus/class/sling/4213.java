...
public class Activator implements BundleActivator {
    ...
    public void start(final BundleContext context) throws Exception {
        ...
        final String[] serviceInterfaces = { OsgiInstaller.class.getName(), InfoProvider.class.getName(), ResourceChangeListener.class.getName(), RetryHandler.class.getName() };
    ...
    private void registerServices(final BundleContext context) throws Exception {
        ...
        for (final Class<?> serviceClass : serviceClasses) {
            ...
            if (service instanceof ResourceTransformer && service instanceof InstallTaskFactory) {
                serviceInterfaces = new String[] { ResourceTransformer.class.getName(), InstallTaskFactory.class.getName() };
