...
public class I18NFilter implements Filter {
    ...
    private static class I18NHttpServletRequest extends HttpServletRequestWrapper {
        ...
        private ResourceBundle resourceBundle;
         ...
         I18NHttpServletRequest(final ServletRequest delegatee, final ResourceBundleProvider bundleProvider, final RequestLocaleResolver localeResolver) {
    ...
    private static class I18NSlingHttpServletRequest extends BaseI18NSlingHttpServletRequest {
        ...
        private List<Locale> localeList;
         ...
         I18NSlingHttpServletRequest(final ServletRequest delegatee, final ResourceBundleProvider bundleProvider, final LocaleResolver localeResolver) {
