...
public class ResourceProviderAuthenticator {
    ...
    public  ResourceProviderAuthenticator(ResourceResolver resolver, Map<String, Object> authInfo, ResourceAccessSecurityTracker securityTracker) throws LoginException {
     ...
     */
    public void authenticateAll(final List<ResourceProviderHandler> handlers, final CombinedResourceProvider combinedProvider) throws LoginException {
    ...
    @Nonnull
    private StatefulResourceProvider authenticate(final ResourceProviderHandler handler, CombinedResourceProvider combinedProvider) throws LoginException {
    ...
    @Nonnull
    public StatefulResourceProvider getStateful(ResourceProviderHandler handler, CombinedResourceProvider combinedProvider) throws LoginException {
    ...
    public Collection<StatefulResourceProvider> getAllBestEffort(List<ResourceProviderHandler> handlers, CombinedResourceProvider combinedProvider) {
    ...
    @Nonnull
    private StatefulResourceProvider createStateful(ResourceProviderHandler handler, CombinedResourceProvider combinedProvider) throws LoginException {
