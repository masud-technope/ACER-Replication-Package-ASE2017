 ...
 * </code>
 */
@Component(immediate = true, metatype = true, label = "%deleteAuthorizable.post.operation.name", description = "%deleteAuthorizable.post.operation.description")
@Service(value = { Servlet.class, DeleteUser.class, DeleteGroup.class, DeleteAuthorizables.class })
@Properties({ @Property(name = "sling.servlet.resourceTypes", value = { "sling/user", "sling/group", "sling/userManager" }), @Property(name = "sling.servlet.methods", value = "POST"), @Property(name = "sling.servlet.selectors", value = "delete") })
