...
public class DefaultPrimitivesModel {
    ...
    @Inject
    public  DefaultPrimitivesModel(@Default(booleanValues = true) boolean booleanProperty, @Default(booleanValues = { true, true }) boolean[] booleanArrayProperty, @Default(longValues = 1L) long longProperty, @Default(longValues = { 1L, 1L }) long[] longArrayProperty) {
