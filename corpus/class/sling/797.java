...
public class PipelineImpl implements Processor {
    ...
    private <ComponentType> ComponentType getPipelineComponent(final Class<ComponentType> typeClass, final String type, final boolean optional) throws IOException {
