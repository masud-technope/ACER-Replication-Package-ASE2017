...
public class ResourceTraversor {
    ...
    public  ResourceTraversor(final Resource resource) throws JSONException {
     ...
     * @throws JSONException
     */
    private void collectChildren(final Resource resource, final JSONObject jsonObj) throws JSONException {
     ...
     * @throws JSONException
     */
    private JSONObject collectResource(final Resource resource, final JSONObject parent) throws JSONException {
