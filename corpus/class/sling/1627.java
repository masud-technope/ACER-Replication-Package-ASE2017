...
@Properties({ @org.apache.felix.scr.annotations.Property(name = "sling.preferences.jcr.path", value = "/preferences"), @org.apache.felix.scr.annotations.Property(name = "sling.preferences.jcr.namespace", value = "http://osgi.org/service/prefs/Preferences/1.1"), @org.apache.felix.scr.annotations.Property(name = "sling.preferences.jcr.prefix", value = "osgipref") })
public class JcrBackingStore implements BackingStore {
    ...
    protected void store(PreferencesImpl prefs, Session session) throws BackingStoreException, RepositoryException {
        ...
        @SuppressWarnings("unchecked") final Iterator<PreferencesImpl> i = prefs.getChildren().iterator();
        while (i.hasNext()) {
