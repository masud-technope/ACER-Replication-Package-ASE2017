...
public class VltSerializationManagerTest {
    ...
    public void getSerializationFilePath_Root() {
        ...
        assertThat(serializationManager.getBaseResourcePath(new File(root, ".content.xml").getAbsolutePath()), is(root.getAbsolutePath()));
    }
    ...
    public void getSerializationFilePath_NestedPath() {
        ...
        assertThat(serializationManager.getBaseResourcePath(f.getAbsolutePath()), is(f.getParentFile().getAbsolutePath()));
    }
    ...
    public void getRepositoryPath_MangledName() {
        assertThat(serializationManager.getRepositoryPath("/content/test/_jcr_content"), is("/content/test/jcr:content"));
    }
    ...
    public void getBaseResourcePath_MissingXmlFile() {
        ...
        assertThat(serializationManager.getBaseResourcePath(f.getAbsolutePath()), is(f.getAbsolutePath().replace(".xml", "")));
    }
}
