...
public class SlingWebDavServlet extends SimpleWebdavServlet {
    ...
    public static final String[] COLLECTION_TYPES_DEFAULT = new String[] { TYPE_NONCOLLECTIONS_DEFAULT, TYPE_CONTENT_DEFAULT };
