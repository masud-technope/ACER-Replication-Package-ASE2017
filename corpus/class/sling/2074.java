...
class Generator {
    ...
    private void genPreambleClassVariableDeclarations(String className) throws JasperException {
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
            for (int i = 0; i < tagHandlerPoolNames.size(); i++) {
                out.printil("private org.apache.sling.scripting.jsp.jasper.runtime.TagHandlerPool " + tagHandlerPoolNames.elementAt(i) + ";");
            }
            out.println();
        }
    ...
    class GenerateVisitor extends Node.Visitor {
        ...
        private String attributeValue(Node.JspAttribute attr, boolean encode, Class expectedType) {
            ...
            if (attr.isExpression()) {
                ...
                if (encode) {
                    return "org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.URLEncode(" + quote(v) + ", request.getCharacterEncoding())";
                }
                return quote(v);
            }
        }
        ...
        private void printParams(Node n, String pageParam, boolean literal) throws JasperException {
            class ParamVisitor extends Node.Visitor {
                ...
                public void visit(Node.ParamAction n) throws JasperException {
                    ...
                    out.print(separator);
                    out.print(" + ");
                    out.print("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary." + "URLEncode(" + quote(n.getTextAttribute("name")) + ", request.getCharacterEncoding())");
                    out.print("+ \"=\" + ");
        ...
        public void visit(Node.ELExpression n) throws JasperException {
            ...
            if (!pageInfo.isELIgnored() && (n.getEL() != null)) {
                out.printil("out.write(" + JspUtil.interpreterCall(this.isTagFile, n.getType() + "{" + new String(n.getText()) + "}", String.class, n.getEL().getMapName(), false) + ");");
            } else {
        ...
        public void visit(Node.IncludeAction n) throws JasperException {
            ...
            out.printin("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.include(request, response, " + pageParam);
        ...
        public void visit(Node.GetProperty n) throws JasperException {
            ...
            if (beanInfo.checkVariable(name)) {
                ...
                out.printil("out.write(org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.toString(" + "(((" + beanName + ")_jspx_page_context.findAttribute(" + "\"" + name + "\"))." + methodName + "())));");
            } else {
                // The object could be a custom action with an associated
                // VariableInfo entry for this name.
                // Get the class name and then introspect at runtime.
                out.printil("out.write(org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.toString" + "(org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.handleGetProperty" + "(_jspx_page_context.getAttribute(\"" + name + "\", PageContext.PAGE_SCOPE), \"" + property + "\")));");
            }
            n.setEndJavaLine(out.getJavaLine());
        }
        ...
        public void visit(Node.SetProperty n) throws JasperException {
            ...
            n.setBeginJavaLine(out.getJavaLine());
            if ("*".equals(property)) {
                out.printil("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.introspect(" + "_jspx_page_context.findAttribute(" + "\"" + name + "\"), request);");
            } else if (value == null) {
                if (param == null) {
                    // default to same as property
                    param = property;
                }
                out.printil("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", request.getParameter(\"" + param + "\"), " + "request, \"" + param + "\", false);");
            } else if (value.isExpression()) {
                out.printil("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.handleSetProperty(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\",");
                ...
                out.printil("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.handleSetPropertyExpression(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", " + quote(value.getValue()) + ", " + "_jspx_page_context, " + value.getEL().getMapName() + ");");
                ...
                out.printil("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", " + valueVarName + ", null, null, false);");
            } else {
                out.printin("org.apache.sling.scripting.jsp.jasper.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", ");
                out.print(attributeValue(value, false, null));
        ...
        public void visit(Node.TemplateText n) throws JasperException {
            ...
            // relative to starting srouce line
            int srcLine = 0;
            ...
            if (body != null) {
                ...
                if (body.size() == 1) {
                    ...
                    if (bodyElement instanceof Node.TemplateText) {
                        ...
                        out.printil("String " + varName + " = " + quote(new String(((Node.TemplateText) bodyElement).getText())) + ";");
                    }
                }
                if (!templateTextOptimization) {
                    out.printil("out = _jspx_page_context.pushBody();");
                    visitBody(n);
                    out.printil("String " + varName + " = " + "((javax.servlet.jsp.tagext.BodyContent)" + "out).getString();");
                    out.printil("out = _jspx_page_context.popBody();");
                }
            } else {
    ...
    public static void generate(ServletWriter out, Compiler compiler, Node.Nodes page) throws JasperException {
        ...
        if (gen.ctxt.isTagFile()) {
            ...
            page.visit(gen.new GenerateVisitor(gen.ctxt.isTagFile(), out, gen.methodsBuffered, gen.fragmentHelperClass, gen.ctxt.getClassLoader(), tagInfo));
            gen.generateTagHandlerPostamble(tagInfo);
        } else {
            gen.generatePreamble(page);
            gen.generateXmlProlog(page);
            gen.fragmentHelperClass.generatePreamble();
            page.visit(gen.new GenerateVisitor(gen.ctxt.isTagFile(), out, gen.methodsBuffered, gen.fragmentHelperClass, gen.ctxt.getClassLoader(), null));
    ...
    private void generateSetJspContext(TagInfo tagInfo) {
        ...
        if (aliasSeen) {
            out.printil("this.jspContext = new org.apache.sling.scripting.jsp.jasper.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, aliasMap);");
        } else {
            out.printil("this.jspContext = new org.apache.sling.scripting.jsp.jasper.runtime.JspContextWrapper(ctx, _jspx_nested, _jspx_at_begin, _jspx_at_end, null);");
        }
        out.popIndent();
        out.printil("}");
        out.println();
