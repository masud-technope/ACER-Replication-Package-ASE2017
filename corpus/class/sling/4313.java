...
public class WebLoaderImpl implements Webloader {
    ...
    /** @inheritDoc */
    public String createJob(String webQuery, String storagePath, String fileExtensions, int maxDocsToRetrieve, int maxDocSizeInKb) {
        deleteFinishedJobs();
        final WebloaderJob j = new WebloaderJob(repository, mimeTypeService, webQuery, storagePath, fileExtensions, maxDocsToRetrieve, maxDocSizeInKb);
        synchronized (jobs) {
