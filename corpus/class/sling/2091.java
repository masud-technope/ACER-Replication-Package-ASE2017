...
@Properties({ @Property(name = "scheduler.period", longValue = 60), @Property(name = "scheduler.concurrent", boolValue = false), @Property(name = EventConstants.EVENT_TOPIC, value = { SlingConstants.TOPIC_RESOURCE_ADDED, SlingConstants.TOPIC_RESOURCE_CHANGED, SlingConstants.TOPIC_RESOURCE_REMOVED, ResourceHelper.BUNDLE_EVENT_STARTED, ResourceHelper.BUNDLE_EVENT_UPDATED }) })
public class JobManagerImpl implements JobManager, EventHandler, Runnable {
    ...
    private enum Operation implements  {
     ...
     */
    private Job addJobInteral(final String jobTopic, final Map<String, Object> jobProperties, final List<String> errors) {
     ...
     */
    private JobImpl writeJob(final ResourceResolver resolver, final String jobTopic, final Map<String, Object> jobProperties, final QueueInfo info) throws PersistenceException {
     ...
     */
    @Override
    public Collection<ScheduledJobInfo> getScheduledJobs(final String topic, final long limit, final Map<String, Object>... templates) {
