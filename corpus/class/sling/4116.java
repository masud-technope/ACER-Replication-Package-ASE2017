...
public class IntermediatePathsExtractorTest {
    ...
    public void extractPaths() {
        doTest("http://localhost:8080/apps/slingshot/install", Arrays.asList("http://localhost:8080/apps", "http://localhost:8080/apps/slingshot", "http://localhost:8080/apps/slingshot/install"));
    }
