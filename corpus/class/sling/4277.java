...
public class RunMode extends Traceable implements Comparable<RunMode> {
    ...
    public boolean isRunMode(final String mode) {
        ...
        if (mode != null && this.names != null && this.names.length == 1 && this.names[0].equals(mode)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "RunMode [names=" + Arrays.toString(names) + ", groups=" + groups + ", configurations=" + configurations + ", settings=" + settings + "]";
    }
}
