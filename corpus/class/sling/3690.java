...
@Properties({ @Property(name = "service.description", value = "Sling APT Servlet"), @Property(name = "sling.servlet.resourceTypes", value = "sling/servlet/default"), @Property(name = "sling.servlet.extensions", value = "aptml") })
public class SlingAptServlet extends SlingSafeMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws IOException {
        ...
        if (stream == null) {
            response.sendError(HttpServletResponse.SC_BAD_REQUEST, "Resource does not adapt to an InputStream: " + request.getResource());
            return;
        }
        ...
        try {
            ...
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Exception while parsing APT content: " + e);
        }
