...
public interface QueryManager {
     ...
     */
    @Nonnull
    Result find(@Nonnull ResourceResolver resolver, @Nonnull Query q, @CheckForNull QueryInstructions qi);
     ...
     */
    @Nonnull
    Query andQuery(@Nonnull Query q1, @Nonnull Query... q2);
     ...
     */
    @Nonnull
    Query orQuery(@Nonnull Query q1, @Nonnull Query... q2);
     ...
     */
    @Nonnull
    QueryInstructionsBuilder instructions();
}
