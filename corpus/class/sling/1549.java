...
public class SuppTest {
    ...
    private static final IteratorToIteratorFunctionWrapper<String> EXPANDING_FUNCTION = new IteratorToIteratorFunctionWrapper<String>(new ElementToIteratorFunction<String>() {
