...
@Properties({ @Property(name = "provider.roots", value = { "/content/cassandra" }) })
public class CassandraResourceProvider implements ResourceProvider, ModifyingResourceProvider {
    ...
    private static final String KEYSPACE = "sling_cassandra";

    private String CASSANDRA_EP = "localhost:9160";

    private ConcurrentHashMap<String, CassandraMapper> cassandraMapperMap = new ConcurrentHashMap<String, CassandraMapper>();
