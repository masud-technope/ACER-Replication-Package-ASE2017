...
public class ResourceHelperWithoutJcrTest {
    ...
    private static final Map<String, Object> VALUEMAP_1 = ImmutableMap.<String, Object>builder().put("prop1", "value1").put("prop2", 25).build();

    private static final Map<String, Object> VALUEMAP_2 = ImmutableMap.<String, Object>builder().put("prop1", "value2").put("prop5", true).build();
