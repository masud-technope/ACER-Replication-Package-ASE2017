...
public class JSONValue {
    ...
    private String getBinaryDownloadURLFromPropertyDef(int index, PropertyDefinition propertyDef) {
        ...
        return String.format("/%s/%s/%s/%s/%s/%s/%s/%s/%s.default_binary_value.bin", nodeTypeName, propertyName, propertyType, isAutoCreated, isMandatory, isProtected, isMultiple, onParentVersionAction, index);
    }
