...
public class Artifact extends Commentable implements Comparable {
     ...
     */
    public  Artifact(final String gId, final String aId, final String version, final String classifier, final String type) {
    ...
    public String toString() {
        return "Artifact [groupId=" + groupId + ", artifactId=" + artifactId + ", version=" + version + ", classifier=" + classifier + ", type=" + type + (this.getLocation() != null ? ", location=" + this.getLocation() : "") + "]";
    }
}
