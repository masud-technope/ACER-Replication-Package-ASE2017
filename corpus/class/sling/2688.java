...
public class Resource implements Serializable, Comparable<Resource> {
    ...
    private  Resource(URL resourceURL, Attributes attrs, long size) throws IOException {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Resource) {
            ...
            return this.getSymbolicName().equals(other.getSymbolicName()) && this.getVersion().equals(other.getVersion());
        }
        return false;
    }
