...
public class TeleportedResourcesSingleTest {
    ...
    @Rule
    public final TeleporterRule teleporter = TeleporterRule.forClass(getClass(), "Launchpad").withResources("/teleporter/file2.txt", "/teleporter/subfolder/thirdfile.txt");
