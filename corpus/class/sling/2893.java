...
public class RepositoryMojo extends AbstractSlingStartMojo {
     ...
     */
    private void copyArtifactToRepository(final org.apache.sling.provisioning.model.Artifact artifact, final File artifactDir) throws MojoExecutionException {
        final File artifactFile = getRepositoryFile(artifactDir, artifact);
        final Artifact source = ModelUtils.getArtifact(this.project, this.mavenSession, this.artifactHandlerManager, this.resolver, artifact.getGroupId(), artifact.getArtifactId(), artifact.getVersion(), artifact.getType(), artifact.getClassifier());
        try {
