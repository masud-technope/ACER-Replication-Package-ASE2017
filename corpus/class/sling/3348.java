...
public class ScriptEngineManagerFactory implements BundleListener {
        ...
        if (log.isInfoEnabled()) {
            for (Object o : extensions) {
                ...
                if (e == null) {
                    ...
                    log.info("Script extension '{}' is now handled by ScriptEngine '{}', version='{}', class='{}'", new Object[] { ext, e.getFactory().getEngineName(), e.getFactory().getEngineVersion(), e.getClass().getName() });
                }
            }
        }
    }
    ...
    protected void activate(ComponentContext context) {
        ...
        this.refreshScriptEngineManager();
        scriptEngineManagerRegistration = this.bundleContext.registerService(new String[] { ScriptEngineManager.class.getName(), SlingScriptEngineManager.class.getName() }, scriptEngineManager, new Hashtable<String, Object>());
