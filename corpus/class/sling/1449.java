...
public class SightlyScriptEngine extends AbstractSlingScriptEngine {
    ...
    public Object eval(Reader reader, ScriptContext scriptContext) throws ScriptException {
        ...
        final ResourceResolver scriptResourceResolver = (ResourceResolver) scriptContext.getAttribute(SlingScriptConstants.ATTR_SCRIPT_RESOURCE_RESOLVER, SlingScriptConstants.SLING_SCOPE);
        try {
