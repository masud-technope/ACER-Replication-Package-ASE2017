...
public class MultiplexingAuthorizableAction extends AbstractAuthorizableAction implements ServiceTrackerCustomizer {
    ...
    private Map<Comparable, AuthorizableAction> actionMap = new ConcurrentSkipListMap<Comparable, AuthorizableAction>(Collections.reverseOrder());
    ...
    private Filter createFilter(BundleContext context) {
        try {
            ...
            return context.createFilter("(&(!(jackrabbit.extension=true))" + "(objectClass=org.apache.jackrabbit.core.security.user.action.AuthorizableAction))");
