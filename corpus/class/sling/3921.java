...
public class ResourceProviderTracker {
    ...
    private void postOSGiEvent(final ProviderEvent event) {
        ...
        eventAdmin.postEvent(new Event(event.isAdd ? SlingConstants.TOPIC_RESOURCE_PROVIDER_ADDED : SlingConstants.TOPIC_RESOURCE_PROVIDER_REMOVED, eventProps));
    }
    ...
    private void postResourceProviderChange(final ProviderEvent event) {
        final ResourceChange change = new ResourceChange(event.isAdd ? ChangeType.PROVIDER_ADDED : ChangeType.PROVIDER_REMOVED, event.path, false, null, null, null);
