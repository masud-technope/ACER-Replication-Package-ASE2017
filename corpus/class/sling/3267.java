...
public class OpenIDAuthenticationHandlerTest extends TestCase {
    ...
    public void test_getBaseUrl() {
        ...
        // http/999
        assertEquals(HTTP + "://" + NAME + ":" + port999, handler1.getBaseUrl(request));
        // https/999
        assertEquals(HTTPS + "://" + NAME + ":" + port999, handler1.getBaseUrl(request));
        // any/80
        assertEquals(ANY + "://" + NAME + ":" + port80, handler1.getBaseUrl(request));
        // any/443
        assertEquals(ANY + "://" + NAME + ":" + port443, handler1.getBaseUrl(request));
        // any/999
        assertEquals(ANY + "://" + NAME + ":" + port999, handler1.getBaseUrl(request));
        // http/-1
        assertEquals(HTTP + "://" + NAME, handler1.getBaseUrl(request));
        // https/-1
        assertEquals(HTTPS + "://" + NAME, handler1.getBaseUrl(request));
