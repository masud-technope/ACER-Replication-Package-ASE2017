...
public class EspLoadTest extends HttpTestBase {
    ...
    public void testNestedInclude() throws Exception {
        ...
        final String[] toDelete = { uploadTestScript(tn.scriptPath, "esp-load/main.esp", "html.esp"), uploadTestScript(tn.scriptPath, "esp-load/included-a.esp", "included-a.esp"), uploadTestScript(subfolder, "esp-load/subfolder/included-b.esp", "included-b.esp") };
        try {
            final String content = getContent(tn.nodeUrl + ".html", CONTENT_TYPE_HTML);
            final String[] expectedStringsInOrder = { "main.esp before load", "included-a.esp before load", "included-b.esp", "included-a.esp after load", "main.esp after load", "Here's more from included-a" };
            int pos = 0;
    ...
    public void testNonExistentInclude() throws Exception {
        ...
        try {
            assertHttpStatus(tn.nodeUrl + ".html", HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Including " + badScript + " must fail");
        } finally {
