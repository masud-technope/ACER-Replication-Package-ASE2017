...
public class SlingHealthCheckProcessor implements AnnotationProcessor {
    ...
    private void processHealthCheck(final ClassAnnotation cad, final ClassDescription classDescription) {
        ...
        generateStringPropertyDescriptor(cad, classDescription, metatype, "asyncCronExpression", "hc.async.cronExpression", /* use constant once API is released */
    ...
    private void generateStringPropertyDescriptor(final ClassAnnotation cad, final ClassDescription classDescription, final boolean metatype, final String propertyName, final String propertyDescriptorName, String label, String description, boolean isArray) {
