...
@Service(value = { Servlet.class, CreateUser.class })
...
public class CreateUserServlet extends AbstractUserPostServlet implements CreateUser {
    ...
    @Property(label = "%self.registration.enabled.name", description = "%self.registration.enabled.description", boolValue = DEFAULT_SELF_REGISTRATION_ENABLED)
