...
public class Announcement {
    ...
    public String toString() {
        ...
        return "Announcement[ownerId=" + getOwnerId() + ", protocolVersion=" + protocolVersion + ", inherited=" + isInherited() + ", loop=" + loop + ", incomings=" + incomingList + "]";
    }
    ...
    public static Announcement fromJSON(final String topologyAnnouncementJSON) throws JSONException {
        ...
        final String localClusterViewJSON = announcement.getString("localClusterView");
    ...
    private static ClusterView asClusterView(final String localClusterViewJSON) throws JSONException {
    ...
    private static JSONObject asJSON(final ClusterView clusterView) throws JSONException {
    ...
    private static DefaultInstanceDescription asInstance(final JSONObject anInstance) throws JSONException {
    ...
    private static JSONObject asJSON(final InstanceDescription instanceDescription) throws JSONException {
        JSONObject obj = new JSONObject();
    ...
    public void removeInherited(final String ownerId) {
        for (Iterator<Announcement> it = incomings.iterator(); it.hasNext(); ) {
            Announcement anIncomingAnnouncement = it.next();
            if (anIncomingAnnouncement.isInherited() && anIncomingAnnouncement.getOwnerId().equals(ownerId)) {
                // then filter this
                it.remove();
            }
        }
