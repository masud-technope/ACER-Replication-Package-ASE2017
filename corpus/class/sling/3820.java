...
public abstract class JsonObjectCreator {
    ...
    public static JSONObject create(final Resource resource) throws JSONException {
    ...
    /** Dump a single node */
    private static void createSingleResource(final Resource n, final JSONObject parent) throws JSONException {
