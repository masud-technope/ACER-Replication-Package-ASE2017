...
public class Configurations implements Closeable {
    ...
    private static class ConfigAdminProxy {
        ...
        Object createFactoryConfiguration(String factoryPid) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
            return svc.getClass().getMethod("createFactoryConfiguration", String.class).invoke(svc, factoryPid);
        }

        Object getConfiguration(String pid) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
            return svc.getClass().getMethod("getConfiguration", String.class).invoke(svc, pid);
        }

        void setConfigBundleLocation(Object config, String location) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
            config.getClass().getMethod("setBundleLocation", String.class).invoke(config, location);
        }

        void updateConfig(Object config, Dictionary<String, Object> properties) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
    ...
    private void setConfig(Configuration c) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
