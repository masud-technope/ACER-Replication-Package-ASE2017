...
class MockRepository implements Repository {
    ...
    public Session login(final Credentials credentials, final String workspaceName) throws RepositoryException {
        ...
        return new MockSession(this, items, StringUtils.defaultString(userId, MockJcr.DEFAULT_USER_ID), StringUtils.defaultString(workspaceName, MockJcr.DEFAULT_WORKSPACE));
    }
