...
public class MongoDBNoSqlResourceProviderIT extends AbstractNoSqlResourceProviderTest {
    ...
    protected void registerResourceProviderFactory() {
        context.registerInjectActivateService(new MongoDBNoSqlResourceProviderFactory(), ImmutableMap.<String, Object>builder().put(ResourceProvider.ROOTS, "/test").put("connectionString", System.getProperty("connectionString", "localhost:27017")).put("database", System.getProperty("database", "sling")).put("collection", System.getProperty("collection", "resources")).build());
    }
