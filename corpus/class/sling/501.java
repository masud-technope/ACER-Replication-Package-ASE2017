 ...
 */
@Component
@Properties({ @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = "service.description", value = "Default Login Form for the Authenticator Selector") })
...
public class SelectorFormServlet extends AbstractAuthenticationFormServlet {
    ...
    private static final String[] AUTH_REQUIREMENT = { "-" + SERVLET_PATH, "-/sling.css", "-/sling-logo.png", "-/signup.html" };
