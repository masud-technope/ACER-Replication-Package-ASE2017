...
public abstract class DistributionIntegrationTestBase {
    ...
    static {
        ...
        try {
            ...
            registerReverse("impersonate-publish-reverse", "impersonate-reverse");
            {
                ...
                setArrayProperties(author, authorAgentConfigUrl("publish-multiple"), "packageImporter.endpoints", "endpoint1=" + remoteImporterUrl, "endpoint2=" + remoteImporterUrl + "badaddress");
                Thread.sleep(1000);
            ...
            }
            {
                ...
                setArrayProperties(author, authorAgentConfigUrl("publish-selective"), "packageImporter.endpoints", "publisher1=" + remoteImporterUrl);
                Thread.sleep(1000);
    ...
    public static void registerPublish(String publishAgent, String remoteImporter) throws Exception {
        ...
        authorClient.setProperties(authorAgentConfigUrl(publishAgent), "packageImporter.endpoints", remoteImporterUrl);
        Thread.sleep(1000);
