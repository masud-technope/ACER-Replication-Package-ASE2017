...
public class ResourceValidationModelProviderImpl implements ValidationModelProvider, EventHandler {
    ...
    protected void activate(ComponentContext componentContext) throws LoginException {
        ...
        try {
            ...
            eventHandlerRegistration = componentContext.getBundleContext().registerService(EventHandler.class.getName(), this, eventHandlerProperties);
            ...
            while (models.hasNext()) {
                ...
                try {
                    ...
                    if (resourceProperties.isEmpty() && children.isEmpty()) {
                        ...
                        vm = new ValidationModelImpl(resourceProperties, relativeResourceType, applicablePaths, children);
     ...
     */
    @Nonnull
    private List<ResourceProperty> buildProperties(@Nonnull Map<String, Validator<?>> validatorsMap, Resource propertiesResource) {
     ...
     */
    @Nonnull
    private List<ChildResource> buildChildren(@Nonnull Resource modelResource, @Nonnull Resource rootResource, @Nonnull Map<String, Validator<?>> validatorsMap) {
