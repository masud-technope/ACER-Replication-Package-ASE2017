...
public class LaunchpadEnvironment {
    ...
    public  LaunchpadEnvironment(final File launchpadJar, final boolean cleanWorkingDirectory, final boolean shutdownOnExit, final int readyTimeOutSec, final String debug) {
    ...
    private void copyResource(final String resource, final File dir) throws IOException {
