...
public class JmxAdjustableStatusForTesting {
    ...
    private class AdjustableHealthCheckStatusMBean implements DynamicMBean {
        ...
        private MBeanInfo createMBeanInfo() {
            ...
            ops.add(new MBeanOperationInfo(OP_RESET, "Resets this testing mechanism and removes the failing HC", new MBeanParameterInfo[0], "java.lang.String", MBeanOperationInfo.ACTION));
            ops.add(new MBeanOperationInfo(OP_ADD_CRITICAL_RESULT_FOR_TAGS, "Adds a critical result for the given tags", params, "java.lang.String", MBeanOperationInfo.ACTION));
            ops.add(new MBeanOperationInfo(OP_ADD_WARN_RESULT_FOR_TAGS, "Adds a warn result for the given tags", params, "java.lang.String", MBeanOperationInfo.ACTION));
