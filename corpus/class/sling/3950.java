...
public class FreemarkerScriptEngineFactory extends AbstractScriptEngineFactory {
    ...
    public static final String FREEMARKER_SCRIPT_EXTENSION = "ftl";

    /** The MIME type of FreeMarker script files (value is "text/x-freemarker"). */
    public static final String FREEMARKER_MIME_TYPE = "text/x-freemarker";

    /**
     * The short name of the FreeMarker script engine factory (value is
     * "freemarker").
     */
    public static final String SHORT_NAME = "freemarker";
    ...
    public  FreemarkerScriptEngineFactory() {
        ...
        languageVersion = (langVersion == null) ? DEFAULT_FREEMARKER_VERSION : langVersion;
    }
