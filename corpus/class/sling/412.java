...
public class AuthorizableResource extends AbstractResource {
    ...
    public  AuthorizableResource(Authorizable authorizable, ResourceResolver resourceResolver, String path) {
        super();
    ...
    public <AdapterType> AdapterType adaptTo(Class<AdapterType> type) {
        ...
        // cast
        } else if (type == Authorizable.class || (type == User.class && !authorizable.isGroup()) || (type == Group.class && authorizable.isGroup())) {
