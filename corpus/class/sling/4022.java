...
@Service
@Properties({ @Property(name = "service.description", value = "Apache Sling Workspace Picker"), @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = "pattern", value = "/.*", propertyPrivate = true) })
