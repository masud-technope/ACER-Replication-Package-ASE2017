 ...
 */
@Component
@Service(value = { Servlet.class, GetAcl.class })
@Properties({ @Property(name = "sling.servlet.resourceTypes", value = "sling/servlet/default"), @Property(name = "sling.servlet.methods", value = "GET"), @Property(name = "sling.servlet.selectors", value = { "acl", "tidy.acl" }), @Property(name = "sling.servlet.extensions", value = "json") })
public class GetAclServlet extends AbstractGetAclServlet implements GetAcl {
	 ...
	 */
    public JSONObject getAcl(Session jcrSession, String resourcePath) throws RepositoryException, JSONException {
