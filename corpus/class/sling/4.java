...
@Properties({ @Property(name = org.osgi.framework.Constants.SERVICE_DESCRIPTION, value = "Apache Sling Web Console Plugin to tail log(s) of this Sling instance"), @Property(name = WebConsoleConstants.PLUGIN_LABEL, value = LogTailerWebConsolePlugin.LABEL), @Property(name = WebConsoleConstants.PLUGIN_TITLE, value = LogTailerWebConsolePlugin.TITLE), @Property(name = "felix.webconsole.configprinter.modes", value = { "always" }) })
