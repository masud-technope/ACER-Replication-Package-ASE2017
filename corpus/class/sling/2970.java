...
public class BundleUninstallMojo extends AbstractBundleInstallMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        getLog().info("Unistalling Bundle " + bundleName + ") from " + targetURL + " via " + (usePut ? "DELETE" : "POST"));
    ...
    protected void delete(String targetURL, File file) throws MojoExecutionException {
    ...
    protected void post(String targetURL, String symbolicName) throws MojoExecutionException {
