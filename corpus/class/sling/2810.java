...
public class DefaultWrappersModel {
    ...
    @Inject
    public  DefaultWrappersModel(@Default(booleanValues = true) Boolean booleanWrapperProperty, @Default(booleanValues = { true, true }) Boolean[] booleanWrapperArrayProperty, @Default(longValues = 1L) Long longWrapperProperty, @Default(longValues = { 1L, 1L }) Long[] longWrapperArrayProperty) {
