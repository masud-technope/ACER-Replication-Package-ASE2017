...
public class SlingSettingsPrinter {
    ...
    public static void initPlugin(final BundleContext bundleContext, final SlingSettingsService service) {
        final SlingSettingsPrinter printer = new SlingSettingsPrinter(service);
        final Dictionary<String, String> props = new Hashtable<String, String>();
        props.put(Constants.SERVICE_DESCRIPTION, "Apache Sling Sling Settings Configuration Printer");
        props.put(Constants.SERVICE_VENDOR, "The Apache Software Foundation");
        props.put("felix.webconsole.label", "slingsettings");
        props.put("felix.webconsole.title", "Sling Settings");
        props.put("felix.webconsole.configprinter.modes", "always");
        pluginReg = bundleContext.registerService(SlingSettingsPrinter.class.getName(), printer, props);
    }
