...
public class NoClusterDiscoveryService implements DiscoveryService {
     ...
     */
    @SuppressWarnings("unused")
    private void unbindPropertyProvider(final PropertyProvider propertyProvider, final Map<String, Object> props, final boolean inform) {
    ...
    private void bindTopologyEventListener(final TopologyEventListener clusterAware) {
        ...
        boolean inform = true;
        synchronized (lock) {
            List<TopologyEventListener> currentList = new ArrayList<TopologyEventListener>(Arrays.asList(listeners));
