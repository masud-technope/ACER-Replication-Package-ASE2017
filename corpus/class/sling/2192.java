...
public class ErbScriptEngine extends AbstractSlingScriptEngine {
    ...
    public  ErbScriptEngine(ErbScriptEngineFactory factory) {
        ...
        try {
            ...
            runtime.evalScriptlet("require 'java';require 'erb';self.send :include, ERB::Util;class ERB;def get_binding;binding;end;attr_reader :props;def set_props(p);@props = p;" + "for name,v in @props;instance_eval \"def #{name}; @props['#{name}'];end\";end;end;end;");
    ...
    public Object eval(Reader script, ScriptContext scriptContext) throws ScriptException {
        ...
        try {
            ...
            IRubyObject erb = (IRubyObject) JavaEmbedUtils.invokeMethod(runtime, erbModule, "new", new Object[] { scriptRubyString }, IRubyObject.class);
            ...
            scriptContext.getWriter().write((String) JavaEmbedUtils.invokeMethod(runtime, erb, "result", new Object[] { binding }, String.class));
        } catch (Throwable t) {
