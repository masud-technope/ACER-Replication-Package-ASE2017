...
public class BasicResolveContext<T> implements ResolverContext<T> {
    ...
    public  BasicResolveContext(ResourceResolver resourceResolver, T providerState, String parentPath, CombinedResourceProvider combinedProvider) {
    ...
    public  BasicResolveContext(ResourceResolver resourceResolver, T providerState, String parentPath) {
