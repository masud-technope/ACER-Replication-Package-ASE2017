...
public class RankedServicesTest {
    ...
    private static final Map<String, Object> SERVICE_1_PROPS = ImmutableMap.<String, Object>builder().put(Constants.SERVICE_RANKING, 50).put(Constants.SERVICE_ID, 1L).build();

    private static final String SERVICE_2 = "service2";

    private static final Map<String, Object> SERVICE_2_PROPS = ImmutableMap.<String, Object>builder().put(Constants.SERVICE_RANKING, 10).put(Constants.SERVICE_ID, 2L).build();

    private static final String SERVICE_3 = "service3";

    private static final Map<String, Object> SERVICE_3_PROPS = ImmutableMap.<String, Object>builder().put(Constants.SERVICE_RANKING, 100).put(Constants.SERVICE_ID, 3L).build();
