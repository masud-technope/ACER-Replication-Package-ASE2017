...
public class UpdateSubsystemTask extends InstallTask {
    ...
    public  UpdateSubsystemTask(final TaskResourceGroup grp, final BundleContext bundleContext, final ServiceReference<Subsystem> ref, final Subsystem rootSubsystem) {
        super(grp);
