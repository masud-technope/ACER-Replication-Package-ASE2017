...
public interface SlingScriptHelper {
     ...
     */
    @CheckForNull
    <ServiceType> ServiceType getService(@Nonnull Class<ServiceType> serviceType);
     ...
     */
    @CheckForNull
    <ServiceType> ServiceType[] getServices(@Nonnull Class<ServiceType> serviceType, String filter);
