...
@Component
@Service
@Properties({ @Property(name = ContentReader.PROPERTY_EXTENSIONS, value = "json"), @Property(name = ContentReader.PROPERTY_TYPES, value = "application/json") })
public class JsonReader implements ContentReader {
    ...
    private String toString(InputStream ins) throws IOException {
        ...
        // just to comply with the contract
        bos.close();
