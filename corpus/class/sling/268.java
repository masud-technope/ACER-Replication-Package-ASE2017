...
public final class ExpressionTranslator extends SideEffectVisitor {
    ...
    public void visit(BinaryOperation binaryOperation) {
        ...
        opGen.generate(source, this, typeInfo.getTyped(binaryOperation.getLeftOperand()), typeInfo.getTyped(binaryOperation.getRightOperand()));
    ...
    public void visit(NumericConstant numericConstant) {
        ...
        source.append(numericConstant.getValue().toString());
    }
    ...
    public void visit(TernaryOperator ternaryOperator) {
        GenHelper.generateTernary(source, this, typeInfo.getTyped(ternaryOperator.getCondition()), typeInfo.getTyped(ternaryOperator.getThenBranch()), typeInfo.getTyped(ternaryOperator.getElseBranch()));
    }
    ...
    public void visit(MapLiteral mapLiteral) {
        ...
        for (Map.Entry<String, ExpressionNode> entry : mapLiteral.getMap().entrySet()) {
            source.startCall(SourceGenConstants.MAP_TYPE_ADD, true).stringLiteral(entry.getKey()).separateArgument();
