...
public class Activator implements BundleActivator {
    ...
    private void registerInstaller(final BundleContext context, final Subsystem rootSubsystem) {
        ...
        this.serviceReg = context.registerService(new String[] { ResourceTransformer.class.getName(), InstallTaskFactory.class.getName() }, new SubsystemInstaller(rootSubsystem, context), props);
    }
