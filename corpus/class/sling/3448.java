...
public enum BinaryOperator implements  {
    ...
    ADD() {
        ...
        @Override
        public Object eval(Object left, Object right) {
            return adjust(RenderUtils.toNumber(left).doubleValue() + RenderUtils.toNumber(right).doubleValue());
        }
    }
    , // difference
    SUB() {
    ...
    I_DIV() {
        ...
        @Override
        public Object eval(Object left, Object right) {
            return adjust(RenderUtils.toNumber(left).intValue() / RenderUtils.toNumber(right).intValue());
        }
    }
    , // reminder
    REM() {
