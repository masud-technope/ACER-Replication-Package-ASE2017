...
public class ServiceUserMappedBundleFilterTest {
    ...
    static final String BUNDLE1 = "bundle1";

    static final String BUNDLE2 = "bundle2";

    static final BundleContext bundleContext1;

    static final BundleContext bundleContext2;
