...
public class StatisticsMBeanImpl implements DynamicMBean {
    ...
    public Object getAttribute(String attribute) throws AttributeNotFoundException, MBeanException, ReflectionException {
        ...
        try {
            if (attribute.startsWith("PerSecond_")) {
                return getTimeSeries(attribute.substring("PerSecond_".length())).getValuePerSecond();
            } else if (attribute.startsWith("PerMinute_")) {
                return getTimeSeries(attribute.substring("PerMinute_".length())).getValuePerMinute();
            } else if (attribute.startsWith("PerHour_")) {
                return getTimeSeries(attribute.substring("PerHour_".length())).getValuePerHour();
            } else if (attribute.startsWith("PerWeek_")) {
                return getTimeSeries(attribute.substring("PerWeek_".length())).getValuePerWeek();
            } else if (attribute.startsWith("LastMinutePerSecond_")) {
                return getCurrentValue(getTimeSeries(attribute.substring("LastMinutePerSecond_".length())).getValuePerSecond());
            } else if (attribute.startsWith("LastHourPerMinute_")) {
                return getCurrentValue(getTimeSeries(attribute.substring("LastHourPerMinute_".length())).getValuePerMinute());
            } else if (attribute.startsWith("LastWeekPerHour_")) {
                return getCurrentValue(getTimeSeries(attribute.substring("LastWeekPerHour_".length())).getValuePerHour());
            } else if (attribute.startsWith("LastYearPerWeek_")) {
                return getCurrentValue(getTimeSeries(attribute.substring("LastYearPerWeek_".length())).getValuePerWeek());
            }
    ...
    public MBeanInfo getMBeanInfo() {
        ...
        while (statIter.hasNext()) {
            Entry<String, TimeSeries> entry = statIter.next();
            attributesList.add(new MBeanAttributeInfo("PerSecond_" + entry.getKey(), long.class.getName(), "Current per second value of " + entry.getKey(), true, false, false));
            ...
            attributesList.add(new MBeanAttributeInfo("PerMinute" + entry.getKey(), long.class.getName(), "Current per minute value of " + entry.getKey(), true, false, false));
            ...
            attributesList.add(new MBeanAttributeInfo("PerHour_" + entry.getKey(), long.class.getName(), "Current per hour value of " + entry.getKey(), true, false, false));
            ...
            attributesList.add(new MBeanAttributeInfo("PerWeek_" + entry.getKey(), long.class.getName(), "Current per week value of " + entry.getKey(), true, false, false));
        ...
        for (Type t : Type.values()) {
            ...
            if (!typeNames.contains(name)) {
                attributesList.add(new MBeanAttributeInfo(name, long.class.getName(), "Current counter value of " + name, true, false, false));
                typeNames.add(name);
            }
        }
