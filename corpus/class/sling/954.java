 ...
 */
@Component(immediate = true, metatype = true, label = "%authorizable.resourceprovider.name", description = "%authorizable.resourceprovider.description")
@Service(value = ResourceProvider.class)
@Properties({ @Property(name = "service.description", value = "Resource provider implementation for UserManager resources"), @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = "provider.roots", value = "/system/userManager/") })
public class AuthorizableResourceProvider implements ResourceProvider {
    ...
    public Resource getResource(ResourceResolver resourceResolver, String path) {
        ...
        if (pid != null) {
            if (pid.indexOf('/') != -1) {
                // something bogus on the end of the path so bail
                return null;
            // out now.
            }
            try {
