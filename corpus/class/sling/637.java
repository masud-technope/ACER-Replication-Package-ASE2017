...
public class InitResourceTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] { { "/one;v=1.1", "one;v=1.1", "/one;v=1.1" }, { "/two;v=1.1", "two", "/two;v=1.1" }, { "/three", "three", "/three" }, { "/four%3Bv=1.1", "four", "/four" }, { "/five%3Bv=1.1", "five;v=1.1", "/five;v=1.1" }, { "/six;v=1.1", "six;v=1.1", "/six;v=1.1" }, { "/seven", "seven;v=1.1", "/seven;v=1.1" } });
    }
