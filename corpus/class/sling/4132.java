...
@Properties({ @Property(name = "service.description", value = "Sightly Include Block Plugin"), @Property(name = Plugin.SCR_PROP_NAME_BLOCK_NAME, value = "include"), @Property(name = Plugin.SCR_PROP_NAME_PRIORITY, intValue = PluginComponent.DEFAULT_PRIORITY) })
    ...
    public PluginInvoke invoke(final Expression expression, final PluginCallInfo callInfo, final CompilerContext compilerContext) {
        return new DefaultPluginInvoke() {
            ...
            public void beforeChildren(PushStream stream) {
                ...
                stream.emit(new VariableBinding.Start(includedContentVar, new RuntimeCall(FUNCTION, new Identifier(pathVar), new MapLiteral(expression.getOptions()))));
