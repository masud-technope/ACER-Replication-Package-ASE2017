...
@Properties({ @Property(name = "service.description", value = "Download Servlet for binary properties"), @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = "sling.servlet.selectors", value = "property"), @Property(name = "sling.servlet.extensions", value = "download"), @Property(name = "sling.servlet.resourceTypes", value = "sling/servlet/default") })
public class DownloadBinaryProperty extends SlingSafeMethodsServlet {

    private static final long serialVersionUID = -1L;

    /** default log */
    private final Logger log = LoggerFactory.getLogger(DownloadBinaryProperty.class);
