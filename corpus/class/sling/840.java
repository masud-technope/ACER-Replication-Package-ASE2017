...
@Component(label = "Apache Sling Scripting Thymeleaf â€œSling Resource Resolverâ€?", description = "Sling resource resolver for Sling Scripting Thymeleaf", immediate = true, metatype = true)
@Service
@Properties({ @Property(name = Constants.SERVICE_VENDOR, value = "The Apache Software Foundation"), @Property(name = Constants.SERVICE_DESCRIPTION, value = "Sling resource resolver for Sling Scripting Thymeleaf"), @Property(name = Constants.SERVICE_RANKING, intValue = 0, propertyPrivate = false) })
public class SlingResourceResolver implements IResourceResolver {
    ...
    public IResource resolveResource(final IEngineConfiguration engineConfiguration, final IContext context, final String resourceName, final String characterEncoding) {
        ...
        } else if (context instanceof IWebVariablesMap) {
            // TODO Thymeleaf #388
