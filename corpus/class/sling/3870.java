...
public class LocationIterator implements Iterator<String> {
    ...
    private String getResourceSuperType(String resourceType) {
        ...
        String superType;
        if (resourceType.equals(this.firstResourceType) && this.firstResourceSuperType != null) {
    ...
    private String getResourceSuperType(final ResourceResolver resourceResolver, final String resourceType) {
