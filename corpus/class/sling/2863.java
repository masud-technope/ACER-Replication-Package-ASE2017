...
public class BodyOnlyScriptFilteredCopyTest extends TestCase {
    ...
    public void testBasicTemplate() throws IOException {
        final String input = "out.write('Something before body');\n" + "out.write('<body class='foo'>');\n" + "out.write(\"some template code\");\n" + "out.write('</body>');\n" + "out.write('Something after body');\n";
        final String expected = "out.write(\"some template code\");\n";
        runTest(input, expected);
    }

    public void testOpenClose() throws IOException {
        final String input = "A\n" + "out.write('    <body class='foo'>');\n" + "out.write(\"some <script> here </script>\");\n" + "out.write('</body>');\n" + "B\n";
        final String expected = "out.write(\"some <\");\n" + "out.write(\"script> here </\");\n" + "out.write(\"script>\");\n";
        runTest(input, expected);
    }

    public void test_SLING_615() throws IOException {
        final String input = "out.write(' <meta name='decorator' content='tssdotcom'></head><body>');\n" + "out.write('the body');\n" + "out.write('</body></html>');\n";
        final String expected = "out.write('the body');\n";
        runTest(input, expected);
    }
}
