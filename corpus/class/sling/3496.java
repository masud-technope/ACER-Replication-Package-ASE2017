...
public class ReportLogger {
    ...
    public enum ReportType implements  {
     ...
     */
    private  ReportLogger(final String testSuiteName, final String testCaseName, final String className, final String referenceMethod) {
     ...
     * @return
     */
    public static ReportLogger getOrCreate(final String testSuiteName, final String testCaseName, final String className, final String referenceMethod) {
    ...
    public static void writeReportTxt(String testSuiteName, String testCaseName, String className, String methodName, DescriptiveStatistics statistics, PerformanceRunner.ReportLevel reportLevel) throws Exception {
        writeReportTxt(testSuiteName, testCaseName, className, methodName, statistics.getMin(), statistics.getPercentile(10), statistics.getPercentile(50), statistics.getPercentile(90), statistics.getMax(), reportLevel);
    }
    ...
    public static void writeReportTxt(String testSuiteName, String testCaseName, String className, String methodName, double min, double percentile10, double percentile50, double percentile90, double max, PerformanceRunner.ReportLevel reportLevel) throws Exception {
        writeReportTxt(testSuiteName, testCaseName, className, methodName, min, percentile10, percentile50, percentile90, max, reportLevel, false);
    }
    ...
    public static void writeReportTxt(String testSuiteName, String testCaseName, String className, String methodName, double min, double percentile10, double percentile50, double percentile90, double max, PerformanceRunner.ReportLevel reportLevel, boolean showDecimals) throws Exception {
        ...
        if (reportLevel.equals(PerformanceRunner.ReportLevel.ClassLevel)) {
            ...
            writeReportMethodLevel(resultFileName, testSuiteName, testCaseName, className, methodName, min, percentile10, percentile50, percentile90, max, showDecimals);
        }
    }
