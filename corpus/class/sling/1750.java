...
public class TaskSupport {
    ...
    public BundleRefresher getBundleRefresher() {
        ...
        if (checkedWireAdmin.booleanValue()) {
            return new WABundleRefresher(this.bundleContext.getBundle(Constants.SYSTEM_BUNDLE_LOCATION).adapt(FrameworkWiring.class), this.bundleContext);
        } else {
            return new PABundleRefresher((PackageAdmin) this.packageAdminTracker.getService(), this.bundleContext);
        }
    }
}
