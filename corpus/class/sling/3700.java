...
public class DefaultInstanceDescriptionTest {
    ...
    public void testNotOwnInstance() throws Exception {
        final String slingId = UUID.randomUUID().toString();
        assertEquals(true, constructInstanceDescription(null, false, true, slingId, null).isLocal());
    }
    ...
    public DefaultInstanceDescription constructInstanceDescription(final DefaultClusterView clusterView, final boolean isLeader, final boolean isOwn, final String theSlingId, final Map<String, String> properties) throws Exception {
