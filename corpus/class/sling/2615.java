...
public class BindingsValuesProvidersByContextIT {
    ...
    public Option[] config() {
        ...
        return options(when(localRepo.length() > 0).useOptions(systemProperty("org.ops4j.pax.url.mvn.localRepository").value(localRepo)), provision(bundle(bundleFile.toURI().toString()), mavenBundle("org.apache.felix", "org.apache.felix.scr", "1.6.2"), mavenBundle("org.apache.felix", "org.apache.felix.eventadmin", "1.3.2"), mavenBundle(maven().groupId(FELIX_GID).artifactId("org.apache.felix.webconsole").versionAsInProject()), mavenBundle(maven().groupId(SLING_GID).artifactId("org.apache.sling.scripting.api").versionAsInProject()), mavenBundle(maven().groupId(SLING_GID).artifactId("org.apache.sling.commons.threads").versionAsInProject()), mavenBundle(maven().groupId(SLING_GID).artifactId("org.apache.sling.api").versionAsInProject()), mavenBundle(maven().groupId(SLING_GID).artifactId("org.apache.sling.commons.mime").versionAsInProject()), mavenBundle(maven().groupId(SLING_GID).artifactId("org.apache.sling.commons.osgi").versionAsInProject()), mavenBundle("org.mortbay.jetty", "servlet-api-2.5", "6.1.14"), mavenBundle(maven().groupId("commons-io").artifactId("commons-io").versionAsInProject()), mavenBundle(maven().groupId("commons-lang").artifactId("commons-lang").versionAsInProject())), junitBundles());
    }
