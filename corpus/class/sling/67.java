...
public class MessageStoreImpl implements MessageStore {
    ...
    @Reference(cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, policy = ReferencePolicy.DYNAMIC, referenceInterface = MessageProcessor.class)
    ...
    private boolean assertResource(ResourceResolver resolver, Resource parent, String name, Map<String, Object> newProps) throws LoginException, PersistenceException {
