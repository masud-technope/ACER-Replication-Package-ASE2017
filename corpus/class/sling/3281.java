...
public class DictionaryDigestTest {
    ...
    private String testDigestChanged(Dictionary<String, Object> d, String oldDigest, int step, boolean shouldChange) throws Exception {
    ...
    @org.junit.Test
    public void testDictionaryDigestChanges() throws Exception {
        String digest = "";
        int step = 1;
