...
@SlingServlet(resourceTypes = "mailserver/stats/destination", methods = "GET", extensions = "json", selectors = "statsdata")
public class StatsDataServlet extends /** Generates json data for the destination.esp script.
 * 
