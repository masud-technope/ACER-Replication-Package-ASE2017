...
@Properties({ @Property(name = InventoryPrinter.FORMAT, value = { "JSON", "TEXT" }), @Property(name = InventoryPrinter.NAME, value = "slingserviceusers"), @Property(name = InventoryPrinter.TITLE, value = "Sling Service User Mappings"), @Property(name = InventoryPrinter.WEBCONSOLE, boolValue = true) })
