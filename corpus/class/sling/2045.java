...
@Component
@Service
@Properties({ @Property(name = "service.description", value = "Sightly Use Block Plugin"), @Property(name = Plugin.SCR_PROP_NAME_BLOCK_NAME, value = "use"), @Property(name = Plugin.SCR_PROP_NAME_PRIORITY, intValue = 1) })
    ...
    public PluginInvoke invoke(final Expression expression, final PluginCallInfo callInfo, final CompilerContext compilerContext) {
        return new DefaultPluginInvoke() {
            ...
            public void beforeElement(PushStream stream, String tagName) {
                ...
                stream.emit(new VariableBinding.Global(variableName, new RuntimeCall(FUNCTION_NAME, expression.getRoot(), new MapLiteral(expression.getOptions()))));
            }
