...
@Properties({ @Property(name = Constants.SERVICE_DESCRIPTION, value = "Sling Jolokia Servlet"), @Property(name = Constants.SERVICE_VENDOR, value = "The Apache Software Foundation") })
public class SlingJolokiaServlet {
    ...
    protected void activate(final BundleContext bundleContext, final Map<String, ?> config) {
        ...
        try {
            ...
            dummyServiceProperties.put(Constants.SERVICE_DESCRIPTION, "Helper for " + config.get(Constants.SERVICE_DESCRIPTION));
