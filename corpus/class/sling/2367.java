...
@Properties({ @Property(name = "sling.servlet.paths", value = "sling/servlet/errorhandler/default"), @Property(name = "sling.servlet.prefix", value = "-1") })
...
public class DefaultErrorHandlerServlet extends GenericServlet {
     ...
     */
    private PrintWriter sendIntro(final HttpServletResponse response, final int statusCode, final String statusMessageIn, final String requestUri, final String servletName) throws IOException {
