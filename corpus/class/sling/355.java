...
@Properties({ @Property(name = "service.description", value = "Returns the node types as a JSON file"), @Property(name = "service.vendor", value = "Sandro Boehme"), @Property(name = "sling.servlet.extensions", value = "json"), @Property(name = "sling.servlet.resourceTypes", value = "jsnodetypes") })
