...
@Properties(@Property(name = RuntimeExtension.NAME, value = XSSFilter.FUNCTION_NAME))
public class XSSRuntimeExtension implements RuntimeExtension {
    ...
    public Object call(final RenderContext renderContext, Object... arguments) {
        if (arguments.length < 2) {
            throw new SightlyException(String.format("Extension %s requires at least %d arguments", XSSFilter.FUNCTION_NAME, 2));
        }
    ...
    private String applyXSSFilter(final XSSAPI xssapi, String text, MarkupContext xssContext) {
        ...
        //todo: apply the rest of XSS filters
        return text;
    }
