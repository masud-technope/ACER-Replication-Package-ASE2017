...
public class OrderedQueueTest extends AbstractJobHandlingTest {
    ...
    public void testOrderedQueue() throws Exception {
        ...
        final ServiceRegistration jcReg = this.registerJobConsumer("sling/orderedtest/*", new JobConsumer() {
        ...
        final ServiceRegistration ehReg = this.registerEventHandler(NotificationConstants.TOPIC_JOB_FINISHED, new EventHandler() {
