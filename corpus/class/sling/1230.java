...
@Service
@Properties({ @Property(name = "service.description", value = "RequestProgressTracker dump filter", propertyPrivate = true), @Property(name = "service.vendor", value = "The Apache Software Foundation", propertyPrivate = true), @Property(name = "filter.scope", value = "request", propertyPrivate = true) })
public class RequestProgressTrackerLogFilter implements Filter {
    ...
    private void activate(ComponentContext ctx) {
        ...
        log.debug("activated: extensions = {}, min = {}, max = {}, compact = {}", new Object[] { extensions, minDurationMs, maxDurationMs, compactLogFormat });
    }
}
