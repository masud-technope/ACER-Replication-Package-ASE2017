...
public interface PropertyBuilder {
     ...
     */
    @Nonnull
    QueryBuilder eq(@Nonnull Object value);
     ...
     */
    @Nonnull
    QueryBuilder isGreater(@Nonnull Object value);
     ...
     */
    @Nonnull
    QueryBuilder isGreaterOrEq(@Nonnull Object value);
     ...
     */
    @Nonnull
    QueryBuilder isLess(@Nonnull Object value);
     ...
     */
    @Nonnull
    QueryBuilder isLessOrEq(@Nonnull Object value);
     ...
     */
    @Nonnull
    QueryBuilder contains(@Nonnull Object value);
