    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
        ...
        if (targetPath != null) {
            if (!isUrl(targetPath)) {
                ...
                targetPath = appendSelectorsExtensionSuffixQuery(request, new StringBuilder(targetPath)).toString();
            }
