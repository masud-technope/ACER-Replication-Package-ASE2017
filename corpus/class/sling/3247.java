...
public class DeleteOperation extends AbstractPostOperation {
     ...
     */
    private void deleteResource(final Resource resource, final List<Modification> changes, VersioningConfiguration versioningConfiguration, boolean deleteChunks) throws RepositoryException {
