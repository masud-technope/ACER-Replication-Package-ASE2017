...
@Properties({ @Property(name = SightlyEngineConfiguration.SCR_PROP_NAME_DEVMODE, boolValue = SightlyEngineConfiguration.SCR_PROP_DEFAULT_DEVMODE, label = "Development Mode", description = "If enabled, Sightly components will be recompiled at every request instead of loading objects from memory." + " This will also write the generated Java classes' source code for Sightly templates through the ClassLoaderWriter " + "service."), @Property(name = SightlyEngineConfiguration.SCR_PROP_NAME_ENCODING, value = SightlyEngineConfiguration.SCR_PROP_DEFAULT_ENCODING, label = "Template Files Default Encoding", description = "The default encoding used for reading Sightly template files (this directly affects how Sightly templates" + "are rendered).") })
