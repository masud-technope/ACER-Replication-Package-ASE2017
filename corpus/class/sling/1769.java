...
public class MultipleEndpointDistributionTransport implements DistributionTransport {
    ...
    public  MultipleEndpointDistributionTransport(Map<String, DistributionTransport> transportHelpers, TransportEndpointStrategyType endpointStrategyType) {
    ...
    public  MultipleEndpointDistributionTransport(List<DistributionTransport> transportHelpers, TransportEndpointStrategyType endpointStrategyType) {
