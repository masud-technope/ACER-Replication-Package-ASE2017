...
public class RemoteDistributionPackageImporterTest {
    ...
    public void testDummyImport() throws Exception {
        ...
        for (TransportEndpointStrategyType strategy : TransportEndpointStrategyType.values()) {
            RemoteDistributionPackageImporter remotedistributionPackageImporter = new RemoteDistributionPackageImporter(mock(DefaultDistributionLog.class), distributionTransportSecretProvider, endpoints, strategy);
