...
public class SynchronousOakResourceListener extends OakResourceListener {
    ...
    public  SynchronousOakResourceListener(final SlingRepository repo, final BundleContext bundleContext, final ResourceResolver resolver, final ServiceTracker tracker, final Executor executor) throws LoginException, RepositoryException, NoSuchFieldException {
