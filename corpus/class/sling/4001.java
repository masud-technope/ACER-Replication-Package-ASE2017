...
public class BundleResourceProvider implements ResourceProvider {
    ...
    public Iterator<Resource> listChildren(final Resource parent) throws SlingException {
        ...
        if (mappedPath != null) {
            return new BundleResourceIterator(parent.getResourceResolver(), bundle, mappedPath, parentPath);
        }
