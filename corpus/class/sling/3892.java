...
public class BasicQuery implements Query {
    ...
    public  BasicQuery(final Set<String> paths, final Set<String> resourceTypes, final Set<String> names, final Set<PropertyConstraint> propertyConstraints) {
    ...
    public  BasicQuery(final QueryType qt, final List<Query> subQueries) {
        this.queryType = qt;
