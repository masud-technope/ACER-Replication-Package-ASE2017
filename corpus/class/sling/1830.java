                    ...
                    for (final JobKey key : keys) {
                        ...
                        if (jobName != null && job != null) {
                            ...
                            if (runOn != null) {
                                ...
                                if (runOn.length == 1 && (org.apache.sling.commons.scheduler.Scheduler.VALUE_RUN_ON_LEADER.equals(runOn[0]) || org.apache.sling.commons.scheduler.Scheduler.VALUE_RUN_ON_SINGLE.equals(runOn[0]))) {
