...
@Service
@Properties({ @Property(name = Constants.SERVICE_RANKING, label = "Service Ranking", description = "The Service Ranking value acts as the priority with which this Use Provider is queried to return an Use-object. A higher " + "value represents a higher priority.", /**
         ...
         */
intValue = 95, propertyPrivate = false) })
