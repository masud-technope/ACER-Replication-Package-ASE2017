...
public class WebConsoleConfigPrinter {
    ...
    public static Object register(final BundleContext bundleContext, final ServletFilterManager filterManager) {
        ...
        serviceProps.put(Constants.SERVICE_DESCRIPTION, "Apache Sling Servlet Filter Configuration Printer");
        ...
        reg.filterPlugin = bundleContext.registerService(WebConsoleConfigPrinter.class.getName(), filterPrinter, serviceProps);
        return reg;
    }
