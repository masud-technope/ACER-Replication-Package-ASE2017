...
public class ServletResolverConfigTest extends HttpTestBase {
    ...
    public void testCacheDisabled() throws Exception {
        ...
        if (cacheSize != 0) {
            fail("ServletResolver cache size should be set to zero for testing, current value=" + cacheSize + " *** THIS MIGHT CAUSE MANY OTHER TESTS TO FAIL!! ***" + " (" + CONFIG_PID + "/" + CONFIG_PROP + ")");
        }
    }
}
