...
public class ExecutionResult implements Comparable<ExecutionResult>, HealthCheckExecutionResult {
     ...
     * Full constructor
     */
    public  ExecutionResult(final HealthCheckMetadata metadata, final Result simpleResult, final long elapsedTimeInMs, final boolean timedout) {
     ...
     */
    public  ExecutionResult(final HealthCheckMetadata metadata, final Result simpleResult, final long elapsedTimeInMs) {
     ...
     */
    public  ExecutionResult(final HealthCheckMetadata metadata, final Result.Status status, final String errorMessage, final long elapsedTime, boolean timedOut) {
    ...
    public String toString() {
        return "ExecutionResult [status=" + this.resultFromHC.getStatus() + ", finishedAt=" + finishedAt + ", elapsedTimeInMs=" + elapsedTimeInMs + ", timedOut=" + timedOut + "]";
    }
