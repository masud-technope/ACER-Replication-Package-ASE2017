...
public class OakVirtualInstanceBuilder extends VirtualInstanceBuilder {
    ...
    protected BaseDiscoveryService createDiscoveryService() throws Exception {
        return OakDiscoveryService.testConstructor(getSlingSettingsService(), getAnnouncementRegistry(), getConnectorRegistry(), getClusterViewService(), getConfig(), getOakViewChecker(), getScheduler(), getIdMapService(), getOakBacklogClusterSyncService(), getSyncTokenService(), getResourceResolverFactory());
    }
