...
public class WhiteboardHandler {
    ...
    private static final String SCHEDULED_JOB_FILTER = "(|(" + Constants.OBJECTCLASS + "=" + Runnable.class.getName() + ")" + "(" + Constants.OBJECTCLASS + "=" + Job.class.getName() + "))";
    ...
    protected void activate(final BundleContext btx) throws InvalidSyntaxException {
        this.serviceTracker = new ServiceTracker(btx, btx.createFilter(SCHEDULED_JOB_FILTER), new ServiceTrackerCustomizer() {
    ...
    private void scheduleJob(final ServiceReference ref, final Object job, final ScheduleOptions scheduleOptions) {
        ...
        final ScheduleOptions options = scheduleOptions.name(name).canRunConcurrently((concurrent != null ? concurrent : true)).onInstancesOnly(runOnOpts);
