...
@Properties({ @Property(name = "service.description", value = "List the Resource Types available in the repository."), @Property(name = "service.vendor", value = "The Apache Software Foundation"), @Property(name = "sling.servlet.extensions", value = "json"), @Property(name = "sling.servlet.resourceTypes", value = "sling/resource-editor/resource-type-list") })
public class ResourceTypeList extends SlingSafeMethodsServlet {

    private static final long serialVersionUID = -1L;

    /** default log */
    private final Logger log = LoggerFactory.getLogger(ResourceTypeList.class);
