...
public class JobHandlingUtils {
    ...
    public static DistributionQueueItemStatus getStatus(final Job job) {
        ...
        DistributionQueueItemStatus status = new DistributionQueueItemStatus(job.getCreated(), attempts > 0 ? DistributionQueueItemState.ERROR : DistributionQueueItemState.QUEUED, attempts, queueName);
        return status;
    }
