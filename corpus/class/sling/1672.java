...
public class ViewHelper {
     ...
     * @return
     */
    public static Set<String> determineLiveInstances(final Resource clusterInstancesResource, final Config config) {
        final Set<String> myView = new HashSet<String>();
        final Iterator<Resource> it = clusterInstancesResource.getChildren().iterator();
        while (it.hasNext()) {
     ...
     * @return
     */
    private static boolean isHeartBeatCurrent(Resource aClusterInstanceResource, final Config config) {
    ...
    public static View getEstablishedView(final ResourceResolver resourceResolver, final Config config) {
        final Resource establishedParent = resourceResolver.getResource(config.getEstablishedViewPath());
