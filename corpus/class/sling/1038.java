...
@Adaptable(adaptableClass = Resource.class, adapters = { @Adapter(value = { Item.class, Property.class, Value.class, String.class, Boolean.class, Long.class, Double.class, BigDecimal.class, Calendar.class, InputStream.class, Value[].class, String[].class, Boolean[].class, Long[].class, Double[].class, BigDecimal[].class }), @Adapter(value = Node.class, condition = "If the resource is a JcrPropertyResource and the property is a reference or weak reference property.") })
class JcrPropertyResource extends // this should be package private, see SLING-1414
JcrItemResource<Property> {
    ...
    public  JcrPropertyResource(final ResourceResolver resourceResolver, final String path, final String version, final Property property) throws RepositoryException {
    ...
    public <AdapterType> AdapterType adaptTo(Class<AdapterType> type) {
        ...
        try {
            ...
            } else if (type == Node.class && (getProperty().getType() == PropertyType.REFERENCE || getProperty().getType() == PropertyType.WEAKREFERENCE)) {
