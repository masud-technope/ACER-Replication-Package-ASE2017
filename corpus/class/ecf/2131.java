...
public class EMFUpdateProvider implements IUpdateProvider {
    ...
    private EDataGraph clone(EDataGraph source) throws IOException {
        ...
        return SDOUtil.loadDataGraph(new ByteArrayInputStream(buf.toByteArray()), null);
    }
     ...
     *      byte[])
     */
    public void applyUpdate(ISharedDataGraph graph, Object data) throws ECFException {
        EDataGraph dataGraph = (EDataGraph) graph.getDataGraph();
        EChangeSummary changeSummary = (EChangeSummary) dataGraph.getChangeSummary();
     ...
     */
    public DataGraph deserializeDataGraph(Object data) throws IOException, ClassNotFoundException {
        return SDOUtil.loadDataGraph(new ByteArrayInputStream((byte[]) data), null);
    }
}
