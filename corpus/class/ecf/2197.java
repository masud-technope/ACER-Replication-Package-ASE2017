...
public class BasicTopologyManagerComponent implements EventListenerHook, RemoteServiceAdminListener {
    ...
    private boolean exportRegisteredSvcs = new Boolean(System.getProperty("org.eclipse.ecf.osgi.services.basictopologymanager.exportRegisteredSvcs", //$NON-NLS-1$ //$NON-NLS-2$
    "true")).booleanValue();

    private String exportRegisteredSvcsFilter = System.getProperty("org.eclipse.ecf.osgi.services.basictopologymanager.exportRegisteredSvcsFilter", //$NON-NLS-1$ //$NON-NLS-2$
