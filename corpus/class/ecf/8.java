    ...
    public void start(final BundleContext context1) throws Exception {
        ...
        SafeRunner.run(new ExtensionRegistryRunnable(this.context) {
            ...
            protected void runWithoutRegistry() throws Exception {
                ...
                context1.registerService(//$NON-NLS-1$
                ContainerTypeDescription.class, //$NON-NLS-1$
                new ContainerTypeDescription(GenericContainerInstantiator.TCPCLIENT_NAME, new GenericContainerInstantiator(), "ECF Generic Client", false, true), //$NON-NLS-1$
                null);
                //$NON-NLS-1$
                context1.registerService(//$NON-NLS-1$
                ContainerTypeDescription.class, //$NON-NLS-1$
                ...
                context1.registerService(//$NON-NLS-1$
                ContainerTypeDescription.class, //$NON-NLS-1$
                new ContainerTypeDescription(SSLGenericContainerInstantiator.SSLCLIENT_NAME, new SSLGenericContainerInstantiator(), "ECF SSL Generic Client", false, true), //$NON-NLS-1$
                null);
            }
        });
    }
