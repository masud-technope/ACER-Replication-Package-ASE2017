...
public interface HttpClientOptions {
    ...
    //$NON-NLS-1$
    public String FORCE_NTLM_PROP = "org.eclipse.ecf.provider.filetransfer.httpclient.options.ForceNTLMProxy";
	 ...
	 */
    //$NON-NLS-1$ //$NON-NLS-2$
    public static final int RETRIEVE_DEFAULT_CONNECTION_TIMEOUT = new Integer(System.getProperty("org.eclipse.ecf.provider.filetransfer.httpclient.retrieve.connectTimeout", "120000")).intValue();
	 ...
	 */
    //$NON-NLS-1$ //$NON-NLS-2$
    public static final int RETRIEVE_DEFAULT_READ_TIMEOUT = new Integer(System.getProperty("org.eclipse.ecf.provider.filetransfer.httpclient.retrieve.readTimeout", "120000")).intValue();
	 ...
	 */
    //$NON-NLS-1$ //$NON-NLS-2$;
    public static final int BROWSE_DEFAULT_CONNECTION_TIMEOUT = new Integer(System.getProperty("org.eclipse.ecf.provider.filetransfer.httpclient.browse.connectTimeout", "120000")).intValue();
}
