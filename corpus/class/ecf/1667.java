...
public class RemoteServiceAdmin implements org.osgi.service.remoteserviceadmin.RemoteServiceAdmin {
    ...
    class ImportEndpoint {
        ...
        synchronized void update(org.osgi.service.remoteserviceadmin.EndpointDescription endpoint) {
            ...
            Map newProxyProperties = createProxyProperties(importContainerID, updatedEndpoint, rsReference, rs);
    ...
    private void publishEvent(RemoteServiceAdminEvent event, EndpointDescription endpointDescription) {
        ...
        if (listeners != null)
            for (int i = 0; i < listeners.length; i++) listeners[i].remoteAdminEvent(event);
    ...
    private ImportRegistration importService(EndpointDescription endpointDescription, IRemoteServiceContainer rsContainer) {
        ...
        final ID[] idFilter = getIDFilter(endpointDescription, endpointContainerID);
