...
public class DataGraphSharingFactory {
    ...
    public static final IDataGraphSharing getDataGraphSharing(ISharedObjectContainer container, String name) throws ECFException {
        IDataGraphSharingManager instantiator = (IDataGraphSharingManager) managers.get(name);
    ...
    public static void registerManager(String name, IDataGraphSharingManager manager) {
