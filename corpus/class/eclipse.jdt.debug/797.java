...
public class ExceptionBreakpointDetailPane extends AbstractDetailPane {
    ...
    public  ExceptionBreakpointDetailPane() {
        ...
        addAutosaveProperties(new int[] { StandardJavaBreakpointEditor.PROP_HIT_COUNT_ENABLED, StandardJavaBreakpointEditor.PROP_SUSPEND_POLICY, ExceptionBreakpointEditor.PROP_CAUGHT, ExceptionBreakpointEditor.PROP_UNCAUGHT, ExceptionBreakpointEditor.PROP_SUBCLASSES });
    }
