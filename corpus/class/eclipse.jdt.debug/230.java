...
public class WatchpointDetailPane extends AbstractDetailPane {
    ...
    public  WatchpointDetailPane() {
        ...
        addAutosaveProperties(new int[] { StandardJavaBreakpointEditor.PROP_HIT_COUNT_ENABLED, StandardJavaBreakpointEditor.PROP_SUSPEND_POLICY, WatchpointEditor.PROP_ACCESS, WatchpointEditor.PROP_MODIFICATION });
    }
