...
public class LineBreakpointDetailPane extends AbstractDetailPane {
    ...
    public  LineBreakpointDetailPane() {
        ...
        addAutosaveProperties(new int[] { JavaBreakpointConditionEditor.PROP_CONDITION_ENABLED, JavaBreakpointConditionEditor.PROP_CONDITION_SUSPEND_POLICY, StandardJavaBreakpointEditor.PROP_HIT_COUNT_ENABLED, StandardJavaBreakpointEditor.PROP_SUSPEND_POLICY });
    }
